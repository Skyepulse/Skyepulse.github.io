...
* @license MIT
**//*! #__NO_SIDE_EFFECTS__ */function qs(t){const e=Object.create(null);for(const r of t.split(","))e[r]=1;return r=>r in e}const ge={},Er=[],Tt=()=>{},Pu=()=>!1,pi=t=>t.charCodeAt(0)===111&&t.charCodeAt(1)===110&&(t.charCodeAt(2)>122||t.charCodeAt(2)<97),Ws=t=>t.startsWith("onUpdate:"),Le=Object.assign,Ks=(t,e)=>{const r=t.indexOf(e);r>-1&&t.splice(r,1)},Iu=Object.prototype.hasOwnProperty,ce=(t,e)=>Iu.call(t,e),$=Array.isArray,Sr=t=>gi(t)==="[object Map]",bc=t=>gi(t)==="[object Set]",ee=t=>typeof t=="function",Pe=t=>typeof t=="string",Xt=t=>typeof t=="symbol",we=t=>t!==null&&typeof t=="object",yc=t=>(we(t)||ee(t))&&ee(t.then)&&ee(t.catch),vc=Object.prototype.toString,gi=t=>vc.call(t),Ou=t=>gi(t).slice(8,-1),Bc=t=>gi(t)==="[object Object]",Ys=t=>Pe(t)&&t!=="NaN"&&t[0]!=="-"&&""+parseInt(t,10)===t,Xr=qs(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),bi=t=>{const e=Object.create(null);return r=>e[r]||(e[r]=t(r))},Ru=/-(\w)/g,Kt=bi(t=>t.replace(Ru,(e,r)=>r?r.toUpperCase():"")),Du=/\B([A-Z])/g,$t=bi(t=>t.replace(Du,"-$1").toLowerCase()),xc=bi(t=>t.charAt(0).toUpperCase()+t.slice(1)),_i=bi(t=>t?`on${xc(t)}`:""),Wt=(t,e)=>!Object.is(t,e),Li=(t,...e)=>{for(let r=0;r<t.length;r++)t[r](...e)},As=(t,e,r,n=!1)=>{Object.defineProperty(t,e,{configurable:!0,enumerable:!1,writable:n,value:r})},Gu=t=>{const e=parseFloat(t);return isNaN(e)?t:e};let No;const yi=()=>No||(No=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function vi(t){if($(t)){const e={};for(let r=0;r<t.length;r++){const n=t[r],i=Pe(n)?Lu(n):vi(n);if(i)for(const s in i)e[s]=i[s]}return e}else if(Pe(t)||we(t))return t}const Fu=/;(?![^(]*\))/g,Uu=/:([^]+)/,_u=/\/\*[^]*?\*\//g;function Lu(t){const e={};return t.replace(_u,"").split(Fu).forEach(r=>{if(r){const n=r.split(Uu);n.length>1&&(e[n[0].trim()]=n[1].trim())}}),e}function ln(t){let e="";if(Pe(t))e=t;else if($(t))for(let r=0;r<t.length;r++){const n=ln(t[r]);n&&(e+=n+" ")}else if(we(t))for(const r in t)t[r]&&(e+=r+" ");return e.trim()}const Nu="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",ju=qs(Nu);function Ac(t){return!!t||t===""}const Tc=t=>!!(t&&t.__v_isRef===!0),Vn=t=>Pe(t)?t:t==null?"":$(t)||we(t)&&(t.toString===vc||!ee(t.toString))?Tc(t)?Vn(t.value):JSON.stringify(t,Cc,2):String(t),Cc=(t,e)=>Tc(e)?Cc(t,e.value):Sr(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((r,[n,i],s)=>(r[Ni(n,s)+" =>"]=i,r),{})}:bc(e)?{[`Set(${e.size})`]:[...e.values()].map(r=>Ni(r))}:Xt(e)?Ni(e):we(e)&&!$(e)&&!Bc(e)?String(e):e,Ni=(t,e="")=>{var r;return Xt(t)?`Symbol(${(r=t.description)!=null?r:e})`:t};/**
* @vue/reactivity v3.5.18
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let qe;class Vu{constructor(e=!1){this.detached=e,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this.parent=qe,!e&&qe&&(this.index=(qe.scopes||(qe.scopes=[])).push(this)-1)}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let e,r;if(this.scopes)for(e=0,r=this.scopes.length;e<r;e++)this.scopes[e].pause();for(e=0,r=this.effects.length;e<r;e++)this.effects[e].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let e,r;if(this.scopes)for(e=0,r=this.scopes.length;e<r;e++)this.scopes[e].resume();for(e=0,r=this.effects.length;e<r;e++)this.effects[e].resume()}}run(e){if(this._active){const r=qe;try{return qe=this,e()}finally{qe=r}}}on(){++this._on===1&&(this.prevScope=qe,qe=this)}off(){this._on>0&&--this._on===0&&(qe=this.prevScope,this.prevScope=void 0)}stop(e){if(this._active){this._active=!1;let r,n;for(r=0,n=this.effects.length;r<n;r++)this.effects[r].stop();for(this.effects.length=0,r=0,n=this.cleanups.length;r<n;r++)this.cleanups[r]();if(this.cleanups.length=0,this.scopes){for(r=0,n=this.scopes.length;r<n;r++)this.scopes[r].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!e){const i=this.parent.scopes.pop();i&&i!==this&&(this.parent.scopes[this.index]=i,i.index=this.index)}this.parent=void 0}}}function Hu(){return qe}let ye;const ji=new WeakSet;class Mc{constructor(e){this.fn=e,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,qe&&qe.active&&qe.effects.push(this)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,ji.has(this)&&(ji.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||Ec(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,jo(this),Sc(this);const e=ye,r=ft;ye=this,ft=!0;try{return this.fn()}finally{Pc(this),ye=e,ft=r,this.flags&=-3}}stop(){if(this.flags&1){for(let e=this.deps;e;e=e.nextDep)$s(e);this.deps=this.depsTail=void 0,jo(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?ji.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){Ts(this)&&this.run()}get dirty(){return Ts(this)}}let wc=0,$r,Zr;function Ec(t,e=!1){if(t.flags|=8,e){t.next=Zr,Zr=t;return}t.next=$r,$r=t}function Qs(){wc++}function Xs(){if(--wc>0)return;if(Zr){let e=Zr;for(Zr=void 0;e;){const r=e.next;e.next=void 0,e.flags&=-9,e=r}}let t;for(;$r;){let e=$r;for($r=void 0;e;){const r=e.next;if(e.next=void 0,e.flags&=-9,e.flags&1)try{e.trigger()}catch(n){t||(t=n)}e=r}}if(t)throw t}function Sc(t){for(let e=t.deps;e;e=e.nextDep)e.version=-1,e.prevActiveLink=e.dep.activeLink,e.dep.activeLink=e}function Pc(t){let e,r=t.depsTail,n=r;for(;n;){const i=n.prevDep;n.version===-1?(n===r&&(r=i),$s(n),ku(n)):e=n,n.dep.activeLink=n.prevActiveLink,n.prevActiveLink=void 0,n=i}t.deps=e,t.depsTail=r}function Ts(t){for(let e=t.deps;e;e=e.nextDep)if(e.dep.version!==e.version||e.dep.computed&&(Ic(e.dep.computed)||e.dep.version!==e.version))return!0;return!!t._dirty}function Ic(t){if(t.flags&4&&!(t.flags&16)||(t.flags&=-17,t.globalVersion===un)||(t.globalVersion=un,!t.isSSR&&t.flags&128&&(!t.deps&&!t._dirty||!Ts(t))))return;t.flags|=2;const e=t.dep,r=ye,n=ft;ye=t,ft=!0;try{Sc(t);const i=t.fn(t._value);(e.version===0||Wt(i,t._value))&&(t.flags|=128,t._value=i,e.version++)}catch(i){throw e.version++,i}finally{ye=r,ft=n,Pc(t),t.flags&=-3}}function $s(t,e=!1){const{dep:r,prevSub:n,nextSub:i}=t;if(n&&(n.nextSub=i,t.prevSub=void 0),i&&(i.prevSub=n,t.nextSub=void 0),r.subs===t&&(r.subs=n,!n&&r.computed)){r.computed.flags&=-5;for(let s=r.computed.deps;s;s=s.nextDep)$s(s,!0)}!e&&!--r.sc&&r.map&&r.map.delete(r.key)}function ku(t){const{prevDep:e,nextDep:r}=t;e&&(e.nextDep=r,t.prevDep=void 0),r&&(r.prevDep=e,t.nextDep=void 0)}let ft=!0;const Oc=[];function Ut(){Oc.push(ft),ft=!1}function _t(){const t=Oc.pop();ft=t===void 0?!0:t}function jo(t){const{cleanup:e}=t;if(t.cleanup=void 0,e){const r=ye;ye=void 0;try{e()}finally{ye=r}}}let un=0;class zu{constructor(e,r){this.sub=e,this.dep=r,this.version=r.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class Zs{constructor(e){this.computed=e,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(e){if(!ye||!ft||ye===this.computed)return;let r=this.activeLink;if(r===void 0||r.sub!==ye)r=this.activeLink=new zu(ye,this),ye.deps?(r.prevDep=ye.depsTail,ye.depsTail.nextDep=r,ye.depsTail=r):ye.deps=ye.depsTail=r,Rc(r);else if(r.version===-1&&(r.version=this.version,r.nextDep)){const n=r.nextDep;n.prevDep=r.prevDep,r.prevDep&&(r.prevDep.nextDep=n),r.prevDep=ye.depsTail,r.nextDep=void 0,ye.depsTail.nextDep=r,ye.depsTail=r,ye.deps===r&&(ye.deps=n)}return r}trigger(e){this.version++,un++,this.notify(e)}notify(e){Qs();try{for(let r=this.subs;r;r=r.prevSub)r.sub.notify()&&r.sub.dep.notify()}finally{Xs()}}}function Rc(t){if(t.dep.sc++,t.sub.flags&4){const e=t.dep.computed;if(e&&!t.dep.subs){e.flags|=20;for(let n=e.deps;n;n=n.nextDep)Rc(n)}const r=t.dep.subs;r!==t&&(t.prevSub=r,r&&(r.nextSub=t)),t.dep.subs=t}}const Cs=new WeakMap,lr=Symbol(""),Ms=Symbol(""),fn=Symbol("");function Fe(t,e,r){if(ft&&ye){let n=Cs.get(t);n||Cs.set(t,n=new Map);let i=n.get(r);i||(n.set(r,i=new Zs),i.map=n,i.key=r),i.track()}}function Ot(t,e,r,n,i,s){const o=Cs.get(t);if(!o){un++;return}const a=c=>{c&&c.trigger()};if(Qs(),e==="clear")o.forEach(a);else{const c=$(t),l=c&&Ys(r);if(c&&r==="length"){const u=Number(n);o.forEach((f,h)=>{(h==="length"||h===fn||!Xt(h)&&h>=u)&&a(f)})}else switch((r!==void 0||o.has(void 0))&&a(o.get(r)),l&&a(o.get(fn)),e){case"add":c?l&&a(o.get("length")):(a(o.get(lr)),Sr(t)&&a(o.get(Ms)));break;case"delete":c||(a(o.get(lr)),Sr(t)&&a(o.get(Ms)));break;case"set":Sr(t)&&a(o.get(lr));break}}Xs()}function gr(t){const e=ae(t);return e===t?e:(Fe(e,"iterate",fn),at(t)?e:e.map(Re))}function Bi(t){return Fe(t=ae(t),"iterate",fn),t}const Ju={__proto__:null,[Symbol.iterator](){return Vi(this,Symbol.iterator,Re)},concat(...t){return gr(this).concat(...t.map(e=>$(e)?gr(e):e))},entries(){return Vi(this,"entries",t=>(t[1]=Re(t[1]),t))},every(t,e){return wt(this,"every",t,e,void 0,arguments)},filter(t,e){return wt(this,"filter",t,e,r=>r.map(Re),arguments)},find(t,e){return wt(this,"find",t,e,Re,arguments)},findIndex(t,e){return wt(this,"findIndex",t,e,void 0,arguments)},findLast(t,e){return wt(this,"findLast",t,e,Re,arguments)},findLastIndex(t,e){return wt(this,"findLastIndex",t,e,void 0,arguments)},forEach(t,e){return wt(this,"forEach",t,e,void 0,arguments)},includes(...t){return Hi(this,"includes",t)},indexOf(...t){return Hi(this,"indexOf",t)},join(t){return gr(this).join(t)},lastIndexOf(...t){return Hi(this,"lastIndexOf",t)},map(t,e){return wt(this,"map",t,e,void 0,arguments)},pop(){return zr(this,"pop")},push(...t){return zr(this,"push",t)},reduce(t,...e){return Vo(this,"reduce",t,e)},reduceRight(t,...e){return Vo(this,"reduceRight",t,e)},shift(){return zr(this,"shift")},some(t,e){return wt(this,"some",t,e,void 0,arguments)},splice(...t){return zr(this,"splice",t)},toReversed(){return gr(this).toReversed()},toSorted(t){return gr(this).toSorted(t)},toSpliced(...t){return gr(this).toSpliced(...t)},unshift(...t){return zr(this,"unshift",t)},values(){return Vi(this,"values",Re)}};function Vi(t,e,r){const n=Bi(t),i=n[e]();return n!==t&&!at(t)&&(i._next=i.next,i.next=()=>{const s=i._next();return s.value&&(s.value=r(s.value)),s}),i}const qu=Array.prototype;function wt(t,e,r,n,i,s){const o=Bi(t),a=o!==t&&!at(t),c=o[e];if(c!==qu[e]){const f=c.apply(t,s);return a?Re(f):f}let l=r;o!==t&&(a?l=function(f,h){return r.call(this,Re(f),h,t)}:r.length>2&&(l=function(f,h){return r.call(this,f,h,t)}));const u=c.call(o,l,n);return a&&i?i(u):u}function Vo(t,e,r,n){const i=Bi(t);let s=r;return i!==t&&(at(t)?r.length>3&&(s=function(o,a,c){return r.call(this,o,a,c,t)}):s=function(o,a,c){return r.call(this,o,Re(a),c,t)}),i[e](s,...n)}function Hi(t,e,r){const n=ae(t);Fe(n,"iterate",fn);const i=n[e](...r);return(i===-1||i===!1)&&no(r[0])?(r[0]=ae(r[0]),n[e](...r)):i}function zr(t,e,r=[]){Ut(),Qs();const n=ae(t)[e].apply(t,r);return Xs(),_t(),n}const Wu=qs("__proto__,__v_isRef,__isVue"),Dc=new Set(Object.getOwnPropertyNames(Symbol).filter(t=>t!=="arguments"&&t!=="caller").map(t=>Symbol[t]).filter(Xt));function Ku(t){Xt(t)||(t=String(t));const e=ae(this);return Fe(e,"has",t),e.hasOwnProperty(t)}class Gc{constructor(e=!1,r=!1){this._isReadonly=e,this._isShallow=r}get(e,r,n){if(r==="__v_skip")return e.__v_skip;const i=this._isReadonly,s=this._isShallow;if(r==="__v_isReactive")return!i;if(r==="__v_isReadonly")return i;if(r==="__v_isShallow")return s;if(r==="__v_raw")return n===(i?s?sf:Lc:s?_c:Uc).get(e)||Object.getPrototypeOf(e)===Object.getPrototypeOf(n)?e:void 0;const o=$(e);if(!i){let c;if(o&&(c=Ju[r]))return c;if(r==="hasOwnProperty")return Ku}const a=Reflect.get(e,r,_e(e)?e:n);return(Xt(r)?Dc.has(r):Wu(r))||(i||Fe(e,"get",r),s)?a:_e(a)?o&&Ys(r)?a:a.value:we(a)?i?Nc(a):to(a):a}}class Fc extends Gc{constructor(e=!1){super(!1,e)}set(e,r,n,i){let s=e[r];if(!this._isShallow){const c=Yt(s);if(!at(n)&&!Yt(n)&&(s=ae(s),n=ae(n)),!$(e)&&_e(s)&&!_e(n))return c?!1:(s.value=n,!0)}const o=$(e)&&Ys(r)?Number(r)<e.length:ce(e,r),a=Reflect.set(e,r,n,_e(e)?e:i);return e===ae(i)&&(o?Wt(n,s)&&Ot(e,"set",r,n):Ot(e,"add",r,n)),a}deleteProperty(e,r){const n=ce(e,r);e[r];const i=Reflect.deleteProperty(e,r);return i&&n&&Ot(e,"delete",r,void 0),i}has(e,r){const n=Reflect.has(e,r);return(!Xt(r)||!Dc.has(r))&&Fe(e,"has",r),n}ownKeys(e){return Fe(e,"iterate",$(e)?"length":lr),Reflect.ownKeys(e)}}class Yu extends Gc{constructor(e=!1){super(!0,e)}set(e,r){return!0}deleteProperty(e,r){return!0}}const Qu=new Fc,Xu=new Yu,$u=new Fc(!0);const ws=t=>t,In=t=>Reflect.getPrototypeOf(t);function Zu(t,e,r){return function(...n){const i=this.__v_raw,s=ae(i),o=Sr(s),a=t==="entries"||t===Symbol.iterator&&o,c=t==="keys"&&o,l=i[t](...n),u=r?ws:e?Xn:Re;return!e&&Fe(s,"iterate",c?Ms:lr),{next(){const{value:f,done:h}=l.next();return h?{value:f,done:h}:{value:a?[u(f[0]),u(f[1])]:u(f),done:h}},[Symbol.iterator](){return this}}}}function On(t){return function(...e){return t==="delete"?!1:t==="clear"?void 0:this}}function ef(t,e){const r={get(i){const s=this.__v_raw,o=ae(s),a=ae(i);t||(Wt(i,a)&&Fe(o,"get",i),Fe(o,"get",a));const{has:c}=In(o),l=e?ws:t?Xn:Re;if(c.call(o,i))return l(s.get(i));if(c.call(o,a))return l(s.get(a));s!==o&&s.get(i)},get size(){const i=this.__v_raw;return!t&&Fe(ae(i),"iterate",lr),Reflect.get(i,"size",i)},has(i){const s=this.__v_raw,o=ae(s),a=ae(i);return t||(Wt(i,a)&&Fe(o,"has",i),Fe(o,"has",a)),i===a?s.has(i):s.has(i)||s.has(a)},forEach(i,s){const o=this,a=o.__v_raw,c=ae(a),l=e?ws:t?Xn:Re;return!t&&Fe(c,"iterate",lr),a.forEach((u,f)=>i.call(s,l(u),l(f),o))}};return Le(r,t?{add:On("add"),set:On("set"),delete:On("delete"),clear:On("clear")}:{add(i){!e&&!at(i)&&!Yt(i)&&(i=ae(i));const s=ae(this);return In(s).has.call(s,i)||(s.add(i),Ot(s,"add",i,i)),this},set(i,s){!e&&!at(s)&&!Yt(s)&&(s=ae(s));const o=ae(this),{has:a,get:c}=In(o);let l=a.call(o,i);l||(i=ae(i),l=a.call(o,i));const u=c.call(o,i);return o.set(i,s),l?Wt(s,u)&&Ot(o,"set",i,s):Ot(o,"add",i,s),this},delete(i){const s=ae(this),{has:o,get:a}=In(s);let c=o.call(s,i);c||(i=ae(i),c=o.call(s,i)),a&&a.call(s,i);const l=s.delete(i);return c&&Ot(s,"delete",i,void 0),l},clear(){const i=ae(this),s=i.size!==0,o=i.clear();return s&&Ot(i,"clear",void 0,void 0),o}}),["keys","values","entries",Symbol.iterator].forEach(i=>{r[i]=Zu(i,t,e)}),r}function eo(t,e){const r=ef(t,e);return(n,i,s)=>i==="__v_isReactive"?!t:i==="__v_isReadonly"?t:i==="__v_raw"?n:Reflect.get(ce(r,i)&&i in n?r:n,i,s)}const tf={get:eo(!1,!1)},rf={get:eo(!1,!0)},nf={get:eo(!0,!1)};const Uc=new WeakMap,_c=new WeakMap,Lc=new WeakMap,sf=new WeakMap;function of(t){switch(t){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function af(t){return t.__v_skip||!Object.isExtensible(t)?0:of(Ou(t))}function to(t){return Yt(t)?t:ro(t,!1,Qu,tf,Uc)}function cf(t){return ro(t,!1,$u,rf,_c)}function Nc(t){return ro(t,!0,Xu,nf,Lc)}function ro(t,e,r,n,i){if(!we(t)||t.__v_raw&&!(e&&t.__v_isReactive))return t;const s=af(t);if(s===0)return t;const o=i.get(t);if(o)return o;const a=new Proxy(t,s===2?n:r);return i.set(t,a),a}function Pr(t){return Yt(t)?Pr(t.__v_raw):!!(t&&t.__v_isReactive)}function Yt(t){return!!(t&&t.__v_isReadonly)}function at(t){return!!(t&&t.__v_isShallow)}function no(t){return t?!!t.__v_raw:!1}function ae(t){const e=t&&t.__v_raw;return e?ae(e):t}function lf(t){return!ce(t,"__v_skip")&&Object.isExtensible(t)&&As(t,"__v_skip",!0),t}const Re=t=>we(t)?to(t):t,Xn=t=>we(t)?Nc(t):t;function _e(t){return t?t.__v_isRef===!0:!1}function er(t){return uf(t,!1)}function uf(t,e){return _e(t)?t:new ff(t,e)}class ff{constructor(e,r){this.dep=new Zs,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=r?e:ae(e),this._value=r?e:Re(e),this.__v_isShallow=r}get value(){return this.dep.track(),this._value}set value(e){const r=this._rawValue,n=this.__v_isShallow||at(e)||Yt(e);e=n?e:ae(e),Wt(e,r)&&(this._rawValue=e,this._value=n?e:Re(e),this.dep.trigger())}}function jc(t){return _e(t)?t.value:t}const hf={get:(t,e,r)=>e==="__v_raw"?t:jc(Reflect.get(t,e,r)),set:(t,e,r,n)=>{const i=t[e];return _e(i)&&!_e(r)?(i.value=r,!0):Reflect.set(t,e,r,n)}};function Vc(t){return Pr(t)?t:new Proxy(t,hf)}class df{constructor(e,r,n){this.fn=e,this.setter=r,this._value=void 0,this.dep=new Zs(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=un-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!r,this.isSSR=n}notify(){if(this.flags|=16,!(this.flags&8)&&ye!==this)return Ec(this,!0),!0}get value(){const e=this.dep.track();return Ic(this),e&&(e.version=this.dep.version),this._value}set value(e){this.setter&&this.setter(e)}}function mf(t,e,r=!1){let n,i;return ee(t)?n=t:(n=t.get,i=t.set),new df(n,i,r)}const Rn={},$n=new WeakMap;let ir;function pf(t,e=!1,r=ir){if(r){let n=$n.get(r);n||$n.set(r,n=[]),n.push(t)}}function gf(t,e,r=ge){const{immediate:n,deep:i,once:s,scheduler:o,augmentJob:a,call:c}=r,l=B=>i?B:at(B)||i===!1||i===0?Rt(B,1):Rt(B);let u,f,h,p,d=!1,m=!1;if(_e(t)?(f=()=>t.value,d=at(t)):Pr(t)?(f=()=>l(t),d=!0):$(t)?(m=!0,d=t.some(B=>Pr(B)||at(B)),f=()=>t.map(B=>{if(_e(B))return B.value;if(Pr(B))return l(B);if(ee(B))return c?c(B,2):B()})):ee(t)?e?f=c?()=>c(t,2):t:f=()=>{if(h){Ut();try{h()}finally{_t()}}const B=ir;ir=u;try{return c?c(t,3,[p]):t(p)}finally{ir=B}}:f=Tt,e&&i){const B=f,w=i===!0?1/0:i;f=()=>Rt(B(),w)}const b=Hu(),g=()=>{u.stop(),b&&b.active&&Ks(b.effects,u)};if(s&&e){const B=e;e=(...w)=>{B(...w),g()}}let y=m?new Array(t.length).fill(Rn):Rn;const T=B=>{if(!(!(u.flags&1)||!u.dirty&&!B))if(e){const w=u.run();if(i||d||(m?w.some((E,C)=>Wt(E,y[C])):Wt(w,y))){h&&h();const E=ir;ir=u;try{const C=[w,y===Rn?void 0:m&&y[0]===Rn?[]:y,p];y=w,c?c(e,3,C):e(...C)}finally{ir=E}}}else u.run()};return a&&a(T),u=new Mc(f),u.scheduler=o?()=>o(T,!1):T,p=B=>pf(B,!1,u),h=u.onStop=()=>{const B=$n.get(u);if(B){if(c)c(B,4);else for(const w of B)w();$n.delete(u)}},e?n?T(!0):y=u.run():o?o(T.bind(null,!0),!0):u.run(),g.pause=u.pause.bind(u),g.resume=u.resume.bind(u),g.stop=g,g}function Rt(t,e=1/0,r){if(e<=0||!we(t)||t.__v_skip||(r=r||new Set,r.has(t)))return t;if(r.add(t),e--,_e(t))Rt(t.value,e,r);else if($(t))for(let n=0;n<t.length;n++)Rt(t[n],e,r);else if(bc(t)||Sr(t))t.forEach(n=>{Rt(n,e,r)});else if(Bc(t)){for(const n in t)Rt(t[n],e,r);for(const n of Object.getOwnPropertySymbols(t))Object.prototype.propertyIsEnumerable.call(t,n)&&Rt(t[n],e,r)}return t}/**
* @vue/runtime-core v3.5.18
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function yn(t,e,r,n){try{return n?t(...n):t()}catch(i){xi(i,e,r)}}function Ct(t,e,r,n){if(ee(t)){const i=yn(t,e,r,n);return i&&yc(i)&&i.catch(s=>{xi(s,e,r)}),i}if($(t)){const i=[];for(let s=0;s<t.length;s++)i.push(Ct(t[s],e,r,n));return i}}function xi(t,e,r,n=!0){const i=e?e.vnode:null,{errorHandler:s,throwUnhandledErrorInProduction:o}=e&&e.appContext.config||ge;if(e){let a=e.parent;const c=e.proxy,l=`https://vuejs.org/error-reference/#runtime-${r}`;for(;a;){const u=a.ec;if(u){for(let f=0;f<u.length;f++)if(u[f](t,c,l)===!1)return}a=a.parent}if(s){Ut(),yn(s,null,10,[t,c,l]),_t();return}}bf(t,r,i,n,o)}function bf(t,e,r,n=!0,i=!1){if(i)throw t;console.error(t)}const je=[];let bt=-1;const Ir=[];let kt=null,Ar=0;const Hc=Promise.resolve();let Zn=null;function yf(t){const e=Zn||Hc;return t?e.then(this?t.bind(this):t):e}function vf(t){let e=bt+1,r=je.length;for(;e<r;){const n=e+r>>>1,i=je[n],s=hn(i);s<t||s===t&&i.flags&2?e=n+1:r=n}return e}function io(t){if(!(t.flags&1)){const e=hn(t),r=je[je.length-1];!r||!(t.flags&2)&&e>=hn(r)?je.push(t):je.splice(vf(e),0,t),t.flags|=1,kc()}}function kc(){Zn||(Zn=Hc.then(Jc))}function Bf(t){$(t)?Ir.push(...t):kt&&t.id===-1?kt.splice(Ar+1,0,t):t.flags&1||(Ir.push(t),t.flags|=1),kc()}function Ho(t,e,r=bt+1){for(;r<je.length;r++){const n=je[r];if(n&&n.flags&2){if(t&&n.id!==t.uid)continue;je.splice(r,1),r--,n.flags&4&&(n.flags&=-2),n(),n.flags&4||(n.flags&=-2)}}}function zc(t){if(Ir.length){const e=[...new Set(Ir)].sort((r,n)=>hn(r)-hn(n));if(Ir.length=0,kt){kt.push(...e);return}for(kt=e,Ar=0;Ar<kt.length;Ar++){const r=kt[Ar];r.flags&4&&(r.flags&=-2),r.flags&8||r(),r.flags&=-2}kt=null,Ar=0}}const hn=t=>t.id==null?t.flags&2?-1:1/0:t.id;function Jc(t){try{for(bt=0;bt<je.length;bt++){const e=je[bt];e&&!(e.flags&8)&&(e.flags&4&&(e.flags&=-2),yn(e,e.i,e.i?15:14),e.flags&4||(e.flags&=-2))}}finally{for(;bt<je.length;bt++){const e=je[bt];e&&(e.flags&=-2)}bt=-1,je.length=0,zc(),Zn=null,(je.length||Ir.length)&&Jc()}}let ot=null,qc=null;function ei(t){const e=ot;return ot=t,qc=t&&t.type.__scopeId||null,e}function xf(t,e=ot,r){if(!e||t._n)return t;const n=(...i)=>{n._d&&Xo(-1);const s=ei(e);let o;try{o=t(...i)}finally{ei(s),n._d&&Xo(1)}return o};return n._n=!0,n._c=!0,n._d=!0,n}function Af(t,e){if(ot===null)return t;const r=Mi(ot),n=t.dirs||(t.dirs=[]);for(let i=0;i<e.length;i++){let[s,o,a,c=ge]=e[i];s&&(ee(s)&&(s={mounted:s,updated:s}),s.deep&&Rt(o),n.push({dir:s,instance:r,value:o,oldValue:void 0,arg:a,modifiers:c}))}return t}function tr(t,e,r,n){const i=t.dirs,s=e&&e.dirs;for(let o=0;o<i.length;o++){const a=i[o];s&&(a.oldValue=s[o].value);let c=a.dir[n];c&&(Ut(),Ct(c,r,8,[t.el,a,t,e]),_t())}}const Tf=Symbol("_vte"),Cf=t=>t.__isTeleport;function so(t,e){t.shapeFlag&6&&t.component?(t.transition=e,so(t.component.subTree,e)):t.shapeFlag&128?(t.ssContent.transition=e.clone(t.ssContent),t.ssFallback.transition=e.clone(t.ssFallback)):t.transition=e}/*! #__NO_SIDE_EFFECTS__ */function Mf(t,e){return ee(t)?Le({name:t.name},e,{setup:t}):t}function Wc(t){t.ids=[t.ids[0]+t.ids[2]+++"-",0,0]}function en(t,e,r,n,i=!1){if($(t)){t.forEach((d,m)=>en(d,e&&($(e)?e[m]:e),r,n,i));return}if(tn(n)&&!i){n.shapeFlag&512&&n.type.__asyncResolved&&n.component.subTree.component&&en(t,e,r,n.component.subTree);return}const s=n.shapeFlag&4?Mi(n.component):n.el,o=i?null:s,{i:a,r:c}=t,l=e&&e.r,u=a.refs===ge?a.refs={}:a.refs,f=a.setupState,h=ae(f),p=f===ge?()=>!1:d=>ce(h,d);if(l!=null&&l!==c&&(Pe(l)?(u[l]=null,p(l)&&(f[l]=null)):_e(l)&&(l.value=null)),ee(c))yn(c,a,12,[o,u]);else{const d=Pe(c),m=_e(c);if(d||m){const b=()=>{if(t.f){const g=d?p(c)?f[c]:u[c]:c.value;i?$(g)&&Ks(g,s):$(g)?g.includes(s)||g.push(s):d?(u[c]=[s],p(c)&&(f[c]=u[c])):(c.value=[s],t.k&&(u[t.k]=c.value))}else d?(u[c]=o,p(c)&&(f[c]=o)):m&&(c.value=o,t.k&&(u[t.k]=o))};o?(b.id=-1,$e(b,r)):b()}}}yi().requestIdleCallback;yi().cancelIdleCallback;const tn=t=>!!t.type.__asyncLoader,Kc=t=>t.type.__isKeepAlive;function wf(t,e){Yc(t,"a",e)}function Ef(t,e){Yc(t,"da",e)}function Yc(t,e,r=Ve){const n=t.__wdc||(t.__wdc=()=>{let i=r;for(;i;){if(i.isDeactivated)return;i=i.parent}return t()});if(Ai(e,n,r),r){let i=r.parent;for(;i&&i.parent;)Kc(i.parent.vnode)&&Sf(n,e,r,i),i=i.parent}}function Sf(t,e,r,n){const i=Ai(e,t,n,!0);Xc(()=>{Ks(n[e],i)},r)}function Ai(t,e,r=Ve,n=!1){if(r){const i=r[t]||(r[t]=[]),s=e.__weh||(e.__weh=(...o)=>{Ut();const a=vn(r),c=Ct(e,r,t,o);return a(),_t(),c});return n?i.unshift(s):i.push(s),s}}const jt=t=>(e,r=Ve)=>{(!mn||t==="sp")&&Ai(t,(...n)=>e(...n),r)},Pf=jt("bm"),Qc=jt("m"),If=jt("bu"),Of=jt("u"),Rf=jt("bum"),Xc=jt("um"),Df=jt("sp"),Gf=jt("rtg"),Ff=jt("rtc");function Uf(t,e=Ve){Ai("ec",t,e)}const _f=Symbol.for("v-ndc");function Lf(t,e,r,n){let i;const s=r,o=$(t);if(o||Pe(t)){const a=o&&Pr(t);let c=!1,l=!1;a&&(c=!at(t),l=Yt(t),t=Bi(t)),i=new Array(t.length);for(let u=0,f=t.length;u<f;u++)i[u]=e(c?l?Xn(Re(t[u])):Re(t[u]):t[u],u,void 0,s)}else if(typeof t=="number"){i=new Array(t);for(let a=0;a<t;a++)i[a]=e(a+1,a,void 0,s)}else if(we(t))if(t[Symbol.iterator])i=Array.from(t,(a,c)=>e(a,c,void 0,s));else{const a=Object.keys(t);i=new Array(a.length);for(let c=0,l=a.length;c<l;c++){const u=a[c];i[c]=e(t[u],u,c,s)}}else i=[];return i}const Es=t=>t?yl(t)?Mi(t):Es(t.parent):null,rn=Le(Object.create(null),{$:t=>t,$el:t=>t.vnode.el,$data:t=>t.data,$props:t=>t.props,$attrs:t=>t.attrs,$slots:t=>t.slots,$refs:t=>t.refs,$parent:t=>Es(t.parent),$root:t=>Es(t.root),$host:t=>t.ce,$emit:t=>t.emit,$options:t=>Zc(t),$forceUpdate:t=>t.f||(t.f=()=>{io(t.update)}),$nextTick:t=>t.n||(t.n=yf.bind(t.proxy)),$watch:t=>oh.bind(t)}),ki=(t,e)=>t!==ge&&!t.__isScriptSetup&&ce(t,e),Nf={get({_:t},e){if(e==="__v_skip")return!0;const{ctx:r,setupState:n,data:i,props:s,accessCache:o,type:a,appContext:c}=t;let l;if(e[0]!=="$"){const p=o[e];if(p!==void 0)switch(p){case 1:return n[e];case 2:return i[e];case 4:return r[e];case 3:return s[e]}else{if(ki(n,e))return o[e]=1,n[e];if(i!==ge&&ce(i,e))return o[e]=2,i[e];if((l=t.propsOptions[0])&&ce(l,e))return o[e]=3,s[e];if(r!==ge&&ce(r,e))return o[e]=4,r[e];Ss&&(o[e]=0)}}const u=rn[e];let f,h;if(u)return e==="$attrs"&&Fe(t.attrs,"get",""),u(t);if((f=a.__cssModules)&&(f=f[e]))return f;if(r!==ge&&ce(r,e))return o[e]=4,r[e];if(h=c.config.globalProperties,ce(h,e))return h[e]},set({_:t},e,r){const{data:n,setupState:i,ctx:s}=t;return ki(i,e)?(i[e]=r,!0):n!==ge&&ce(n,e)?(n[e]=r,!0):ce(t.props,e)||e[0]==="$"&&e.slice(1)in t?!1:(s[e]=r,!0)},has({_:{data:t,setupState:e,accessCache:r,ctx:n,appContext:i,propsOptions:s}},o){let a;return!!r[o]||t!==ge&&ce(t,o)||ki(e,o)||(a=s[0])&&ce(a,o)||ce(n,o)||ce(rn,o)||ce(i.config.globalProperties,o)},defineProperty(t,e,r){return r.get!=null?t._.accessCache[e]=0:ce(r,"value")&&this.set(t,e,r.value,null),Reflect.defineProperty(t,e,r)}};function ko(t){return $(t)?t.reduce((e,r)=>(e[r]=null,e),{}):t}let Ss=!0;function jf(t){const e=Zc(t),r=t.proxy,n=t.ctx;Ss=!1,e.beforeCreate&&zo(e.beforeCreate,t,"bc");const{data:i,computed:s,methods:o,watch:a,provide:c,inject:l,created:u,beforeMount:f,mounted:h,beforeUpdate:p,updated:d,activated:m,deactivated:b,beforeDestroy:g,beforeUnmount:y,destroyed:T,unmounted:B,render:w,renderTracked:E,renderTriggered:C,errorCaptured:I,serverPrefetch:O,expose:L,inheritAttrs:N,components:V,directives:j,filters:P}=e;if(l&&Vf(l,n,null),o)for(const D in o){const F=o[D];ee(F)&&(n[D]=F.bind(r))}if(i){const D=i.call(r,r);we(D)&&(t.data=to(D))}if(Ss=!0,s)for(const D in s){const F=s[D],te=ee(F)?F.bind(r,r):ee(F.get)?F.get.bind(r,r):Tt,ne=!ee(F)&&ee(F.set)?F.set.bind(r):Tt,re=Rs({get:te,set:ne});Object.defineProperty(n,D,{enumerable:!0,configurable:!0,get:()=>re.value,set:Z=>re.value=Z})}if(a)for(const D in a)$c(a[D],n,r,D);if(c){const D=ee(c)?c.call(r):c;Reflect.ownKeys(D).forEach(F=>{Wf(F,D[F])})}u&&zo(u,t,"c");function H(D,F){$(F)?F.forEach(te=>D(te.bind(r))):F&&D(F.bind(r))}if(H(Pf,f),H(Qc,h),H(If,p),H(Of,d),H(wf,m),H(Ef,b),H(Uf,I),H(Ff,E),H(Gf,C),H(Rf,y),H(Xc,B),H(Df,O),$(L))if(L.length){const D=t.exposed||(t.exposed={});L.forEach(F=>{Object.defineProperty(D,F,{get:()=>r[F],set:te=>r[F]=te,enumerable:!0})})}else t.exposed||(t.exposed={});w&&t.render===Tt&&(t.render=w),N!=null&&(t.inheritAttrs=N),V&&(t.components=V),j&&(t.directives=j),O&&Wc(t)}function Vf(t,e,r=Tt){$(t)&&(t=Ps(t));for(const n in t){const i=t[n];let s;we(i)?"default"in i?s=Hn(i.from||n,i.default,!0):s=Hn(i.from||n):s=Hn(i),_e(s)?Object.defineProperty(e,n,{enumerable:!0,configurable:!0,get:()=>s.value,set:o=>s.value=o}):e[n]=s}}function zo(t,e,r){Ct($(t)?t.map(n=>n.bind(e.proxy)):t.bind(e.proxy),e,r)}function $c(t,e,r,n){let i=n.includes(".")?hl(r,n):()=>r[n];if(Pe(t)){const s=e[t];ee(s)&&Ji(i,s)}else if(ee(t))Ji(i,t.bind(r));else if(we(t))if($(t))t.forEach(s=>$c(s,e,r,n));else{const s=ee(t.handler)?t.handler.bind(r):e[t.handler];ee(s)&&Ji(i,s,t)}}function Zc(t){const e=t.type,{mixins:r,extends:n}=e,{mixins:i,optionsCache:s,config:{optionMergeStrategies:o}}=t.appContext,a=s.get(e);let c;return a?c=a:!i.length&&!r&&!n?c=e:(c={},i.length&&i.forEach(l=>ti(c,l,o,!0)),ti(c,e,o)),we(e)&&s.set(e,c),c}function ti(t,e,r,n=!1){const{mixins:i,extends:s}=e;s&&ti(t,s,r,!0),i&&i.forEach(o=>ti(t,o,r,!0));for(const o in e)if(!(n&&o==="expose")){const a=Hf[o]||r&&r[o];t[o]=a?a(t[o],e[o]):e[o]}return t}const Hf={data:Jo,props:qo,emits:qo,methods:Kr,computed:Kr,beforeCreate:Ne,created:Ne,beforeMount:Ne,mounted:Ne,beforeUpdate:Ne,updated:Ne,beforeDestroy:Ne,beforeUnmount:Ne,destroyed:Ne,unmounted:Ne,activated:Ne,deactivated:Ne,errorCaptured:Ne,serverPrefetch:Ne,components:Kr,directives:Kr,watch:zf,provide:Jo,inject:kf};function Jo(t,e){return e?t?function(){return Le(ee(t)?t.call(this,this):t,ee(e)?e.call(this,this):e)}:e:t}function kf(t,e){return Kr(Ps(t),Ps(e))}function Ps(t){if($(t)){const e={};for(let r=0;r<t.length;r++)e[t[r]]=t[r];return e}return t}function Ne(t,e){return t?[...new Set([].concat(t,e))]:e}function Kr(t,e){return t?Le(Object.create(null),t,e):e}function qo(t,e){return t?$(t)&&$(e)?[...new Set([...t,...e])]:Le(Object.create(null),ko(t),ko(e??{})):e}function zf(t,e){if(!t)return e;if(!e)return t;const r=Le(Object.create(null),t);for(const n in e)r[n]=Ne(t[n],e[n]);return r}function el(){return{app:null,config:{isNativeTag:Pu,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Jf=0;function qf(t,e){return function(n,i=null){ee(n)||(n=Le({},n)),i!=null&&!we(i)&&(i=null);const s=el(),o=new WeakSet,a=[];let c=!1;const l=s.app={_uid:Jf++,_component:n,_props:i,_container:null,_context:s,_instance:null,version:Sh,get config(){return s.config},set config(u){},use(u,...f){return o.has(u)||(u&&ee(u.install)?(o.add(u),u.install(l,...f)):ee(u)&&(o.add(u),u(l,...f))),l},mixin(u){return s.mixins.includes(u)||s.mixins.push(u),l},component(u,f){return f?(s.components[u]=f,l):s.components[u]},directive(u,f){return f?(s.directives[u]=f,l):s.directives[u]},mount(u,f,h){if(!c){const p=l._ceVNode||ur(n,i);return p.appContext=s,h===!0?h="svg":h===!1&&(h=void 0),t(p,u,h),c=!0,l._container=u,u.__vue_app__=l,Mi(p.component)}},onUnmount(u){a.push(u)},unmount(){c&&(Ct(a,l._instance,16),t(null,l._container),delete l._container.__vue_app__)},provide(u,f){return s.provides[u]=f,l},runWithContext(u){const f=Or;Or=l;try{return u()}finally{Or=f}}};return l}}let Or=null;function Wf(t,e){if(Ve){let r=Ve.provides;const n=Ve.parent&&Ve.parent.provides;n===r&&(r=Ve.provides=Object.create(n)),r[t]=e}}function Hn(t,e,r=!1){const n=Ah();if(n||Or){let i=Or?Or._context.provides:n?n.parent==null||n.ce?n.vnode.appContext&&n.vnode.appContext.provides:n.parent.provides:void 0;if(i&&t in i)return i[t];if(arguments.length>1)return r&&ee(e)?e.call(n&&n.proxy):e}}const tl={},rl=()=>Object.create(tl),nl=t=>Object.getPrototypeOf(t)===tl;function Kf(t,e,r,n=!1){const i={},s=rl();t.propsDefaults=Object.create(null),il(t,e,i,s);for(const o in t.propsOptions[0])o in i||(i[o]=void 0);r?t.props=n?i:cf(i):t.type.props?t.props=i:t.props=s,t.attrs=s}function Yf(t,e,r,n){const{props:i,attrs:s,vnode:{patchFlag:o}}=t,a=ae(i),[c]=t.propsOptions;let l=!1;if((n||o>0)&&!(o&16)){if(o&8){const u=t.vnode.dynamicProps;for(let f=0;f<u.length;f++){let h=u[f];if(Ti(t.emitsOptions,h))continue;const p=e[h];if(c)if(ce(s,h))p!==s[h]&&(s[h]=p,l=!0);else{const d=Kt(h);i[d]=Is(c,a,d,p,t,!1)}else p!==s[h]&&(s[h]=p,l=!0)}}}else{il(t,e,i,s)&&(l=!0);let u;for(const f in a)(!e||!ce(e,f)&&((u=$t(f))===f||!ce(e,u)))&&(c?r&&(r[f]!==void 0||r[u]!==void 0)&&(i[f]=Is(c,a,f,void 0,t,!0)):delete i[f]);if(s!==a)for(const f in s)(!e||!ce(e,f))&&(delete s[f],l=!0)}l&&Ot(t.attrs,"set","")}function il(t,e,r,n){const[i,s]=t.propsOptions;let o=!1,a;if(e)for(let c in e){if(Xr(c))continue;const l=e[c];let u;i&&ce(i,u=Kt(c))?!s||!s.includes(u)?r[u]=l:(a||(a={}))[u]=l:Ti(t.emitsOptions,c)||(!(c in n)||l!==n[c])&&(n[c]=l,o=!0)}if(s){const c=ae(r),l=a||ge;for(let u=0;u<s.length;u++){const f=s[u];r[f]=Is(i,c,f,l[f],t,!ce(l,f))}}return o}function Is(t,e,r,n,i,s){const o=t[r];if(o!=null){const a=ce(o,"default");if(a&&n===void 0){const c=o.default;if(o.type!==Function&&!o.skipFactory&&ee(c)){const{propsDefaults:l}=i;if(r in l)n=l[r];else{const u=vn(i);n=l[r]=c.call(null,e),u()}}else n=c;i.ce&&i.ce._setProp(r,n)}o[0]&&(s&&!a?n=!1:o[1]&&(n===""||n===$t(r))&&(n=!0))}return n}const Qf=new WeakMap;function sl(t,e,r=!1){const n=r?Qf:e.propsCache,i=n.get(t);if(i)return i;const s=t.props,o={},a=[];let c=!1;if(!ee(t)){const u=f=>{c=!0;const[h,p]=sl(f,e,!0);Le(o,h),p&&a.push(...p)};!r&&e.mixins.length&&e.mixins.forEach(u),t.extends&&u(t.extends),t.mixins&&t.mixins.forEach(u)}if(!s&&!c)return we(t)&&n.set(t,Er),Er;if($(s))for(let u=0;u<s.length;u++){const f=Kt(s[u]);Wo(f)&&(o[f]=ge)}else if(s)for(const u in s){const f=Kt(u);if(Wo(f)){const h=s[u],p=o[f]=$(h)||ee(h)?{type:h}:Le({},h),d=p.type;let m=!1,b=!0;if($(d))for(let g=0;g<d.length;++g){const y=d[g],T=ee(y)&&y.name;if(T==="Boolean"){m=!0;break}else T==="String"&&(b=!1)}else m=ee(d)&&d.name==="Boolean";p[0]=m,p[1]=b,(m||ce(p,"default"))&&a.push(f)}}const l=[o,a];return we(t)&&n.set(t,l),l}function Wo(t){return t[0]!=="$"&&!Xr(t)}const oo=t=>t==="_"||t==="__"||t==="_ctx"||t==="$stable",ao=t=>$(t)?t.map(xt):[xt(t)],Xf=(t,e,r)=>{if(e._n)return e;const n=xf((...i)=>ao(e(...i)),r);return n._c=!1,n},ol=(t,e,r)=>{const n=t._ctx;for(const i in t){if(oo(i))continue;const s=t[i];if(ee(s))e[i]=Xf(i,s,n);else if(s!=null){const o=ao(s);e[i]=()=>o}}},al=(t,e)=>{const r=ao(e);t.slots.default=()=>r},cl=(t,e,r)=>{for(const n in e)(r||!oo(n))&&(t[n]=e[n])},$f=(t,e,r)=>{const n=t.slots=rl();if(t.vnode.shapeFlag&32){const i=e.__;i&&As(n,"__",i,!0);const s=e._;s?(cl(n,e,r),r&&As(n,"_",s,!0)):ol(e,n)}else e&&al(t,e)},Zf=(t,e,r)=>{const{vnode:n,slots:i}=t;let s=!0,o=ge;if(n.shapeFlag&32){const a=e._;a?r&&a===1?s=!1:cl(i,e,r):(s=!e.$stable,ol(e,i)),o=e}else e&&(al(t,e),o={default:1});if(s)for(const a in i)!oo(a)&&o[a]==null&&delete i[a]},$e=dh;function eh(t){return th(t)}function th(t,e){const r=yi();r.__VUE__=!0;const{insert:n,remove:i,patchProp:s,createElement:o,createText:a,createComment:c,setText:l,setElementText:u,parentNode:f,nextSibling:h,setScopeId:p=Tt,insertStaticContent:d}=t,m=(v,A,S,U=null,R=null,G=null,J=void 0,z=null,k=!!A.dynamicChildren)=>{if(v===A)return;v&&!Jr(v,A)&&(U=Ee(v),Z(v,R,G,!0),v=null),A.patchFlag===-2&&(k=!1,A.dynamicChildren=null);const{type:_,ref:Y,shapeFlag:q}=A;switch(_){case Ci:b(v,A,S,U);break;case Dr:g(v,A,S,U);break;case qi:v==null&&y(A,S,U,J);break;case Bt:V(v,A,S,U,R,G,J,z,k);break;default:q&1?w(v,A,S,U,R,G,J,z,k):q&6?j(v,A,S,U,R,G,J,z,k):(q&64||q&128)&&_.process(v,A,S,U,R,G,J,z,k,me)}Y!=null&&R?en(Y,v&&v.ref,G,A||v,!A):Y==null&&v&&v.ref!=null&&en(v.ref,null,G,v,!0)},b=(v,A,S,U)=>{if(v==null)n(A.el=a(A.children),S,U);else{const R=A.el=v.el;A.children!==v.children&&l(R,A.children)}},g=(v,A,S,U)=>{v==null?n(A.el=c(A.children||""),S,U):A.el=v.el},y=(v,A,S,U)=>{[v.el,v.anchor]=d(v.children,A,S,U,v.el,v.anchor)},T=({el:v,anchor:A},S,U)=>{let R;for(;v&&v!==A;)R=h(v),n(v,S,U),v=R;n(A,S,U)},B=({el:v,anchor:A})=>{let S;for(;v&&v!==A;)S=h(v),i(v),v=S;i(A)},w=(v,A,S,U,R,G,J,z,k)=>{A.type==="svg"?J="svg":A.type==="math"&&(J="mathml"),v==null?E(A,S,U,R,G,J,z,k):O(v,A,R,G,J,z,k)},E=(v,A,S,U,R,G,J,z)=>{let k,_;const{props:Y,shapeFlag:q,transition:W,dirs:X}=v;if(k=v.el=o(v.type,G,Y&&Y.is,Y),q&8?u(k,v.children):q&16&&I(v.children,k,null,U,R,zi(v,G),J,z),X&&tr(v,null,U,"created"),C(k,v,v.scopeId,J,U),Y){for(const be in Y)be!=="value"&&!Xr(be)&&s(k,be,null,Y[be],G,U);"value"in Y&&s(k,"value",null,Y.value,G),(_=Y.onVnodeBeforeMount)&&pt(_,U,v)}X&&tr(v,null,U,"beforeMount");const ie=rh(R,W);ie&&W.beforeEnter(k),n(k,A,S),((_=Y&&Y.onVnodeMounted)||ie||X)&&$e(()=>{_&&pt(_,U,v),ie&&W.enter(k),X&&tr(v,null,U,"mounted")},R)},C=(v,A,S,U,R)=>{if(S&&p(v,S),U)for(let G=0;G<U.length;G++)p(v,U[G]);if(R){let G=R.subTree;if(A===G||ml(G.type)&&(G.ssContent===A||G.ssFallback===A)){const J=R.vnode;C(v,J,J.scopeId,J.slotScopeIds,R.parent)}}},I=(v,A,S,U,R,G,J,z,k=0)=>{for(let _=k;_<v.length;_++){const Y=v[_]=z?zt(v[_]):xt(v[_]);m(null,Y,A,S,U,R,G,J,z)}},O=(v,A,S,U,R,G,J)=>{const z=A.el=v.el;let{patchFlag:k,dynamicChildren:_,dirs:Y}=A;k|=v.patchFlag&16;const q=v.props||ge,W=A.props||ge;let X;if(S&&rr(S,!1),(X=W.onVnodeBeforeUpdate)&&pt(X,S,A,v),Y&&tr(A,v,S,"beforeUpdate"),S&&rr(S,!0),(q.innerHTML&&W.innerHTML==null||q.textContent&&W.textContent==null)&&u(z,""),_?L(v.dynamicChildren,_,z,S,U,zi(A,R),G):J||F(v,A,z,null,S,U,zi(A,R),G,!1),k>0){if(k&16)N(z,q,W,S,R);else if(k&2&&q.class!==W.class&&s(z,"class",null,W.class,R),k&4&&s(z,"style",q.style,W.style,R),k&8){const ie=A.dynamicProps;for(let be=0;be<ie.length;be++){const fe=ie[be],ke=q[fe],ze=W[fe];(ze!==ke||fe==="value")&&s(z,fe,ke,ze,R,S)}}k&1&&v.children!==A.children&&u(z,A.children)}else!J&&_==null&&N(z,q,W,S,R);((X=W.onVnodeUpdated)||Y)&&$e(()=>{X&&pt(X,S,A,v),Y&&tr(A,v,S,"updated")},U)},L=(v,A,S,U,R,G,J)=>{for(let z=0;z<A.length;z++){const k=v[z],_=A[z],Y=k.el&&(k.type===Bt||!Jr(k,_)||k.shapeFlag&198)?f(k.el):S;m(k,_,Y,null,U,R,G,J,!0)}},N=(v,A,S,U,R)=>{if(A!==S){if(A!==ge)for(const G in A)!Xr(G)&&!(G in S)&&s(v,G,A[G],null,R,U);for(const G in S){if(Xr(G))continue;const J=S[G],z=A[G];J!==z&&G!=="value"&&s(v,G,z,J,R,U)}"value"in S&&s(v,"value",A.value,S.value,R)}},V=(v,A,S,U,R,G,J,z,k)=>{const _=A.el=v?v.el:a(""),Y=A.anchor=v?v.anchor:a("");let{patchFlag:q,dynamicChildren:W,slotScopeIds:X}=A;X&&(z=z?z.concat(X):X),v==null?(n(_,S,U),n(Y,S,U),I(A.children||[],S,Y,R,G,J,z,k)):q>0&&q&64&&W&&v.dynamicChildren?(L(v.dynamicChildren,W,S,R,G,J,z),(A.key!=null||R&&A===R.subTree)&&ll(v,A,!0)):F(v,A,S,Y,R,G,J,z,k)},j=(v,A,S,U,R,G,J,z,k)=>{A.slotScopeIds=z,v==null?A.shapeFlag&512?R.ctx.activate(A,S,U,J,k):P(A,S,U,R,G,J,k):x(v,A,k)},P=(v,A,S,U,R,G,J)=>{const z=v.component=xh(v,U,R);if(Kc(v)&&(z.ctx.renderer=me),Th(z,!1,J),z.asyncDep){if(R&&R.registerDep(z,H,J),!v.el){const k=z.subTree=ur(Dr);g(null,k,A,S),v.placeholder=k.el}}else H(z,v,A,S,R,G,J)},x=(v,A,S)=>{const U=A.component=v.component;if(fh(v,A,S))if(U.asyncDep&&!U.asyncResolved){D(U,A,S);return}else U.next=A,U.update();else A.el=v.el,U.vnode=A},H=(v,A,S,U,R,G,J)=>{const z=()=>{if(v.isMounted){let{next:q,bu:W,u:X,parent:ie,vnode:be}=v;{const dt=ul(v);if(dt){q&&(q.el=be.el,D(v,q,J)),dt.asyncDep.then(()=>{v.isUnmounted||z()});return}}let fe=q,ke;rr(v,!1),q?(q.el=be.el,D(v,q,J)):q=be,W&&Li(W),(ke=q.props&&q.props.onVnodeBeforeUpdate)&&pt(ke,ie,q,be),rr(v,!0);const ze=Yo(v),ht=v.subTree;v.subTree=ze,m(ht,ze,f(ht.el),Ee(ht),v,R,G),q.el=ze.el,fe===null&&hh(v,ze.el),X&&$e(X,R),(ke=q.props&&q.props.onVnodeUpdated)&&$e(()=>pt(ke,ie,q,be),R)}else{let q;const{el:W,props:X}=A,{bm:ie,m:be,parent:fe,root:ke,type:ze}=v,ht=tn(A);rr(v,!1),ie&&Li(ie),!ht&&(q=X&&X.onVnodeBeforeMount)&&pt(q,fe,A),rr(v,!0);{ke.ce&&ke.ce._def.shadowRoot!==!1&&ke.ce._injectChildStyle(ze);const dt=v.subTree=Yo(v);m(null,dt,S,U,v,R,G),A.el=dt.el}if(be&&$e(be,R),!ht&&(q=X&&X.onVnodeMounted)){const dt=A;$e(()=>pt(q,fe,dt),R)}(A.shapeFlag&256||fe&&tn(fe.vnode)&&fe.vnode.shapeFlag&256)&&v.a&&$e(v.a,R),v.isMounted=!0,A=S=U=null}};v.scope.on();const k=v.effect=new Mc(z);v.scope.off();const _=v.update=k.run.bind(k),Y=v.job=k.runIfDirty.bind(k);Y.i=v,Y.id=v.uid,k.scheduler=()=>io(Y),rr(v,!0),_()},D=(v,A,S)=>{A.component=v;const U=v.vnode.props;v.vnode=A,v.next=null,Yf(v,A.props,U,S),Zf(v,A.children,S),Ut(),Ho(v),_t()},F=(v,A,S,U,R,G,J,z,k=!1)=>{const _=v&&v.children,Y=v?v.shapeFlag:0,q=A.children,{patchFlag:W,shapeFlag:X}=A;if(W>0){if(W&128){ne(_,q,S,U,R,G,J,z,k);return}else if(W&256){te(_,q,S,U,R,G,J,z,k);return}}X&8?(Y&16&&Ce(_,R,G),q!==_&&u(S,q)):Y&16?X&16?ne(_,q,S,U,R,G,J,z,k):Ce(_,R,G,!0):(Y&8&&u(S,""),X&16&&I(q,S,U,R,G,J,z,k))},te=(v,A,S,U,R,G,J,z,k)=>{v=v||Er,A=A||Er;const _=v.length,Y=A.length,q=Math.min(_,Y);let W;for(W=0;W<q;W++){const X=A[W]=k?zt(A[W]):xt(A[W]);m(v[W],X,S,null,R,G,J,z,k)}_>Y?Ce(v,R,G,!0,!1,q):I(A,S,U,R,G,J,z,k,q)},ne=(v,A,S,U,R,G,J,z,k)=>{let _=0;const Y=A.length;let q=v.length-1,W=Y-1;for(;_<=q&&_<=W;){const X=v[_],ie=A[_]=k?zt(A[_]):xt(A[_]);if(Jr(X,ie))m(X,ie,S,null,R,G,J,z,k);else break;_++}for(;_<=q&&_<=W;){const X=v[q],ie=A[W]=k?zt(A[W]):xt(A[W]);if(Jr(X,ie))m(X,ie,S,null,R,G,J,z,k);else break;q--,W--}if(_>q){if(_<=W){const X=W+1,ie=X<Y?A[X].el:U;for(;_<=W;)m(null,A[_]=k?zt(A[_]):xt(A[_]),S,ie,R,G,J,z,k),_++}}else if(_>W)for(;_<=q;)Z(v[_],R,G,!0),_++;else{const X=_,ie=_,be=new Map;for(_=ie;_<=W;_++){const Ye=A[_]=k?zt(A[_]):xt(A[_]);Ye.key!=null&&be.set(Ye.key,_)}let fe,ke=0;const ze=W-ie+1;let ht=!1,dt=0;const kr=new Array(ze);for(_=0;_<ze;_++)kr[_]=0;for(_=X;_<=q;_++){const Ye=v[_];if(ke>=ze){Z(Ye,R,G,!0);continue}let mt;if(Ye.key!=null)mt=be.get(Ye.key);else for(fe=ie;fe<=W;fe++)if(kr[fe-ie]===0&&Jr(Ye,A[fe])){mt=fe;break}mt===void 0?Z(Ye,R,G,!0):(kr[mt-ie]=_+1,mt>=dt?dt=mt:ht=!0,m(Ye,A[mt],S,null,R,G,J,z,k),ke++)}const Uo=ht?nh(kr):Er;for(fe=Uo.length-1,_=ze-1;_>=0;_--){const Ye=ie+_,mt=A[Ye],_o=A[Ye+1],Lo=Ye+1<Y?_o.el||_o.placeholder:U;kr[_]===0?m(null,mt,S,Lo,R,G,J,z,k):ht&&(fe<0||_!==Uo[fe]?re(mt,S,Lo,2):fe--)}}},re=(v,A,S,U,R=null)=>{const{el:G,type:J,transition:z,children:k,shapeFlag:_}=v;if(_&6){re(v.component.subTree,A,S,U);return}if(_&128){v.suspense.move(A,S,U);return}if(_&64){J.move(v,A,S,me);return}if(J===Bt){n(G,A,S);for(let q=0;q<k.length;q++)re(k[q],A,S,U);n(v.anchor,A,S);return}if(J===qi){T(v,A,S);return}if(U!==2&&_&1&&z)if(U===0)z.beforeEnter(G),n(G,A,S),$e(()=>z.enter(G),R);else{const{leave:q,delayLeave:W,afterLeave:X}=z,ie=()=>{v.ctx.isUnmounted?i(G):n(G,A,S)},be=()=>{q(G,()=>{ie(),X&&X()})};W?W(G,ie,be):be()}else n(G,A,S)},Z=(v,A,S,U=!1,R=!1)=>{const{type:G,props:J,ref:z,children:k,dynamicChildren:_,shapeFlag:Y,patchFlag:q,dirs:W,cacheIndex:X}=v;if(q===-2&&(R=!1),z!=null&&(Ut(),en(z,null,S,v,!0),_t()),X!=null&&(A.renderCache[X]=void 0),Y&256){A.ctx.deactivate(v);return}const ie=Y&1&&W,be=!tn(v);let fe;if(be&&(fe=J&&J.onVnodeBeforeUnmount)&&pt(fe,A,v),Y&6)Te(v.component,S,U);else{if(Y&128){v.suspense.unmount(S,U);return}ie&&tr(v,null,A,"beforeUnmount"),Y&64?v.type.remove(v,A,S,me,U):_&&!_.hasOnce&&(G!==Bt||q>0&&q&64)?Ce(_,A,S,!1,!0):(G===Bt&&q&384||!R&&Y&16)&&Ce(k,A,S),U&&de(v)}(be&&(fe=J&&J.onVnodeUnmounted)||ie)&&$e(()=>{fe&&pt(fe,A,v),ie&&tr(v,null,A,"unmounted")},S)},de=v=>{const{type:A,el:S,anchor:U,transition:R}=v;if(A===Bt){Ie(S,U);return}if(A===qi){B(v);return}const G=()=>{i(S),R&&!R.persisted&&R.afterLeave&&R.afterLeave()};if(v.shapeFlag&1&&R&&!R.persisted){const{leave:J,delayLeave:z}=R,k=()=>J(S,G);z?z(v.el,G,k):k()}else G()},Ie=(v,A)=>{let S;for(;v!==A;)S=h(v),i(v),v=S;i(A)},Te=(v,A,S)=>{const{bum:U,scope:R,job:G,subTree:J,um:z,m:k,a:_,parent:Y,slots:{__:q}}=v;Ko(k),Ko(_),U&&Li(U),Y&&$(q)&&q.forEach(W=>{Y.renderCache[W]=void 0}),R.stop(),G&&(G.flags|=8,Z(J,v,A,S)),z&&$e(z,A),$e(()=>{v.isUnmounted=!0},A),A&&A.pendingBranch&&!A.isUnmounted&&v.asyncDep&&!v.asyncResolved&&v.suspenseId===A.pendingId&&(A.deps--,A.deps===0&&A.resolve())},Ce=(v,A,S,U=!1,R=!1,G=0)=>{for(let J=G;J<v.length;J++)Z(v[J],A,S,U,R)},Ee=v=>{if(v.shapeFlag&6)return Ee(v.component.subTree);if(v.shapeFlag&128)return v.suspense.next();const A=h(v.anchor||v.el),S=A&&A[Tf];return S?h(S):A};let Be=!1;const Ke=(v,A,S)=>{v==null?A._vnode&&Z(A._vnode,null,null,!0):m(A._vnode||null,v,A,null,null,null,S),A._vnode=v,Be||(Be=!0,Ho(),zc(),Be=!1)},me={p:m,um:Z,m:re,r:de,mt:P,mc:I,pc:F,pbc:L,n:Ee,o:t};return{render:Ke,hydrate:void 0,createApp:qf(Ke)}}function zi({type:t,props:e},r){return r==="svg"&&t==="foreignObject"||r==="mathml"&&t==="annotation-xml"&&e&&e.encoding&&e.encoding.includes("html")?void 0:r}function rr({effect:t,job:e},r){r?(t.flags|=32,e.flags|=4):(t.flags&=-33,e.flags&=-5)}function rh(t,e){return(!t||t&&!t.pendingBranch)&&e&&!e.persisted}function ll(t,e,r=!1){const n=t.children,i=e.children;if($(n)&&$(i))for(let s=0;s<n.length;s++){const o=n[s];let a=i[s];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=i[s]=zt(i[s]),a.el=o.el),!r&&a.patchFlag!==-2&&ll(o,a)),a.type===Ci&&(a.el=o.el),a.type===Dr&&!a.el&&(a.el=o.el)}}function nh(t){const e=t.slice(),r=[0];let n,i,s,o,a;const c=t.length;for(n=0;n<c;n++){const l=t[n];if(l!==0){if(i=r[r.length-1],t[i]<l){e[n]=i,r.push(n);continue}for(s=0,o=r.length-1;s<o;)a=s+o>>1,t[r[a]]<l?s=a+1:o=a;l<t[r[s]]&&(s>0&&(e[n]=r[s-1]),r[s]=n)}}for(s=r.length,o=r[s-1];s-- >0;)r[s]=o,o=e[o];return r}function ul(t){const e=t.subTree.component;if(e)return e.asyncDep&&!e.asyncResolved?e:ul(e)}function Ko(t){if(t)for(let e=0;e<t.length;e++)t[e].flags|=8}const ih=Symbol.for("v-scx"),sh=()=>Hn(ih);function Ji(t,e,r){return fl(t,e,r)}function fl(t,e,r=ge){const{immediate:n,deep:i,flush:s,once:o}=r,a=Le({},r),c=e&&n||!e&&s!=="post";let l;if(mn){if(s==="sync"){const p=sh();l=p.__watcherHandles||(p.__watcherHandles=[])}else if(!c){const p=()=>{};return p.stop=Tt,p.resume=Tt,p.pause=Tt,p}}const u=Ve;a.call=(p,d,m)=>Ct(p,u,d,m);let f=!1;s==="post"?a.scheduler=p=>{$e(p,u&&u.suspense)}:s!=="sync"&&(f=!0,a.scheduler=(p,d)=>{d?p():io(p)}),a.augmentJob=p=>{e&&(p.flags|=4),f&&(p.flags|=2,u&&(p.id=u.uid,p.i=u))};const h=gf(t,e,a);return mn&&(l?l.push(h):c&&h()),h}function oh(t,e,r){const n=this.proxy,i=Pe(t)?t.includes(".")?hl(n,t):()=>n[t]:t.bind(n,n);let s;ee(e)?s=e:(s=e.handler,r=e);const o=vn(this),a=fl(i,s.bind(n),r);return o(),a}function hl(t,e){const r=e.split(".");return()=>{let n=t;for(let i=0;i<r.length&&n;i++)n=n[r[i]];return n}}const ah=(t,e)=>e==="modelValue"||e==="model-value"?t.modelModifiers:t[`${e}Modifiers`]||t[`${Kt(e)}Modifiers`]||t[`${$t(e)}Modifiers`];function ch(t,e,...r){if(t.isUnmounted)return;const n=t.vnode.props||ge;let i=r;const s=e.startsWith("update:"),o=s&&ah(n,e.slice(7));o&&(o.trim&&(i=r.map(u=>Pe(u)?u.trim():u)),o.number&&(i=r.map(Gu)));let a,c=n[a=_i(e)]||n[a=_i(Kt(e))];!c&&s&&(c=n[a=_i($t(e))]),c&&Ct(c,t,6,i);const l=n[a+"Once"];if(l){if(!t.emitted)t.emitted={};else if(t.emitted[a])return;t.emitted[a]=!0,Ct(l,t,6,i)}}function dl(t,e,r=!1){const n=e.emitsCache,i=n.get(t);if(i!==void 0)return i;const s=t.emits;let o={},a=!1;if(!ee(t)){const c=l=>{const u=dl(l,e,!0);u&&(a=!0,Le(o,u))};!r&&e.mixins.length&&e.mixins.forEach(c),t.extends&&c(t.extends),t.mixins&&t.mixins.forEach(c)}return!s&&!a?(we(t)&&n.set(t,null),null):($(s)?s.forEach(c=>o[c]=null):Le(o,s),we(t)&&n.set(t,o),o)}function Ti(t,e){return!t||!pi(e)?!1:(e=e.slice(2).replace(/Once$/,""),ce(t,e[0].toLowerCase()+e.slice(1))||ce(t,$t(e))||ce(t,e))}function Yo(t){const{type:e,vnode:r,proxy:n,withProxy:i,propsOptions:[s],slots:o,attrs:a,emit:c,render:l,renderCache:u,props:f,data:h,setupState:p,ctx:d,inheritAttrs:m}=t,b=ei(t);let g,y;try{if(r.shapeFlag&4){const B=i||n,w=B;g=xt(l.call(w,B,u,f,p,h,d)),y=a}else{const B=e;g=xt(B.length>1?B(f,{attrs:a,slots:o,emit:c}):B(f,null)),y=e.props?a:lh(a)}}catch(B){nn.length=0,xi(B,t,1),g=ur(Dr)}let T=g;if(y&&m!==!1){const B=Object.keys(y),{shapeFlag:w}=T;B.length&&w&7&&(s&&B.some(Ws)&&(y=uh(y,s)),T=Gr(T,y,!1,!0))}return r.dirs&&(T=Gr(T,null,!1,!0),T.dirs=T.dirs?T.dirs.concat(r.dirs):r.dirs),r.transition&&so(T,r.transition),g=T,ei(b),g}const lh=t=>{let e;for(const r in t)(r==="class"||r==="style"||pi(r))&&((e||(e={}))[r]=t[r]);return e},uh=(t,e)=>{const r={};for(const n in t)(!Ws(n)||!(n.slice(9)in e))&&(r[n]=t[n]);return r};function fh(t,e,r){const{props:n,children:i,component:s}=t,{props:o,children:a,patchFlag:c}=e,l=s.emitsOptions;if(e.dirs||e.transition)return!0;if(r&&c>=0){if(c&1024)return!0;if(c&16)return n?Qo(n,o,l):!!o;if(c&8){const u=e.dynamicProps;for(let f=0;f<u.length;f++){const h=u[f];if(o[h]!==n[h]&&!Ti(l,h))return!0}}}else return(i||a)&&(!a||!a.$stable)?!0:n===o?!1:n?o?Qo(n,o,l):!0:!!o;return!1}function Qo(t,e,r){const n=Object.keys(e);if(n.length!==Object.keys(t).length)return!0;for(let i=0;i<n.length;i++){const s=n[i];if(e[s]!==t[s]&&!Ti(r,s))return!0}return!1}function hh({vnode:t,parent:e},r){for(;e;){const n=e.subTree;if(n.suspense&&n.suspense.activeBranch===t&&(n.el=t.el),n===t)(t=e.vnode).el=r,e=e.parent;else break}}const ml=t=>t.__isSuspense;function dh(t,e){e&&e.pendingBranch?$(t)?e.effects.push(...t):e.effects.push(t):Bf(t)}const Bt=Symbol.for("v-fgt"),Ci=Symbol.for("v-txt"),Dr=Symbol.for("v-cmt"),qi=Symbol.for("v-stc"),nn=[];let tt=null;function Wi(t=!1){nn.push(tt=t?null:[])}function mh(){nn.pop(),tt=nn[nn.length-1]||null}let dn=1;function Xo(t,e=!1){dn+=t,t<0&&tt&&e&&(tt.hasOnce=!0)}function ph(t){return t.dynamicChildren=dn>0?tt||Er:null,mh(),dn>0&&tt&&tt.push(t),t}function Ki(t,e,r,n,i,s){return ph(yt(t,e,r,n,i,s,!0))}function pl(t){return t?t.__v_isVNode===!0:!1}function Jr(t,e){return t.type===e.type&&t.key===e.key}const gl=({key:t})=>t??null,kn=({ref:t,ref_key:e,ref_for:r})=>(typeof t=="number"&&(t=""+t),t!=null?Pe(t)||_e(t)||ee(t)?{i:ot,r:t,k:e,f:!!r}:t:null);function yt(t,e=null,r=null,n=0,i=null,s=t===Bt?0:1,o=!1,a=!1){const c={__v_isVNode:!0,__v_skip:!0,type:t,props:e,key:e&&gl(e),ref:e&&kn(e),scopeId:qc,slotScopeIds:null,children:r,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:s,patchFlag:n,dynamicProps:i,dynamicChildren:null,appContext:null,ctx:ot};return a?(co(c,r),s&128&&t.normalize(c)):r&&(c.shapeFlag|=Pe(r)?8:16),dn>0&&!o&&tt&&(c.patchFlag>0||s&6)&&c.patchFlag!==32&&tt.push(c),c}const ur=gh;function gh(t,e=null,r=null,n=0,i=null,s=!1){if((!t||t===_f)&&(t=Dr),pl(t)){const a=Gr(t,e,!0);return r&&co(a,r),dn>0&&!s&&tt&&(a.shapeFlag&6?tt[tt.indexOf(t)]=a:tt.push(a)),a.patchFlag=-2,a}if(Eh(t)&&(t=t.__vccOpts),e){e=bh(e);let{class:a,style:c}=e;a&&!Pe(a)&&(e.class=ln(a)),we(c)&&(no(c)&&!$(c)&&(c=Le({},c)),e.style=vi(c))}const o=Pe(t)?1:ml(t)?128:Cf(t)?64:we(t)?4:ee(t)?2:0;return yt(t,e,r,n,i,o,s,!0)}function bh(t){return t?no(t)||nl(t)?Le({},t):t:null}function Gr(t,e,r=!1,n=!1){const{props:i,ref:s,patchFlag:o,children:a,transition:c}=t,l=e?yh(i||{},e):i,u={__v_isVNode:!0,__v_skip:!0,type:t.type,props:l,key:l&&gl(l),ref:e&&e.ref?r&&s?$(s)?s.concat(kn(e)):[s,kn(e)]:kn(e):s,scopeId:t.scopeId,slotScopeIds:t.slotScopeIds,children:a,target:t.target,targetStart:t.targetStart,targetAnchor:t.targetAnchor,staticCount:t.staticCount,shapeFlag:t.shapeFlag,patchFlag:e&&t.type!==Bt?o===-1?16:o|16:o,dynamicProps:t.dynamicProps,dynamicChildren:t.dynamicChildren,appContext:t.appContext,dirs:t.dirs,transition:c,component:t.component,suspense:t.suspense,ssContent:t.ssContent&&Gr(t.ssContent),ssFallback:t.ssFallback&&Gr(t.ssFallback),placeholder:t.placeholder,el:t.el,anchor:t.anchor,ctx:t.ctx,ce:t.ce};return c&&n&&so(u,c.clone(u)),u}function bl(t=" ",e=0){return ur(Ci,null,t,e)}function xt(t){return t==null||typeof t=="boolean"?ur(Dr):$(t)?ur(Bt,null,t.slice()):pl(t)?zt(t):ur(Ci,null,String(t))}function zt(t){return t.el===null&&t.patchFlag!==-1||t.memo?t:Gr(t)}function co(t,e){let r=0;const{shapeFlag:n}=t;if(e==null)e=null;else if($(e))r=16;else if(typeof e=="object")if(n&65){const i=e.default;i&&(i._c&&(i._d=!1),co(t,i()),i._c&&(i._d=!0));return}else{r=32;const i=e._;!i&&!nl(e)?e._ctx=ot:i===3&&ot&&(ot.slots._===1?e._=1:(e._=2,t.patchFlag|=1024))}else ee(e)?(e={default:e,_ctx:ot},r=32):(e=String(e),n&64?(r=16,e=[bl(e)]):r=8);t.children=e,t.shapeFlag|=r}function yh(...t){const e={};for(let r=0;r<t.length;r++){const n=t[r];for(const i in n)if(i==="class")e.class!==n.class&&(e.class=ln([e.class,n.class]));else if(i==="style")e.style=vi([e.style,n.style]);else if(pi(i)){const s=e[i],o=n[i];o&&s!==o&&!($(s)&&s.includes(o))&&(e[i]=s?[].concat(s,o):o)}else i!==""&&(e[i]=n[i])}return e}function pt(t,e,r,n=null){Ct(t,e,7,[r,n])}const vh=el();let Bh=0;function xh(t,e,r){const n=t.type,i=(e?e.appContext:t.appContext)||vh,s={uid:Bh++,vnode:t,type:n,parent:e,appContext:i,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new Vu(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(i.provides),ids:e?e.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:sl(n,i),emitsOptions:dl(n,i),emit:null,emitted:null,propsDefaults:ge,inheritAttrs:n.inheritAttrs,ctx:ge,data:ge,props:ge,attrs:ge,slots:ge,refs:ge,setupState:ge,setupContext:null,suspense:r,suspenseId:r?r.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return s.ctx={_:s},s.root=e?e.root:s,s.emit=ch.bind(null,s),t.ce&&t.ce(s),s}let Ve=null;const Ah=()=>Ve||ot;let ri,Os;{const t=yi(),e=(r,n)=>{let i;return(i=t[r])||(i=t[r]=[]),i.push(n),s=>{i.length>1?i.forEach(o=>o(s)):i[0](s)}};ri=e("__VUE_INSTANCE_SETTERS__",r=>Ve=r),Os=e("__VUE_SSR_SETTERS__",r=>mn=r)}const vn=t=>{const e=Ve;return ri(t),t.scope.on(),()=>{t.scope.off(),ri(e)}},$o=()=>{Ve&&Ve.scope.off(),ri(null)};function yl(t){return t.vnode.shapeFlag&4}let mn=!1;function Th(t,e=!1,r=!1){e&&Os(e);const{props:n,children:i}=t.vnode,s=yl(t);Kf(t,n,s,e),$f(t,i,r||e);const o=s?Ch(t,e):void 0;return e&&Os(!1),o}function Ch(t,e){const r=t.type;t.accessCache=Object.create(null),t.proxy=new Proxy(t.ctx,Nf);const{setup:n}=r;if(n){Ut();const i=t.setupContext=n.length>1?wh(t):null,s=vn(t),o=yn(n,t,0,[t.props,i]),a=yc(o);if(_t(),s(),(a||t.sp)&&!tn(t)&&Wc(t),a){if(o.then($o,$o),e)return o.then(c=>{Zo(t,c)}).catch(c=>{xi(c,t,0)});t.asyncDep=o}else Zo(t,o)}else vl(t)}function Zo(t,e,r){ee(e)?t.type.__ssrInlineRender?t.ssrRender=e:t.render=e:we(e)&&(t.setupState=Vc(e)),vl(t)}function vl(t,e,r){const n=t.type;t.render||(t.render=n.render||Tt);{const i=vn(t);Ut();try{jf(t)}finally{_t(),i()}}}const Mh={get(t,e){return Fe(t,"get",""),t[e]}};function wh(t){const e=r=>{t.exposed=r||{}};return{attrs:new Proxy(t.attrs,Mh),slots:t.slots,emit:t.emit,expose:e}}function Mi(t){return t.exposed?t.exposeProxy||(t.exposeProxy=new Proxy(Vc(lf(t.exposed)),{get(e,r){if(r in e)return e[r];if(r in rn)return rn[r](t)},has(e,r){return r in e||r in rn}})):t.proxy}function Eh(t){return ee(t)&&"__vccOpts"in t}const Rs=(t,e)=>mf(t,e,mn),Sh="3.5.18";/**
* @vue/runtime-dom v3.5.18
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let Ds;const ea=typeof window<"u"&&window.trustedTypes;if(ea)try{Ds=ea.createPolicy("vue",{createHTML:t=>t})}catch{}const Bl=Ds?t=>Ds.createHTML(t):t=>t,Ph="http://www.w3.org/2000/svg",Ih="http://www.w3.org/1998/Math/MathML",Pt=typeof document<"u"?document:null,ta=Pt&&Pt.createElement("template"),Oh={insert:(t,e,r)=>{e.insertBefore(t,r||null)},remove:t=>{const e=t.parentNode;e&&e.removeChild(t)},createElement:(t,e,r,n)=>{const i=e==="svg"?Pt.createElementNS(Ph,t):e==="mathml"?Pt.createElementNS(Ih,t):r?Pt.createElement(t,{is:r}):Pt.createElement(t);return t==="select"&&n&&n.multiple!=null&&i.setAttribute("multiple",n.multiple),i},createText:t=>Pt.createTextNode(t),createComment:t=>Pt.createComment(t),setText:(t,e)=>{t.nodeValue=e},setElementText:(t,e)=>{t.textContent=e},parentNode:t=>t.parentNode,nextSibling:t=>t.nextSibling,querySelector:t=>Pt.querySelector(t),setScopeId(t,e){t.setAttribute(e,"")},insertStaticContent(t,e,r,n,i,s){const o=r?r.previousSibling:e.lastChild;if(i&&(i===s||i.nextSibling))for(;e.insertBefore(i.cloneNode(!0),r),!(i===s||!(i=i.nextSibling)););else{ta.innerHTML=Bl(n==="svg"?`<svg>${t}</svg>`:n==="mathml"?`<math>${t}</math>`:t);const a=ta.content;if(n==="svg"||n==="mathml"){const c=a.firstChild;for(;c.firstChild;)a.appendChild(c.firstChild);a.removeChild(c)}e.insertBefore(a,r)}return[o?o.nextSibling:e.firstChild,r?r.previousSibling:e.lastChild]}},Rh=Symbol("_vtc");function Dh(t,e,r){const n=t[Rh];n&&(e=(e?[e,...n]:[...n]).join(" ")),e==null?t.removeAttribute("class"):r?t.setAttribute("class",e):t.className=e}const ni=Symbol("_vod"),xl=Symbol("_vsh"),Gh={beforeMount(t,{value:e},{transition:r}){t[ni]=t.style.display==="none"?"":t.style.display,r&&e?r.beforeEnter(t):qr(t,e)},mounted(t,{value:e},{transition:r}){r&&e&&r.enter(t)},updated(t,{value:e,oldValue:r},{transition:n}){!e!=!r&&(n?e?(n.beforeEnter(t),qr(t,!0),n.enter(t)):n.leave(t,()=>{qr(t,!1)}):qr(t,e))},beforeUnmount(t,{value:e}){qr(t,e)}};function qr(t,e){t.style.display=e?t[ni]:"none",t[xl]=!e}const Fh=Symbol(""),Uh=/(^|;)\s*display\s*:/;function _h(t,e,r){const n=t.style,i=Pe(r);let s=!1;if(r&&!i){if(e)if(Pe(e))for(const o of e.split(";")){const a=o.slice(0,o.indexOf(":")).trim();r[a]==null&&zn(n,a,"")}else for(const o in e)r[o]==null&&zn(n,o,"");for(const o in r)o==="display"&&(s=!0),zn(n,o,r[o])}else if(i){if(e!==r){const o=n[Fh];o&&(r+=";"+o),n.cssText=r,s=Uh.test(r)}}else e&&t.removeAttribute("style");ni in t&&(t[ni]=s?n.display:"",t[xl]&&(n.display="none"))}const ra=/\s*!important$/;function zn(t,e,r){if($(r))r.forEach(n=>zn(t,e,n));else if(r==null&&(r=""),e.startsWith("--"))t.setProperty(e,r);else{const n=Lh(t,e);ra.test(r)?t.setProperty($t(n),r.replace(ra,""),"important"):t[n]=r}}const na=["Webkit","Moz","ms"],Yi={};function Lh(t,e){const r=Yi[e];if(r)return r;let n=Kt(e);if(n!=="filter"&&n in t)return Yi[e]=n;n=xc(n);for(let i=0;i<na.length;i++){const s=na[i]+n;if(s in t)return Yi[e]=s}return e}const ia="http://www.w3.org/1999/xlink";function sa(t,e,r,n,i,s=ju(e)){n&&e.startsWith("xlink:")?r==null?t.removeAttributeNS(ia,e.slice(6,e.length)):t.setAttributeNS(ia,e,r):r==null||s&&!Ac(r)?t.removeAttribute(e):t.setAttribute(e,s?"":Xt(r)?String(r):r)}function oa(t,e,r,n,i){if(e==="innerHTML"||e==="textContent"){r!=null&&(t[e]=e==="innerHTML"?Bl(r):r);return}const s=t.tagName;if(e==="value"&&s!=="PROGRESS"&&!s.includes("-")){const a=s==="OPTION"?t.getAttribute("value")||"":t.value,c=r==null?t.type==="checkbox"?"on":"":String(r);(a!==c||!("_value"in t))&&(t.value=c),r==null&&t.removeAttribute(e),t._value=r;return}let o=!1;if(r===""||r==null){const a=typeof t[e];a==="boolean"?r=Ac(r):r==null&&a==="string"?(r="",o=!0):a==="number"&&(r=0,o=!0)}try{t[e]=r}catch{}o&&t.removeAttribute(i||e)}function Nh(t,e,r,n){t.addEventListener(e,r,n)}function jh(t,e,r,n){t.removeEventListener(e,r,n)}const aa=Symbol("_vei");function Vh(t,e,r,n,i=null){const s=t[aa]||(t[aa]={}),o=s[e];if(n&&o)o.value=n;else{const[a,c]=Hh(e);if(n){const l=s[e]=Jh(n,i);Nh(t,a,l,c)}else o&&(jh(t,a,o,c),s[e]=void 0)}}const ca=/(?:Once|Passive|Capture)$/;function Hh(t){let e;if(ca.test(t)){e={};let n;for(;n=t.match(ca);)t=t.slice(0,t.length-n[0].length),e[n[0].toLowerCase()]=!0}return[t[2]===":"?t.slice(3):$t(t.slice(2)),e]}let Qi=0;const kh=Promise.resolve(),zh=()=>Qi||(kh.then(()=>Qi=0),Qi=Date.now());function Jh(t,e){const r=n=>{if(!n._vts)n._vts=Date.now();else if(n._vts<=r.attached)return;Ct(qh(n,r.value),e,5,[n])};return r.value=t,r.attached=zh(),r}function qh(t,e){if($(e)){const r=t.stopImmediatePropagation;return t.stopImmediatePropagation=()=>{r.call(t),t._stopped=!0},e.map(n=>i=>!i._stopped&&n&&n(i))}else return e}const la=t=>t.charCodeAt(0)===111&&t.charCodeAt(1)===110&&t.charCodeAt(2)>96&&t.charCodeAt(2)<123,Wh=(t,e,r,n,i,s)=>{const o=i==="svg";e==="class"?Dh(t,n,o):e==="style"?_h(t,r,n):pi(e)?Ws(e)||Vh(t,e,r,n,s):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):Kh(t,e,n,o))?(oa(t,e,n),!t.tagName.includes("-")&&(e==="value"||e==="checked"||e==="selected")&&sa(t,e,n,o,s,e!=="value")):t._isVueCE&&(/[A-Z]/.test(e)||!Pe(n))?oa(t,Kt(e),n,s,e):(e==="true-value"?t._trueValue=n:e==="false-value"&&(t._falseValue=n),sa(t,e,n,o))};function Kh(t,e,r,n){if(n)return!!(e==="innerHTML"||e==="textContent"||e in t&&la(e)&&ee(r));if(e==="spellcheck"||e==="draggable"||e==="translate"||e==="autocorrect"||e==="form"||e==="list"&&t.tagName==="INPUT"||e==="type"&&t.tagName==="TEXTAREA")return!1;if(e==="width"||e==="height"){const i=t.tagName;if(i==="IMG"||i==="VIDEO"||i==="CANVAS"||i==="SOURCE")return!1}return la(e)&&Pe(r)?!1:e in t}const Yh=["ctrl","shift","alt","meta"],Qh={stop:t=>t.stopPropagation(),prevent:t=>t.preventDefault(),self:t=>t.target!==t.currentTarget,ctrl:t=>!t.ctrlKey,shift:t=>!t.shiftKey,alt:t=>!t.altKey,meta:t=>!t.metaKey,left:t=>"button"in t&&t.button!==0,middle:t=>"button"in t&&t.button!==1,right:t=>"button"in t&&t.button!==2,exact:(t,e)=>Yh.some(r=>t[`${r}Key`]&&!e.includes(r))},ua=(t,e)=>{const r=t._withMods||(t._withMods={}),n=e.join(".");return r[n]||(r[n]=(i,...s)=>{for(let o=0;o<e.length;o++){const a=Qh[e[o]];if(a&&a(i,e))return}return t(i,...s)})},Xh={esc:"escape",space:" ",up:"arrow-up",left:"arrow-left",right:"arrow-right",down:"arrow-down",delete:"backspace"},fa=(t,e)=>{const r=t._withKeys||(t._withKeys={}),n=e.join(".");return r[n]||(r[n]=i=>{if(!("key"in i))return;const s=$t(i.key);if(e.some(o=>o===s||Xh[o]===s))return t(i)})},$h=Le({patchProp:Wh},Oh);let ha;function Zh(){return ha||(ha=eh($h))}const ed=(...t)=>{const e=Zh().createApp(...t),{mount:r}=e;return e.mount=n=>{const i=rd(n);if(!i)return;const s=e._component;!ee(s)&&!s.render&&!s.template&&(s.template=i.innerHTML),i.nodeType===1&&(i.textContent="");const o=r(i,!1,td(i));return i instanceof Element&&(i.removeAttribute("v-cloak"),i.setAttribute("data-v-app","")),o},e};function td(t){if(t instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&t instanceof MathMLElement)return"mathml"}function rd(t){return Pe(t)?document.querySelector(t):t}const nd="/projects/webGPU-Basics-Collections/assets/expand-yilVOYUy.png",dr=16;function ve({name:t="default",albedo:e=[1,1,1],roughness:r=.98,metalness:n=0,usePerlinRoughness:i=!1,usePerlinMetalness:s=!1,perlinFreq:o=2,useAlbedoTexture:a=!1,useMetalnessTexture:c=!1,useRoughnessTexture:l=!1,useNormalTexture:u=!1,textureIndex:f=-1}){return{name:t,albedo:e,roughness:r,usePerlinRoughness:i,metalness:n,usePerlinMetalness:s,perlinFreq:o,useAlbedoTexture:a,useMetalnessTexture:c,useRoughnessTexture:l,useNormalTexture:u,textureIndex:f}}function wi(t){const e=new Array(dr),r=new Float32Array(e);return r.set(t.albedo,0),r[3]=t.metalness,r[4]=t.usePerlinMetalness?1:0,r[5]=t.roughness,r[6]=t.usePerlinRoughness?1:0,r[7]=t.perlinFreq,r[8]=t.useAlbedoTexture?1:0,r[9]=t.useMetalnessTexture?1:0,r[10]=t.useRoughnessTexture?1:0,r[11]=t.useNormalTexture?1:0,r[12]=t.textureIndex,r}function lo(t){const e=[];for(const r of t)e.push(...r.albedo),e.push(r.metalness),e.push(r.usePerlinMetalness?1:0),e.push(r.roughness),e.push(r.usePerlinRoughness?1:0),e.push(r.perlinFreq),e.push(r.useAlbedoTexture?1:0),e.push(r.useMetalnessTexture?1:0),e.push(r.useRoughnessTexture?1:0),e.push(r.useNormalTexture?1:0),e.push(r.textureIndex),e.push(0),e.push(0),e.push(0);return new Float32Array(e)}var id=1e-6,Se=typeof Float32Array<"u"?Float32Array:Array,sd="zyx";function Yr(){var t=new Se(4);return Se!=Float32Array&&(t[1]=0,t[2]=0),t[0]=1,t[3]=1,t}function ii(t,e,r,n){var i=new Se(4);return i[0]=t,i[1]=e,i[2]=r,i[3]=n,i}function Jn(t,e){if(t===e){var r=e[1];t[1]=e[2],t[2]=r}else t[0]=e[0],t[1]=e[2],t[2]=e[1],t[3]=e[3];return t}function od(t,e,r){var n=e[0],i=e[1],s=e[2],o=e[3],a=r[0],c=r[1],l=r[2],u=r[3];return t[0]=n*a+s*c,t[1]=i*a+o*c,t[2]=n*l+s*u,t[3]=i*l+o*u,t}function fr(){var t=new Se(9);return Se!=Float32Array&&(t[1]=0,t[2]=0,t[3]=0,t[5]=0,t[6]=0,t[7]=0),t[0]=1,t[4]=1,t[8]=1,t}function ad(t,e){return t[0]=e[0],t[1]=e[1],t[2]=e[2],t[3]=e[4],t[4]=e[5],t[5]=e[6],t[6]=e[8],t[7]=e[9],t[8]=e[10],t}function Gs(t,e,r,n,i,s,o,a,c){var l=new Se(9);return l[0]=t,l[1]=e,l[2]=r,l[3]=n,l[4]=i,l[5]=s,l[6]=o,l[7]=a,l[8]=c,l}function da(t,e){var r=e[0],n=e[1],i=e[2],s=e[3],o=e[4],a=e[5],c=e[6],l=e[7],u=e[8],f=e[9],h=e[10],p=e[11],d=e[12],m=e[13],b=e[14],g=e[15],y=r*a-n*o,T=r*c-i*o,B=r*l-s*o,w=n*c-i*a,E=n*l-s*a,C=i*l-s*c,I=u*m-f*d,O=u*b-h*d,L=u*g-p*d,N=f*b-h*m,V=f*g-p*m,j=h*g-p*b,P=y*j-T*V+B*N+w*L-E*O+C*I;return P?(P=1/P,t[0]=(a*j-c*V+l*N)*P,t[1]=(c*L-o*j-l*O)*P,t[2]=(o*V-a*L+l*I)*P,t[3]=(i*V-n*j-s*N)*P,t[4]=(r*j-i*L+s*O)*P,t[5]=(n*L-r*V-s*I)*P,t[6]=(m*C-b*E+g*w)*P,t[7]=(b*B-d*C-g*T)*P,t[8]=(d*E-m*B+g*y)*P,t):null}function ma(t,e,r){return t[0]=e[0]+r[0],t[1]=e[1]+r[1],t[2]=e[2]+r[2],t[3]=e[3]+r[3],t[4]=e[4]+r[4],t[5]=e[5]+r[5],t[6]=e[6]+r[6],t[7]=e[7]+r[7],t[8]=e[8]+r[8],t}function pa(t,e,r){return t[0]=e[0]*r,t[1]=e[1]*r,t[2]=e[2]*r,t[3]=e[3]*r,t[4]=e[4]*r,t[5]=e[5]*r,t[6]=e[6]*r,t[7]=e[7]*r,t[8]=e[8]*r,t}function Cr(){var t=new Se(16);return Se!=Float32Array&&(t[1]=0,t[2]=0,t[3]=0,t[4]=0,t[6]=0,t[7]=0,t[8]=0,t[9]=0,t[11]=0,t[12]=0,t[13]=0,t[14]=0),t[0]=1,t[5]=1,t[10]=1,t[15]=1,t}function Al(t){return t[0]=1,t[1]=0,t[2]=0,t[3]=0,t[4]=0,t[5]=1,t[6]=0,t[7]=0,t[8]=0,t[9]=0,t[10]=1,t[11]=0,t[12]=0,t[13]=0,t[14]=0,t[15]=1,t}function cd(t,e){var r=e[0],n=e[1],i=e[2],s=e[3],o=e[4],a=e[5],c=e[6],l=e[7],u=e[8],f=e[9],h=e[10],p=e[11],d=e[12],m=e[13],b=e[14],g=e[15],y=r*a-n*o,T=r*c-i*o,B=r*l-s*o,w=n*c-i*a,E=n*l-s*a,C=i*l-s*c,I=u*m-f*d,O=u*b-h*d,L=u*g-p*d,N=f*b-h*m,V=f*g-p*m,j=h*g-p*b,P=y*j-T*V+B*N+w*L-E*O+C*I;return P?(P=1/P,t[0]=(a*j-c*V+l*N)*P,t[1]=(i*V-n*j-s*N)*P,t[2]=(m*C-b*E+g*w)*P,t[3]=(h*E-f*C-p*w)*P,t[4]=(c*L-o*j-l*O)*P,t[5]=(r*j-i*L+s*O)*P,t[6]=(b*B-d*C-g*T)*P,t[7]=(u*C-h*B+p*T)*P,t[8]=(o*V-a*L+l*I)*P,t[9]=(n*L-r*V-s*I)*P,t[10]=(d*E-m*B+g*y)*P,t[11]=(f*B-u*E-p*y)*P,t[12]=(a*O-o*N-c*I)*P,t[13]=(r*N-n*O+i*I)*P,t[14]=(m*T-d*w-b*y)*P,t[15]=(u*w-f*T+h*y)*P,t):null}function ld(t,e,r,n){var i=e[0],s=e[1],o=e[2],a=e[3],c=i+i,l=s+s,u=o+o,f=i*c,h=i*l,p=i*u,d=s*l,m=s*u,b=o*u,g=a*c,y=a*l,T=a*u,B=n[0],w=n[1],E=n[2];return t[0]=(1-(d+b))*B,t[1]=(h+T)*B,t[2]=(p-y)*B,t[3]=0,t[4]=(h-T)*w,t[5]=(1-(f+b))*w,t[6]=(m+g)*w,t[7]=0,t[8]=(p+y)*E,t[9]=(m-g)*E,t[10]=(1-(f+d))*E,t[11]=0,t[12]=r[0],t[13]=r[1],t[14]=r[2],t[15]=1,t}function se(){var t=new Se(3);return Se!=Float32Array&&(t[0]=0,t[1]=0,t[2]=0),t}function ud(t){var e=new Se(3);return e[0]=t[0],e[1]=t[1],e[2]=t[2],e}function qn(t){var e=t[0],r=t[1],n=t[2];return Math.sqrt(e*e+r*r+n*n)}function M(t,e,r){var n=new Se(3);return n[0]=t,n[1]=e,n[2]=r,n}function Jt(t,e,r){return t[0]=e[0]+r[0],t[1]=e[1]+r[1],t[2]=e[2]+r[2],t}function Fs(t,e,r){return t[0]=e[0]-r[0],t[1]=e[1]-r[1],t[2]=e[2]-r[2],t}function Vt(t,e,r){return t[0]=e[0]*r,t[1]=e[1]*r,t[2]=e[2]*r,t}function Ei(t,e){var r=e[0],n=e[1],i=e[2],s=r*r+n*n+i*i;return s>0&&(s=1/Math.sqrt(s)),t[0]=e[0]*s,t[1]=e[1]*s,t[2]=e[2]*s,t}function or(t,e){return t[0]*e[0]+t[1]*e[1]+t[2]*e[2]}function Wn(t,e,r){var n=e[0],i=e[1],s=e[2],o=r[0],a=r[1],c=r[2];return t[0]=i*c-s*a,t[1]=s*o-n*c,t[2]=n*a-i*o,t}function ga(t,e,r){var n=e[0],i=e[1],s=e[2],o=r[3]*n+r[7]*i+r[11]*s+r[15];return o=o||1,t[0]=(r[0]*n+r[4]*i+r[8]*s+r[12])/o,t[1]=(r[1]*n+r[5]*i+r[9]*s+r[13])/o,t[2]=(r[2]*n+r[6]*i+r[10]*s+r[14])/o,t}function pn(t,e,r){var n=e[0],i=e[1],s=e[2];return t[0]=n*r[0]+i*r[3]+s*r[6],t[1]=n*r[1]+i*r[4]+s*r[7],t[2]=n*r[2]+i*r[5]+s*r[8],t}var Mr=Fs,fd=qn;(function(){var t=se();return function(e,r,n,i,s,o){var a,c;for(r||(r=3),n||(n=0),i?c=Math.min(i*r+n,e.length):c=e.length,a=n;a<c;a+=r)t[0]=e[a],t[1]=e[a+1],t[2]=e[a+2],s(t,t,o),e[a]=t[0],e[a+1]=t[1],e[a+2]=t[2];return e}})();function hd(){var t=new Se(4);return Se!=Float32Array&&(t[0]=0,t[1]=0,t[2]=0,t[3]=0),t}function dd(t,e,r,n){var i=new Se(4);return i[0]=t,i[1]=e,i[2]=r,i[3]=n,i}function md(t,e){var r=e[0],n=e[1],i=e[2],s=e[3],o=r*r+n*n+i*i+s*s;return o>0&&(o=1/Math.sqrt(o)),t[0]=r*o,t[1]=n*o,t[2]=i*o,t[3]=s*o,t}(function(){var t=hd();return function(e,r,n,i,s,o){var a,c;for(r||(r=4),n||(n=0),i?c=Math.min(i*r+n,e.length):c=e.length,a=n;a<c;a+=r)t[0]=e[a],t[1]=e[a+1],t[2]=e[a+2],t[3]=e[a+3],s(t,t,o),e[a]=t[0],e[a+1]=t[1],e[a+2]=t[2],e[a+3]=t[3];return e}})();function Dt(){var t=new Se(4);return Se!=Float32Array&&(t[0]=0,t[1]=0,t[2]=0),t[3]=1,t}function pd(t,e,r){r=r*.5;var n=Math.sin(r);return t[0]=n*e[0],t[1]=n*e[1],t[2]=n*e[2],t[3]=Math.cos(r),t}function gd(t,e,r){var n=e[0],i=e[1],s=e[2],o=e[3],a=r[0],c=r[1],l=r[2],u=r[3];return t[0]=n*u+o*a+i*l-s*c,t[1]=i*u+o*c+s*a-n*l,t[2]=s*u+o*l+n*c-i*a,t[3]=o*u-n*a-i*c-s*l,t}function Xi(t,e,r,n){var i=e[0],s=e[1],o=e[2],a=e[3],c=r[0],l=r[1],u=r[2],f=r[3],h,p,d,m,b;return p=i*c+s*l+o*u+a*f,p<0&&(p=-p,c=-c,l=-l,u=-u,f=-f),1-p>id?(h=Math.acos(p),d=Math.sin(h),m=Math.sin((1-n)*h)/d,b=Math.sin(n*h)/d):(m=1-n,b=n),t[0]=m*i+b*c,t[1]=m*s+b*l,t[2]=m*o+b*u,t[3]=m*a+b*f,t}function bd(t,e){var r=e[0]+e[4]+e[8],n;if(r>0)n=Math.sqrt(r+1),t[3]=.5*n,n=.5/n,t[0]=(e[5]-e[7])*n,t[1]=(e[6]-e[2])*n,t[2]=(e[1]-e[3])*n;else{var i=0;e[4]>e[0]&&(i=1),e[8]>e[i*3+i]&&(i=2);var s=(i+1)%3,o=(i+2)%3;n=Math.sqrt(e[i*3+i]-e[s*3+s]-e[o*3+o]+1),t[i]=.5*n,n=.5/n,t[3]=(e[s*3+o]-e[o*3+s])*n,t[s]=(e[s*3+i]+e[i*3+s])*n,t[o]=(e[o*3+i]+e[i*3+o])*n}return t}function wr(t,e,r,n){var i=arguments.length>4&&arguments[4]!==void 0?arguments[4]:sd,s=Math.PI/360;e*=s,n*=s,r*=s;var o=Math.sin(e),a=Math.cos(e),c=Math.sin(r),l=Math.cos(r),u=Math.sin(n),f=Math.cos(n);switch(i){case"xyz":t[0]=o*l*f+a*c*u,t[1]=a*c*f-o*l*u,t[2]=a*l*u+o*c*f,t[3]=a*l*f-o*c*u;break;case"xzy":t[0]=o*l*f-a*c*u,t[1]=a*c*f-o*l*u,t[2]=a*l*u+o*c*f,t[3]=a*l*f+o*c*u;break;case"yxz":t[0]=o*l*f+a*c*u,t[1]=a*c*f-o*l*u,t[2]=a*l*u-o*c*f,t[3]=a*l*f+o*c*u;break;case"yzx":t[0]=o*l*f+a*c*u,t[1]=a*c*f+o*l*u,t[2]=a*l*u-o*c*f,t[3]=a*l*f-o*c*u;break;case"zxy":t[0]=o*l*f-a*c*u,t[1]=a*c*f+o*l*u,t[2]=a*l*u+o*c*f,t[3]=a*l*f-o*c*u;break;case"zyx":t[0]=o*l*f-a*c*u,t[1]=a*c*f+o*l*u,t[2]=a*l*u-o*c*f,t[3]=a*l*f+o*c*u;break;default:throw new Error("Unknown angle order "+i)}return t}var $i=dd,Tl=md;(function(){var t=se(),e=M(1,0,0),r=M(0,1,0);return function(n,i,s){var o=or(i,s);return o<-.999999?(Wn(t,e,i),fd(t)<1e-6&&Wn(t,r,i),Ei(t,t),pd(n,t,Math.PI),n):o>.999999?(n[0]=0,n[1]=0,n[2]=0,n[3]=1,n):(Wn(t,i,s),n[0]=t[0],n[1]=t[1],n[2]=t[2],n[3]=1+o,Tl(n,n))}})();(function(){var t=Dt(),e=Dt();return function(r,n,i,s,o,a){return Xi(t,n,o,a),Xi(e,i,s,a),Xi(r,t,e,2*a*(1-a)),r}})();(function(){var t=fr();return function(e,r,n,i){return t[0]=n[0],t[3]=n[1],t[6]=n[2],t[1]=i[0],t[4]=i[1],t[7]=i[2],t[2]=-r[0],t[5]=-r[1],t[8]=-r[2],Tl(e,bd(e,t))}})();function K(){var t=new Se(2);return Se!=Float32Array&&(t[0]=0,t[1]=0),t}function si(t){var e=new Se(2);return e[0]=t[0],e[1]=t[1],e}function Q(t,e){var r=new Se(2);return r[0]=t,r[1]=e,r}function It(t,e,r){return t[0]=e[0]+r[0],t[1]=e[1]+r[1],t}function yd(t,e,r){return t[0]=e[0]-r[0],t[1]=e[1]-r[1],t}function St(t,e,r){return t[0]=e[0]*r,t[1]=e[1]*r,t}function vd(t){var e=t[0],r=t[1];return e*e+r*r}function Ze(t,e){return t[0]*e[0]+t[1]*e[1]}function Bd(t,e,r,n){var i=e[0],s=e[1];return t[0]=i+n*(r[0]-i),t[1]=s+n*(r[1]-s),t}function Ge(t,e,r){var n=e[0],i=e[1];return t[0]=r[0]*n+r[2]*i,t[1]=r[1]*n+r[3]*i,t}var gt=yd;(function(){var t=K();return function(e,r,n,i,s,o){var a,c;for(r||(r=2),n||(n=0),i?c=Math.min(i*r+n,e.length):c=e.length,a=n;a<c;a+=r)t[0]=e[a],t[1]=e[a+1],s(t,t,o),e[a]=t[0],e[a+1]=t[1];return e}})();function br(t){const e=Math.cos(t),r=Math.sin(t);return ii(e,r,-r,e)}function Cl(t,e,r){const n=Math.cos(t),i=Math.sin(t),s=Math.cos(e),o=Math.sin(e),a=Math.cos(r),c=Math.sin(r);return Gs(s*a,-s*c,o,i*o*a+n*c,-i*o*c+n*a,-i*s,-n*o*a+i*c,n*o*c+i*a,n*s)}function xd(t,e){const r=fr();return r[0]=t[0]*e[0],r[1]=t[0]*e[1],r[2]=t[0]*e[2],r[3]=t[1]*e[0],r[4]=t[1]*e[1],r[5]=t[1]*e[2],r[6]=t[2]*e[0],r[7]=t[2]*e[1],r[8]=t[2]*e[2],r}function Ad(t,e){let r=t[0],n=t[3]/t[0],i=t[6]/t[0],s=t[4]-n*n*r,o=(t[7]-i*n*r)/s,a=t[8]-(i*i*r+o*o*s),c=e[0],l=e[1]-n*c,u=e[2]-i*c-o*l,f=c/r,h=l/s,p=u/a;const d=M(0,0,0);return d[2]=p,d[1]=h-o*d[2],d[0]=f-n*d[1]-i*d[2],d}function ue(t=0,e=1){return t===void 0?(t=0,e=1):e===void 0&&(e=t,t=0),t+Math.random()*(e-t)}function Td(t,e,r,n){return M(ue(t,t+r),ue(e,e+n),ue(0,Math.PI*2))}function Cd(){const t=Math.floor(ue(0,256)),e=Math.floor(ue(0,256)),r=Math.floor(ue(0,256)),n=255;return new Uint8Array([t,e,r,n])}function Dn(t,e){return t[0]*e[1]-t[1]*e[0]}function Si(t,e,r){const n=Fs(se(),e,t),i=Fs(se(),r,t);return Ei(se(),Wn(se(),n,i))}function Md(t){return t*(180/Math.PI)}function wd(t){return t*(Math.PI/180)}function Nr(){return document.getElementById("info")}function Zt(){return document.getElementById("utils")}function Ml(){Zt()}function jr(){const t=Zt();if(t)for(;t.firstChild;)t.removeChild(t.firstChild);Ml()}function ar(t,e,r,n){const i=document.createElement("label");i.textContent=t,i.htmlFor=`checkbox-${t}`;const s=document.createElement("input");return s.type="checkbox",s.id=`checkbox-${t}`,s.checked=e,s.tabIndex=-1,s.style.cssText=`
        margin-left: 8px;
        transform: scale(1.2);
        cursor: pointer;
    ...
    `,i.appendChild(s);const o=document.createElement("div");o.style.cssText="display: flex; align-items: center; gap: 10px; margin-bottom: 12px;";const a=document.createElement("label");a.textContent="Albedo:",o.appendChild(a);const c=D=>Math.round(D*255).toString(16).padStart(2,"0"),l=`#${c(e.albedo[0])}${c(e.albedo[1])}${c(e.albedo[2])}`,u=document.createElement("input");u.type="color",u.value=l,u.style.cssText=`
        ...
        cursor: pointer;
        padding: 0;
    `,u.tabIndex=-1,o.appendChild(u);const f=document.createElement("span");f.textContent=l.toUpperCase(),f.style.cssText="font-family: monospace; color: #aaa;",o.appendChild(f),u.addEventListener("input",()=>{f.textContent=u.value.toUpperCase();const D=parseInt(u.value.slice(1,3),16)/255,F=parseInt(u.value.slice(3,5),16)/255,te=parseInt(u.value.slice(5,7),16)/255;e.albedo=[D,F,te],r(e)}),i.appendChild(o);const h=document.createElement("label");h.textContent="Albedo texture",o.appendChild(h);const p=document.createElement("input");p.type="checkbox",p.checked=e.useAlbedoTexture,p.tabIndex=-1,o.appendChild(p),p.addEventListener("change",()=>{e.useAlbedoTexture=p.checked,r(e)});const d=document.createElement("div");d.style.cssText="display: flex; align-items: center; gap: 10px; margin-bottom: 12px;";const m=document.createElement("label");m.textContent=`Metalness: ${e.metalness.toFixed(2)}`,d.appendChild(m);const b=document.createElement("input");b.type="range",b.min="0",b.max="1",b.step="0.01",b.value=e.metalness.toString(),b.style.cssText=`
        flex: 1;
        cursor: pointer;
    `,b.tabIndex=-1,d.appendChild(b),i.appendChild(d),b.addEventListener("input",()=>{const D=parseFloat(b.value);e.metalness=isNaN(D)?0:D,m.textContent=`Metalness: ${e.metalness.toFixed(2)}`,r(e)});const g=document.createElement("label");g.textContent="Perlin noise",d.appendChild(g);const y=document.createElement("input");y.type="checkbox",y.checked=e.usePerlinMetalness,y.tabIndex=-1,d.appendChild(y),y.addEventListener("change",()=>{e.usePerlinMetalness=y.checked,r(e)});const T=document.createElement("label");T.textContent="Metalness texture",d.appendChild(T);const B=document.createElement("input");B.type="checkbox",B.checked=e.useMetalnessTexture,B.tabIndex=-1,d.appendChild(B),B.addEventListener("change",()=>{e.useMetalnessTexture=B.checked,r(e)});const w=document.createElement("div");w.style.cssText="display: flex; align-items: center; gap: 10px; margin-bottom: 12px;";const E=document.createElement("label");E.textContent=`Roughness: ${e.roughness.toFixed(2)}`,w.appendChild(E);const C=document.createElement("input");C.type="range",C.min="0",C.max="1",C.step="0.01",C.value=e.roughness.toString(),C.style.cssText=`
        flex: 1;
        cursor: pointer;
    `,C.tabIndex=-1,w.appendChild(C),i.appendChild(w),C.addEventListener("input",()=>{const D=parseFloat(C.value);e.roughness=isNaN(D)?0:D,E.textContent=`Roughness: ${e.roughness.toFixed(2)}`,r(e)});const I=document.createElement("label");I.textContent="Perlin noise",w.appendChild(I);const O=document.createElement("input");O.type="checkbox",O.checked=e.usePerlinRoughness,O.tabIndex=-1,w.appendChild(O),O.addEventListener("change",()=>{e.usePerlinRoughness=O.checked,r(e)});const L=document.createElement("label");L.textContent="Roughness texture",w.appendChild(L);const N=document.createElement("input");N.type="checkbox",N.checked=e.useRoughnessTexture,N.tabIndex=-1,w.appendChild(N),N.addEventListener("change",()=>{e.useRoughnessTexture=N.checked,r(e)});const V=document.createElement("div");V.style.cssText="display: flex; align-items: center; gap: 10px; margin-bottom: 12px;";const j=document.createElement("label");j.textContent=`Perlin Frequency: ${e.perlinFreq.toFixed(2)}`,V.appendChild(j);const P=document.createElement("input");P.type="range",P.min="0.1",P.max="10",P.step="0.1",P.value=e.perlinFreq.toString(),P.style.cssText=`
        flex: 1;
        cursor: pointer;
    `,P.tabIndex=-1,V.appendChild(P),i.appendChild(V),P.addEventListener("input",()=>{const D=parseFloat(P.value);e.perlinFreq=isNaN(D)?.1:D,j.textContent=`Perlin Frequency: ${e.perlinFreq.toFixed(2)}`,r(e)});const x=document.createElement("div");x.style.cssText="display: flex; gap: 8px; justify-content: flex-end;";const H=document.createElement("button");return H.textContent="Cancel",H.style.cssText=`
        padding: 6px 16px;
        background: #555;
        border: none;
        border-radius: 4px;
        ...
        cursor: pointer;
        font-size: 13px;
    `,H.tabIndex=-1,H.addEventListener("click",()=>{n()}),x.appendChild(H),i.appendChild(x),i}function Ed(t,e,r,n,i){const s=document.createElement("div");s.style.cssText=`
        position: fixed;
        left: ${t.x+15}px;
        top: ${t.y}px;
        background: rgba(40, 40, 40, 0.95);
    ...
    `;const o=document.createElement("div");o.textContent=r,o.style.cssText=`
        ...
        padding-bottom: 8px;
        border-bottom: 1px solid #555;
    `,s.appendChild(o);const a=document.createElement("div");a.style.cssText="display: flex; align-items: center; gap: 10px; margin-bottom: 12px;";const c=document.createElement("label");c.textContent="Enabled:",a.appendChild(c);const l=document.createElement("input");l.type="checkbox",l.checked=e.enabled,l.tabIndex=-1,a.appendChild(l),l.addEventListener("change",()=>{e.enabled=l.checked,n(e)}),s.appendChild(a);const u=document.createElement("div");u.style.cssText="display: flex; flex-direction: row; gap: 6px; margin-bottom: 12px;";const f=document.createElement("label");f.textContent="Area light center:",u.appendChild(f),["X","Y","Z"].forEach((x,H)=>{const D=document.createElement("input");D.type="number",D.value=e.center[H].toFixed(2),D.style.cssText=`
            width: 50px;
            padding: 4px;
            border: 1px solid #555;
            border-radius: 4px;
            background: #222;
            color: #eee;
        `,D.tabIndex=-1,u.appendChild(D),D.addEventListener("input",()=>{const F=parseFloat(D.value);e.center[H]=isNaN(F)?0:F,n(e)}),D.placeholder=x}),s.appendChild(u);const h=document.createElement("div");h.style.cssText="display: flex; flex-direction: row; gap: 6px; margin-bottom: 12px;";const p=document.createElement("label");p.textContent="Area light normal direction:",h.appendChild(p),["X","Y","Z"].forEach((x,H)=>{const D=document.createElement("input");D.type="number",D.value=e.normalDirection[H].toFixed(2),D.style.cssText=`
            width: 50px;
            padding: 4px;
            border: 1px solid #555;
            border-radius: 4px;
            background: #222;
            color: #eee;
        `,D.tabIndex=-1,h.appendChild(D),D.addEventListener("input",()=>{const F=parseFloat(D.value);e.normalDirection[H]=isNaN(F)?0:F,n(e)}),D.placeholder=x}),s.appendChild(h);const d=document.createElement("div");d.style.cssText="display: flex; align-items: center; gap: 10px; margin-bottom: 12px;";const m=document.createElement("label");m.textContent="Area light intensity:",d.appendChild(m);const b=document.createElement("input");b.type="number",b.value=e.intensity.toFixed(2),b.style.cssText=`
        width: 80px;
        padding: 4px;
        border: 1px solid #555;
        border-radius: 4px;
        background: #222;
        color: #eee;
    `,b.tabIndex=-1,d.appendChild(b),b.addEventListener("input",()=>{const x=parseFloat(b.value);e.intensity=isNaN(x)?0:x,n(e)}),s.appendChild(d);const g=document.createElement("div");g.style.cssText="display: flex; align-items: center; gap: 10px; margin-bottom: 12px;";const y=document.createElement("label");y.textContent="Area light height:",g.appendChild(y);const T=document.createElement("input");T.type="number",T.value=e.height.toFixed(2),T.style.cssText=`
        width: 80px;
        padding: 4px;
        border: 1px solid #555;
        border-radius: 4px;
        background: #222;
        color: #eee;
    `,T.tabIndex=-1,g.appendChild(T),T.addEventListener("input",()=>{const x=parseFloat(T.value);e.height=isNaN(x)?0:x,n(e)}),s.appendChild(g);const B=document.createElement("div");B.style.cssText="display: flex; align-items: center; gap: 10px; margin-bottom: 12px;";const w=document.createElement("label");w.textContent="Area light width:",B.appendChild(w);const E=document.createElement("input");E.type="number",E.value=e.width.toFixed(2),E.style.cssText=`
        width: 80px;
        padding: 4px;
        border: 1px solid #555;
        border-radius: 4px;
        background: #222;
        color: #eee;
    `,E.tabIndex=-1,B.appendChild(E),E.addEventListener("input",()=>{const x=parseFloat(E.value);e.width=isNaN(x)?0:x,n(e)}),s.appendChild(B);const C=document.createElement("div");C.style.cssText="display: flex; align-items: center; gap: 10px; margin-bottom: 12px;";const I=document.createElement("label");I.textContent="Light color:",C.appendChild(I);const O=x=>Math.round(x*255).toString(16).padStart(2,"0"),L=`#${O(e.color[0])}${O(e.color[1])}${O(e.color[2])}`,N=document.createElement("input");N.type="color",N.value=L,N.style.cssText=`
        width: 50px;
        height: 30px;
        border: none;
        border-radius: 4px;
        cursor: pointer;
        padding: 0;
    `,N.tabIndex=-1,C.appendChild(N);const V=document.createElement("span");V.textContent=L.toUpperCase(),V.style.cssText="font-family: monospace; color: #aaa;",C.appendChild(V),N.addEventListener("input",()=>{V.textContent=N.value.toUpperCase(),e.color=[parseInt(N.value.slice(1,3),16)/255,parseInt(N.value.slice(3,5),16)/255,parseInt(N.value.slice(5,7),16)/255],n(e)}),s.appendChild(C);const j=document.createElement("div");j.style.cssText="display: flex; gap: 8px; justify-content: flex-end;";const P=document.createElement("button");return P.textContent="Cancel",P.style.cssText=`
        padding: 6px 16px;
        background: #555;
        border: none;
        border-radius: 4px;
        ...
        cursor: pointer;
        font-size: 13px;
    `,P.tabIndex=-1,P.addEventListener("click",()=>{i()}),j.appendChild(P),s.appendChild(j),s}function wl(t,e,r,n,i){const s=document.createElement("div");s.style.cssText=`
        position: fixed;
        left: ${t.x+15}px;
        top: ${t.y}px;
        background: rgba(40, 40, 40, 0.95);
    ...
    `;const o=document.createElement("div");o.textContent=r,o.style.cssText=`
        ...
        padding-bottom: 8px;
        border-bottom: 1px solid #555;
    `,s.appendChild(o);const a=document.createElement("div");a.style.cssText="display: flex; align-items: center; gap: 10px; margin-bottom: 12px;";const c=document.createElement("label");c.textContent="Enabled:",a.appendChild(c);const l=document.createElement("input");l.type="checkbox",l.checked=e.enabled,l.tabIndex=-1,a.appendChild(l),l.addEventListener("change",()=>{e.enabled=l.checked,n(e)}),s.appendChild(a);const u=document.createElement("div");u.style.cssText="display: flex; flex-direction: row; gap: 6px; margin-bottom: 12px;";const f=document.createElement("label");f.textContent="Light position:",u.appendChild(f),["X","Y","Z"].forEach((V,j)=>{const P=document.createElement("input");P.type="number",P.value=e.position[j].toFixed(2),P.style.cssText=`
            width: 50px;
            padding: 4px;
            border: 1px solid #555;
            border-radius: 4px;
            background: #222;
            color: #eee;
        `,P.tabIndex=-1,u.appendChild(P),P.addEventListener("input",()=>{const x=parseFloat(P.value);e.position[j]=isNaN(x)?0:x,n(e)}),P.placeholder=V}),s.appendChild(u);const h=document.createElement("div");h.style.cssText="display: flex; flex-direction: row; gap: 6px; margin-bottom: 12px;";const p=document.createElement("label");p.textContent="Light direction:",h.appendChild(p),["X","Y","Z"].forEach((V,j)=>{const P=document.createElement("input");P.type="number",P.value=e.direction[j].toFixed(2),P.style.cssText=`
            width: 50px;
            padding: 4px;
            border: 1px solid #555;
            border-radius: 4px;
            background: #222;
            color: #eee;
        `,P.tabIndex=-1,h.appendChild(P),P.addEventListener("input",()=>{const x=parseFloat(P.value);e.direction[j]=isNaN(x)?0:x,n(e)}),P.placeholder=V}),s.appendChild(h);const d=document.createElement("div");d.style.cssText="display: flex; align-items: center; gap: 10px; margin-bottom: 12px;";const m=document.createElement("label");m.textContent="Light intensity:",d.appendChild(m);const b=document.createElement("input");b.type="number",b.value=e.intensity.toFixed(2),b.style.cssText=`
        width: 80px;
        padding: 4px;
        border: 1px solid #555;
        border-radius: 4px;
        background: #222;
        color: #eee;
    `,b.tabIndex=-1,d.appendChild(b),b.addEventListener("input",()=>{const V=parseFloat(b.value);e.intensity=isNaN(V)?0:V,n(e)}),s.appendChild(d);const g=document.createElement("div");g.style.cssText="display: flex; align-items: center; gap: 10px; margin-bottom: 12px;";const y=document.createElement("label");y.textContent="Cone angle:",g.appendChild(y);const T=document.createElement("input");T.type="range",T.value=Md(e.coneAngle).toFixed(2),T.min="0",T.max="180",T.style.cssText=`
        width: 80px;
        padding: 4px;
        border: 1px solid #555;
        border-radius: 4px;
        background: #222;
        color: #eee;
    `,T.tabIndex=-1,g.appendChild(T),T.addEventListener("input",()=>{const V=parseFloat(T.value),j=wd(V);e.coneAngle=isNaN(j)?0:j,n(e)}),s.appendChild(g);const B=document.createElement("div");B.style.cssText="display: flex; align-items: center; gap: 10px; margin-bottom: 12px;";const w=document.createElement("label");w.textContent="Light color:",B.appendChild(w);const E=V=>Math.round(V*255).toString(16).padStart(2,"0"),C=`#${E(e.color[0])}${E(e.color[1])}${E(e.color[2])}`,I=document.createElement("input");I.type="color",I.value=C,I.style.cssText=`
        width: 50px;
        height: 30px;
        border: none;
        border-radius: 4px;
        cursor: pointer;
        padding: 0;
    `,I.tabIndex=-1,B.appendChild(I);const O=document.createElement("span");O.textContent=C.toUpperCase(),O.style.cssText="font-family: monospace; color: #aaa;",B.appendChild(O),I.addEventListener("input",()=>{O.textContent=I.value.toUpperCase(),e.color=[parseInt(I.value.slice(1,3),16)/255,parseInt(I.value.slice(3,5),16)/255,parseInt(I.value.slice(5,7),16)/255],n(e)}),s.appendChild(B);const L=document.createElement("div");L.style.cssText="display: flex; gap: 8px; justify-content: flex-end;";const N=document.createElement("button");return N.textContent="Cancel",N.style.cssText=`
        padding: 6px 16px;
        background: #555;
        border: none;
        border-radius: 4px;
        ...
        cursor: pointer;
        font-size: 13px;
    `,N.tabIndex=-1,N.addEventListener("click",()=>{i()}),L.appendChild(N),s.appendChild(L),s}const Sd=`@vertex\r
...
{\r
    return input.color;\r
}`,o2=0,a2=1,Qn=50;async function c2(t){const e=await Mt();if(e==null){console.log("Was not able to acquire a WebGPU device.");return}const r=t.getContext("webgpu"),n=navigator.gpu.getPreferredCanvasFormat();if(!r){console.error("WebGPU context is not available.");return}r.configure({device:e,format:n,alphaMode:"premultiplied"});const i=nc(e,"hardcoded triangle",i2),s=nc(e,"hardcoded triangle",s2),o=l2(e,i,s,n),a=12,c=8,l=a*Qn,u=c*Qn,f=Jy({radius:1,innerRadius:.5}),h=f.vertexData.byteLength,p=f.numVertices,d=xs(e,l),m=xs(e,u),b=xs(e,h),g=f2(e,f.indexData.byteLength);e.queue.writeBuffer(b,0,f.vertexData),e.queue.writeBuffer(g,0,f.indexData);const y=[];{const E=new Uint8Array(l),C=new Float32Array(E.buffer);for(let I=0;I<Qn;I++){const O=I*a,L=I*(a/4);E.set([Math.round(ue(.1)*255),Math.round(ue(.1)*255),Math.round(ue(.1)*255),255],O+o2),C.set([ue(-.9,.9),ue(-.9,.9)],L+a2);const N={scale:ue(.1,.4)};y.push(N)}e.queue.writeBuffer(d,0,C)}const T=new Float32Array(u/4),B={label:"basic canvas renderPass",colorAttachments:[{view:void 0,loadOp:"clear",storeOp:"store",clearValue:{r:.3,g:.3,b:.3,a:1}}]};return new ResizeObserver(E=>{for(const C of E){const I=C.target,O=C.contentBoxSize[0].inlineSize,L=C.contentBoxSize[0].blockSize;I.width=Math.max(1,Math.min(O,e.limits.maxTextureDimension2D)),I.height=Math.max(1,Math.min(L,e.limits.maxTextureDimension2D))}u2(e,t,r,o,B,y,d,T,m,p,b,g)}).observe(t),null}function nc(t,e,r){return t.createShaderModule({label:e,code:r})}function l2(t,e,r,n){return t.createRenderPipeline({label:"vertex buffer pipeline",layout:"auto",vertex:{module:e,entryPoint:"vs",buffers:[{arrayStride:12,attributes:[{shaderLocation:0,offset:0,format:"float32x2"},{shaderLocation:4,offset:8,format:"unorm8x4"}]},{arrayStride:12,stepMode:"instance",attributes:[{shaderLocation:1,offset:0,format:"unorm8x4"},{shaderLocation:2,offset:4,format:"float32x2"}]},{arrayStride:8,stepMode:"instance",attributes:[{shaderLocation:3,offset:0,format:"float32x2"}]}]},fragment:{module:r,entryPoint:"fs",targets:[{format:n}]}})}function u2(t,e,r,n,i,s,o,a,c,l,u,f){i.colorAttachments[0].view=r.getCurrentTexture().createView();const h=t.createCommandEncoder({label:"pass encoder"}),p=h.beginRenderPass(i);p.setPipeline(n),p.setVertexBuffer(0,u),p.setVertexBuffer(1,o),p.setVertexBuffer(2,c),p.setIndexBuffer(f,"uint16");const d=e.width/e.height;s.forEach((b,g)=>{const y=2*g;a.set([b.scale/d,b.scale],y)}),t.queue.writeBuffer(c,0,a),p.drawIndexed(l,Qn),p.end();const m=h.finish();t.queue.submit([m])}function xs(t,e){return t.createBuffer({label:"vertex buffer",size:e,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST})}function f2(t,e){return t.createBuffer({label:"index buffer",size:e,usage:GPUBufferUsage.INDEX|GPUBufferUsage.COPY_DST})}const h2=`// ============================== //\r
struct vertexStruct {\r
    @location(0) position: vec2f,\r
...
\r
    ...
    \r
        ...
        let sampleRay = ray_at(jitteredUV);\r
        let newSample = pathTrace(sampleRay, uniforms.ptDepth);\r
        \r
...
{\r
    ...
    return vec4f(color, 1.0);\r
}`;async function Kv(t){const e=new Qv;return await e.initialize(t),e}const pc=224,gc=192,Yv=80;class Qv{device;canvas=null;context=null;presentationFormat=null;timestampQuerySet=null;animationFrameId=null;resizeObserver=null;infoElement=Nr();keysPressed=new Set;isMouseDown=!1;lastMouseX=0;lastMouseY=0;camera=Bn(1);lights=[];a_c=1;a_l=.09;a_q=.0032;normalObjects;rayTracerObjects;usePathTracing=!0;meshesInfo;activeContextMenu=null;showBVH=!1;bvhDepth=1/0;rayTracerMode=0;ptDepth=6;ptSamples=64;randSeed=Math.floor(Math.random()*4294967295);russianRoulette=!0;frameAccumulation=!0;accumTexture=null;renderTexture=null;frameCount=0;frameAccumulationReset=!1;constructor(){xn(this.camera,278,500,-700),Vr(this.camera,0,-.3),Tn(this.camera,.1,2e3),this.camera.moveSpeed=20,this.camera.rotateSpeed=.05,this.device=null,this.normalObjects={},this.rayTracerObjects={};const e={center:M(278,548,279),intensity:40,normalDirection:M(0,-1,0),width:100,height:100,color:M(1,1,1),enabled:!0};this.lights.push(e)}initializeUtils(){const e=Zt();e&&(ar("Use Path Tracing",this.usePathTracing,e,r=>{this.usePathTracing=r}),e.appendChild(document.createElement("br")),Gt("Depth of path tracing",this.ptDepth,0,20,1,e,r=>{this.ptDepth=r,this.frameAccumulationReset=!0}),e.appendChild(document.createElement("br")),Gt("Path tracing samples",this.ptSamples,1,100,1,e,r=>{this.ptSamples=r,this.frameAccumulationReset=!0}),e.appendChild(document.createElement("br")),ar("Russian Roulette",this.russianRoulette,e,r=>{this.russianRoulette=r}),e.appendChild(document.createElement("br")),ar("Frame Accumulation",this.frameAccumulation,e,r=>{this.frameAccumulation=r,this.frameAccumulationReset=!0}),this.lights.forEach((r,n)=>{const i=s=>{s.preventDefault(),this.activeContextMenu&&(this.activeContextMenu.remove(),this.activeContextMenu=null);const o={x:this.canvas.offsetLeft+this.canvas.width-300,y:this.canvas.offsetTop+this.canvas.height/2-150};this.activeContextMenu=Ed(o,this.lights[n],`Edit Light ${n+1}`,a=>{this.lights[n]=a},()=>{this.activeContextMenu?.remove(),this.activeContextMenu=null}),document.body.appendChild(this.activeContextMenu)};e.appendChild(document.createElement("br")),uo(`Edit Light ${n+1}`,e,i)}),e.appendChild(document.createElement("br")),ar("Show BVH",this.showBVH,e,r=>{this.showBVH=r,this.rayTracerMode=r?1:0,this.frameAccumulationReset=!0}),e.appendChild(document.createElement("br")),Gt("BVH Depth",this.bvhDepth===1/0?32:this.bvhDepth,1,32,1,e,r=>{this.bvhDepth=r===32?1/0:r,this.rebuildBVHBuffer()}))}async initialize(e){if(this.canvas=e,this.device=await Mt(["timestamp-query"]),this.device===null||this.device===void 0){console.log("Was not able to acquire a WebGPU device.");return}if(this.context=e.getContext("webgpu"),this.presentationFormat=navigator.gpu.getPreferredCanvasFormat(),!this.context){console.error("WebGPU context is not available.");return}this.context.configure({device:this.device,format:this.presentationFormat,alphaMode:"premultiplied"}),this.initializeShaderModules(),this.initializePipelines(),await this.startRendering()}initializeShaderModules(){this.device!==null&&(this.rayTracerObjects.shaderModule=He(this.device,jv,Vv,"Ray Trace Shader Module"),this.normalObjects.shaderModule=He(this.device,Hv,kv,"Normal Shader Module"),this.normalObjects.bvhShaderModule=He(this.device,zv,Jv,"BVH Draw Shader Module"),this.rayTracerObjects.displayShaderModule=He(this.device,qv,Wv,"Display Shader Module"))}initializePipelines(){this.device===null||this.presentationFormat===null||(this.rayTracerObjects.displayBindGroupLayout=this.device.createBindGroupLayout({label:"Display Bind Group Layout",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float",viewDimension:"2d"}}]}),this.rayTracerObjects.displayPipeline=this.device.createRenderPipeline({label:"Display Pipeline",layout:this.device.createPipelineLayout({label:"Display Pipeline Layout",bindGroupLayouts:[this.rayTracerObjects.displayBindGroupLayout]}),vertex:{module:this.rayTracerObjects.displayShaderModule.vertex,entryPoint:"vs"},fragment:{module:this.rayTracerObjects.displayShaderModule.fragment,entryPoint:"fs",targets:[{format:this.presentationFormat}]},primitive:{topology:"triangle-list",cullMode:"none"}}),this.rayTracerObjects.bindGroupLayout=this.device.createBindGroupLayout({label:"Ray Trace Bind Group Layout",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}},{binding:4,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}},{binding:5,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}},{binding:6,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}},{binding:7,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float",viewDimension:"2d"}}]}),this.rayTracerObjects.materialBindGroupLayout=this.device.createBindGroupLayout({label:"Ray Trace Material Bind Group Layout",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float",viewDimension:"2d-array",multisampled:!1}}]}),this.rayTracerObjects.pipelineLayout=this.device.createPipelineLayout({label:"Ray Trace Pipeline Layout",bindGroupLayouts:[this.rayTracerObjects.bindGroupLayout,this.rayTracerObjects.materialBindGroupLayout]}),this.rayTracerObjects.shaderModule!==null&&(this.rayTracerObjects.pipeline=this.device.createRenderPipeline({label:"Ray Trace Pipeline",layout:this.rayTracerObjects.pipelineLayout,vertex:{module:this.rayTracerObjects.shaderModule.vertex,entryPoint:"vs"},fragment:{module:this.rayTracerObjects.shaderModule.fragment,entryPoint:"fs",targets:[{format:"rgba16float"}]}})),this.normalObjects.bindGroupLayout=this.device.createBindGroupLayout({label:"Normal Bind Group Layout",entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}}]}),this.normalObjects.materialUniformBindGroupLayout=this.device.createBindGroupLayout({label:"Material Uniform Bind Group Layout",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float",viewDimension:"2d"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float",viewDimension:"2d"}},{binding:4,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float",viewDimension:"2d"}},{binding:5,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float",viewDimension:"2d"}},{binding:6,visibility:GPUShaderStage.VERTEX,buffer:{type:"read-only-storage"}},{binding:7,visibility:GPUShaderStage.VERTEX,buffer:{type:"read-only-storage"}}]}),this.normalObjects.pipelineLayout=this.device.createPipelineLayout({label:"Normal Pipeline Layout",bindGroupLayouts:[this.normalObjects.bindGroupLayout,this.normalObjects.materialUniformBindGroupLayout]}),this.normalObjects.bvhDrawPipelineLayout=this.device.createPipelineLayout({label:"BVH Draw Pipeline Layout",bindGroupLayouts:[this.normalObjects.bindGroupLayout,this.normalObjects.materialUniformBindGroupLayout]}),this.normalObjects.depthTexture=this.device.createTexture({size:[this.canvas.width,this.canvas.height],format:"depth24plus",usage:GPUTextureUsage.RENDER_ATTACHMENT}),this.normalObjects.shaderModule!==null&&(this.normalObjects.pipeline=this.device.createRenderPipeline({label:"Normal Pipeline",layout:this.normalObjects.pipelineLayout,vertex:{module:this.normalObjects.shaderModule.vertex,entryPoint:"vs",buffers:[{arrayStride:12,attributes:[{shaderLocation:0,offset:0,format:"float32x3"}]},{arrayStride:12,attributes:[{shaderLocation:1,offset:0,format:"float32x3"}]},{arrayStride:8,attributes:[{shaderLocation:2,offset:0,format:"float32x2"}]}]},fragment:{module:this.normalObjects.shaderModule.fragment,entryPoint:"fs",targets:[{format:this.presentationFormat}]},primitive:{topology:"triangle-list",cullMode:"back"},depthStencil:{format:"depth24plus",depthWriteEnabled:!0,depthCompare:"less"}}),this.normalObjects.bvhDrawPipeline=this.device.createRenderPipeline({label:"BVH Draw Pipeline",layout:this.normalObjects.bvhDrawPipelineLayout,vertex:{module:this.normalObjects.bvhShaderModule.vertex,entryPoint:"vsBVH",buffers:[{arrayStride:12,attributes:[{shaderLocation:0,offset:0,format:"float32x3"}]}]},fragment:{module:this.normalObjects.bvhShaderModule.fragment,entryPoint:"fsBVH",targets:[{format:this.presentationFormat}]},primitive:{topology:"line-list"},depthStencil:{format:"depth24plus",depthWriteEnabled:!1,depthCompare:"less"}})),this.timestampQuerySet=Pi(this.device,2),this.normalObjects.sampler=this.device.createSampler({label:"Normal Objects Sampler",magFilter:"linear",minFilter:"linear",mipmapFilter:"linear",addressModeU:"repeat",addressModeV:"repeat"}),this.rayTracerObjects.sampler=this.device.createSampler({label:"Ray Tracer Sampler",magFilter:"linear",minFilter:"linear",mipmapFilter:"linear",addressModeU:"repeat",addressModeV:"repeat"}))}async initializeBuffers(){if(this.device===null)return;const e=Ue(this.device,1024,32),r=this.meshesInfo?.meshMaterials||[],n=await Xy(r);this.normalObjects.sceneInformation=n,this.meshesInfo=n.additionalInfo;const i=n.meshes.length;this.normalObjects.materialUniforms=[],this.normalObjects.materialBindGroups=[],this.normalObjects.positionBuffers=[],this.normalObjects.normalBuffers=[],this.normalObjects.uvBuffers=[],this.normalObjects.indexBuffers=[],this.normalObjects.meshesModelMatrixBuffers=[],this.normalObjects.meshesNormalMatrixBuffers=[];for(let x=0;x<i;x++){this.normalObjects.meshesModelMatrixBuffers.push(this.device.createBuffer({label:"Mesh Model Matrix Buffer "+x,size:64,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST})),this.device.queue.writeBuffer(this.normalObjects.meshesModelMatrixBuffers[x],0,n.meshes[x].GetFlatWorldMatrix()),this.normalObjects.meshesNormalMatrixBuffers.push(this.device.createBuffer({label:"Mesh Normal Matrix Buffer "+x,size:64,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST})),this.device.queue.writeBuffer(this.normalObjects.meshesNormalMatrixBuffers[x],0,n.meshes[x].GetFlatNormalMatrix()),this.normalObjects.materialUniforms.push(this.device.createBuffer({label:"Material Uniform Buffer "+x,size:dr*4,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}));const H=n.meshes[x].GetFlattenedMaterial();this.device.queue.writeBuffer(this.normalObjects.materialUniforms[x],0,H),this.normalObjects.materialBindGroups.push(this.device.createBindGroup({label:"Material Bind Group "+x,layout:this.normalObjects.materialUniformBindGroupLayout,entries:[{binding:0,resource:{buffer:this.normalObjects.materialUniforms[x]}},{binding:1,resource:this.normalObjects.sampler},{binding:2,resource:n.meshes[x].Material.albedoGPUTexture?n.meshes[x].Material.albedoGPUTexture.createView():e.createView()},{binding:3,resource:n.meshes[x].Material.metalnessGPUTexture?n.meshes[x].Material.metalnessGPUTexture.createView():e.createView()},{binding:4,resource:n.meshes[x].Material.roughnessGPUTexture?n.meshes[x].Material.roughnessGPUTexture.createView():e.createView()},{binding:5,resource:n.meshes[x].Material.normalGPUTexture?n.meshes[x].Material.normalGPUTexture.createView():e.createView()},{binding:6,resource:{buffer:this.normalObjects.meshesModelMatrixBuffers[x]}},{binding:7,resource:{buffer:this.normalObjects.meshesNormalMatrixBuffers[x]}}]}));const D=n.meshes[x].getVertexData();this.normalObjects.positionBuffers.push(this.device.createBuffer({label:"Normal Position Buffer "+x,size:D.byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST})),this.device.queue.writeBuffer(this.normalObjects.positionBuffers[x],0,D);const F=n.meshes[x].getIndexData16();this.normalObjects.indexBuffers.push(this.device.createBuffer({label:"Normal Index Buffer "+x,size:F.byteLength,usage:GPUBufferUsage.INDEX|GPUBufferUsage.COPY_DST})),this.device.queue.writeBuffer(this.normalObjects.indexBuffers[x],0,F);const te=n.meshes[x].getNormalData();this.normalObjects.normalBuffers.push(this.device.createBuffer({label:"Normal Normal Buffer "+x,size:te.byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST})),this.device.queue.writeBuffer(this.normalObjects.normalBuffers[x],0,te);const ne=n.meshes[x].getUVData();this.normalObjects.uvBuffers.push(this.device.createBuffer({label:"Normal UV Buffer "+x,size:ne.byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST})),this.device.queue.writeBuffer(this.normalObjects.uvBuffers[x],0,ne)}this.normalObjects.uniformBuffer=this.device.createBuffer({label:"Normal Uniform Buffer",size:pc,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),this.normalObjects.bindGroup=this.device.createBindGroup({label:"Normal Bind Group",layout:this.normalObjects.bindGroupLayout,entries:[{binding:0,resource:{buffer:this.normalObjects.uniformBuffer}}]});const s=this.getBVHGeometry(1/0);this.normalObjects.bvhLineGeometryBuffers=[];for(let x=0;x<s.length;x++)this.normalObjects.bvhLineGeometryBuffers[x]=this.device.createBuffer({label:`BVH Line Geometry Buffer ${x}`,size:s[x].byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST}),this.device.queue.writeBuffer(this.normalObjects.bvhLineGeometryBuffers[x],0,s[x]);const o=[],a=[],c=[],l=[],u=[],f=[];let h=0,p=0,d=0,m=0,b=0;for(let x=0;x<i;x++){let H=n.meshes[x];o.push(...H.getVertexData()),a.push(...H.getNormalData()),c.push(...H.getUVData());const D=H.getReorderedIndexData32();for(let de of D)l.push(de+p);const{data:F,numNodes:te}=H.getFlattenedBVHData(b);f.push(F),h+=F.byteLength;const ne=new ArrayBuffer(Yv),re=new Float32Array(ne),Z=new Uint32Array(ne);re.set(H.GetFlatInverseWorldMatrix(),0),Z[16]=b,Z[17]=d,Z[18]=m,Z[19]=x,u.push(...re),p+=H.getNumVertices(),d+=H.getNumTriangles(),m+=H.getNumVertices(),b+=te}const g=new Float32Array(o),y=new Float32Array(a),T=new Float32Array(c),B=new Uint32Array(l),w=new Float32Array(u),E=new Uint8Array(h);let C=0;for(let x of f)E.set(new Uint8Array(x),C),C+=x.byteLength;this.rayTracerObjects.uniformBuffer=this.device.createBuffer({label:"Ray Tracer Uniform Buffer",size:gc,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),this.rayTracerObjects.positionStorageBuffer=this.device.createBuffer({label:"Ray Tracer Position Storage Buffer",size:g.byteLength,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),this.device.queue.writeBuffer(this.rayTracerObjects.positionStorageBuffer,0,g),this.rayTracerObjects.normalStorageBuffer=this.device.createBuffer({label:"Ray Tracer Normal Storage Buffer",size:y.byteLength,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),this.device.queue.writeBuffer(this.rayTracerObjects.normalStorageBuffer,0,y),this.rayTracerObjects.uvStorageBuffer=this.device.createBuffer({label:"Ray Tracer UV Storage Buffer",size:T.byteLength,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),this.device.queue.writeBuffer(this.rayTracerObjects.uvStorageBuffer,0,T),this.rayTracerObjects.indexStorageBuffer=this.device.createBuffer({label:"Ray Tracer Index Storage Buffer",size:B.byteLength,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),this.device.queue.writeBuffer(this.rayTracerObjects.indexStorageBuffer,0,B),this.rayTracerObjects.bvhNodesStorageBuffer=this.device.createBuffer({label:"Ray Tracer BVH Nodes Storage Buffer",size:E.byteLength,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),this.device.queue.writeBuffer(this.rayTracerObjects.bvhNodesStorageBuffer,0,E),this.rayTracerObjects.meshInstancesStorageBuffer=this.device.createBuffer({label:"Ray Tracer Mesh Instances Storage Buffer",size:w.byteLength,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),this.device.queue.writeBuffer(this.rayTracerObjects.meshInstancesStorageBuffer,0,w),this.rebuildAccumulationTextures();const I=n.meshes.map(x=>x.Material),O=lo(I);this.rayTracerObjects.materialBuffer=this.device.createBuffer({label:"Ray Tracer Material Storage Buffer",size:O.byteLength,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),this.device.queue.writeBuffer(this.rayTracerObjects.materialBuffer,0,O);const L=4;var N=this.meshesInfo?.meshMaterials.filter(x=>x.textureIndex>=0).length||0;N===0&&(N=1);const V=1024,j=1024;this.rayTracerObjects.textureArray=this.device.createTexture({label:"Ray Tracer Material Texture Array",size:[V,j,L*N],format:"rgba8unorm",mipLevelCount:1,sampleCount:1,dimension:"2d",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT});const P=Lr(1024,32);for(let x=0;x<N;x++){const H=this.meshesInfo?.meshMaterials[x]?.albedoImage?this.meshesInfo.meshMaterials[x].albedoImage:P,D=this.meshesInfo?.meshMaterials[x]?.metalnessImage?this.meshesInfo.meshMaterials[x].metalnessImage:P,F=this.meshesInfo?.meshMaterials[x]?.roughnessImage?this.meshesInfo.meshMaterials[x].roughnessImage:P,te=this.meshesInfo?.meshMaterials[x]?.normalImage?this.meshesInfo.meshMaterials[x].normalImage:P;this.device.queue.copyExternalImageToTexture({source:H},{texture:this.rayTracerObjects.textureArray,origin:[0,0,x*L]},[V,j]),this.device.queue.copyExternalImageToTexture({source:D},{texture:this.rayTracerObjects.textureArray,origin:[0,0,x*L+1]},[V,j]),this.device.queue.copyExternalImageToTexture({source:F},{texture:this.rayTracerObjects.textureArray,origin:[0,0,x*L+2]},[V,j]),this.device.queue.copyExternalImageToTexture({source:te},{texture:this.rayTracerObjects.textureArray,origin:[0,0,x*L+3]},[V,j])}this.rayTracerObjects.materialBindGroup=this.device.createBindGroup({label:"Ray Tracer Material Bind Group",layout:this.rayTracerObjects.materialBindGroupLayout,entries:[{binding:0,resource:{buffer:this.rayTracerObjects.materialBuffer}},{binding:1,resource:this.rayTracerObjects.sampler},{binding:2,resource:this.rayTracerObjects.textureArray.createView()}]})}initializeInputHandlers(){this.canvas&&(window.addEventListener("keydown",this.onKeyDown),window.addEventListener("keyup",this.onKeyUp),this.canvas.addEventListener("mousedown",this.onMouseDown),window.addEventListener("mouseup",this.onMouseUp),window.addEventListener("mousemove",this.onMouseMove),this.canvas.addEventListener("contextmenu",e=>e.preventDefault()))}onKeyDown=e=>{this.keysPressed.add(e.key.toLowerCase())};onKeyUp=e=>{this.keysPressed.delete(e.key.toLowerCase())};onMouseDown=e=>{this.isMouseDown=!0,this.lastMouseX=e.clientX,this.lastMouseY=e.clientY};onMouseUp=e=>{if(this.isMouseDown=!1,e.target!==this.canvas)return;if(this.activeContextMenu!==null){const n=this.activeContextMenu.getBoundingClientRect();if(e.clientX>=n.left&&e.clientX<=n.right&&e.clientY>=n.top&&e.clientY<=n.bottom)return}let r=this.rayCastOnMeshes(e.clientX,e.clientY);r!==-1&&this.spawnMaterialContextMenu(r,e.clientX,e.clientY)};onMouseMove=e=>{if(!this.isMouseDown)return;const r=e.clientX-this.lastMouseX,n=e.clientY-this.lastMouseY,i=.05;xe(this.camera,r*i,-n*i),this.lastMouseX=e.clientX,this.lastMouseY=e.clientY};handleInput(){let e=0,r=0,n=0;(this.keysPressed.has("z")||this.keysPressed.has("w"))&&(n-=this.camera.moveSpeed),this.keysPressed.has("s")&&(n+=this.camera.moveSpeed),(this.keysPressed.has("q")||this.keysPressed.has("a"))&&(e-=this.camera.moveSpeed),this.keysPressed.has("d")&&(e+=this.camera.moveSpeed),this.keysPressed.has(" ")&&(r+=this.camera.moveSpeed),this.keysPressed.has("alt")&&(r-=this.camera.moveSpeed),(e!==0||r!==0||n!==0)&&Cn(this.camera,-n,e,r),this.keysPressed.has("arrowleft")&&xe(this.camera,-1,0),this.keysPressed.has("arrowright")&&xe(this.camera,1,0),this.keysPressed.has("arrowup")&&xe(this.camera,0,1),this.keysPressed.has("arrowdown")&&xe(this.camera,0,-1)}async startRendering(){await this.smallCleanup(),await this.initializeBuffers(),this.initializeUtils(),this.initializeInputHandlers();const e=this.meshesInfo.meshMaterials[2];this.fetchTextureForMaterial(e,oe.Albedo,"meshes/calavera/textures/Material.002_baseColor.png");const r=this.meshesInfo.meshMaterials[3];this.fetchTextureForMaterial(r,oe.Albedo,"meshes/takis/textures/Material.001_baseColor.png"),this.mainLoop()}updateUniforms(){if(this.device!==null)if(this.usePathTracing){const e=new ArrayBuffer(gc),r=new Float32Array(e),n=new Uint32Array(e);r.set(Mn(this.camera),0),r.set(this.camera.position,16),n[19]=this.rayTracerMode,r[20]=this.a_c,r[21]=this.a_l,r[22]=this.a_q,r[23]=this.bvhDepth,n[24]=this.ptDepth,n[25]=this.randSeed,n[26]=this.ptSamples,r[27]=this.russianRoulette?1:0;const i=new Float32Array([this.canvas.width,this.canvas.height]);r.set(i,28),r[30]=this.frameAccumulation?1:0,n[31]=this.frameCount,r.set(this.lights[0].center,32),r[35]=this.lights[0].intensity,r.set(this.lights[0].normalDirection,36),r[39]=this.lights[0].width,r.set(this.lights[0].color,40),r[43]=this.lights[0].height,r[44]=this.lights[0].enabled?1:0,r[45]=0,r[46]=0,r[47]=0,this.device.queue.writeBuffer(this.rayTracerObjects.uniformBuffer,0,e)}else{const e=new ArrayBuffer(pc),r=new Float32Array(e);r.set(this.camera.viewMatrix,0),r.set(this.camera.projectionMatrix,16),r.set(this.camera.position,32),r[36]=this.a_c,r[37]=this.a_l,r[38]=this.a_q,r[39]=0,r.set(this.lights[0].center,40),r[43]=this.lights[0].intensity,r.set(this.lights[0].normalDirection,44),r[47]=this.lights[0].width,r.set(this.lights[0].color,48),r[51]=this.lights[0].height,r[52]=this.lights[0].enabled?1:0,r[53]=0,r[54]=0,r[55]=0,this.device.queue.writeBuffer(this.normalObjects.uniformBuffer,0,e)}}animate(){}mainLoop(){if(this.device===null||this.canvas===null)return;let e=0,r=0;const n=i=>{if(this.canvas===null||this.device===null||this.context===null)return;const s=i-e;e=i;const o=performance.now();if(this.handleInput(),this.camera.dirty&&(this.frameAccumulationReset=!0,this.camera.dirty=!1),this.frameAccumulationReset){this.frameCount=0;const h=this.device.createCommandEncoder({label:"Frame Accumulation Reset Encoder"});h.beginRenderPass({colorAttachments:[{view:this.renderTexture.createView(),loadOp:"clear",storeOp:"store",clearValue:{r:0,g:0,b:0,a:0}}]}).end(),h.copyTextureToTexture({texture:this.renderTexture},{texture:this.accumTexture},[this.canvas.width,this.canvas.height]),this.device.queue.submit([h.finish()]),this.frameAccumulationReset=!1}this.usePathTracing&&this.frameAccumulation&&this.frameCount++,this.updateUniforms(),this.animate();const a=this.context.getCurrentTexture().createView(),c=this.usePathTracing?void 0:{view:this.normalObjects.depthTexture.createView(),depthLoadOp:"clear",depthStoreOp:"store",depthClearValue:1},l=this.device.createCommandEncoder({label:"Render Quad Encoder"});if(this.usePathTracing){const h=l.beginRenderPass({colorAttachments:[{view:this.renderTexture.createView(),loadOp:"clear",storeOp:"store",clearValue:{r:0,g:0,b:0,a:1}}],...this.timestampQuerySet!=null&&{timestampWrites:{querySet:this.timestampQuerySet.querySet,beginningOfPassWriteIndex:0,endOfPassWriteIndex:1}}});h.setPipeline(this.rayTracerObjects.pipeline),h.setBindGroup(0,this.rayTracerObjects.bindGroup),h.setBindGroup(1,this.rayTracerObjects.materialBindGroup),h.draw(6),h.end(),this.frameAccumulation&&l.copyTextureToTexture({texture:this.renderTexture},{texture:this.accumTexture},[this.canvas.width,this.canvas.height]);const p={label:"basic canvas renderPass",colorAttachments:[{view:a,loadOp:"clear",storeOp:"store",clearValue:{r:0,g:0,b:0,a:1}}],depthStencilAttachment:c},d=l.beginRenderPass(p);d.setPipeline(this.rayTracerObjects.displayPipeline),d.setBindGroup(0,this.rayTracerObjects.displayBindGroup),d.draw(6),d.end()}else{const h={label:"basic canvas renderPass",colorAttachments:[{view:a,loadOp:"clear",storeOp:"store",clearValue:{r:0,g:0,b:0,a:1}}],depthStencilAttachment:c,...this.timestampQuerySet!=null&&{timestampWrites:{querySet:this.timestampQuerySet.querySet,beginningOfPassWriteIndex:0,endOfPassWriteIndex:1}}},p=l.beginRenderPass(h);p.setPipeline(this.normalObjects.pipeline),p.setBindGroup(0,this.normalObjects.bindGroup);for(let d=0;d<this.normalObjects.sceneInformation.meshes.length;d++)p.setBindGroup(1,this.normalObjects.materialBindGroups[d]),p.setVertexBuffer(0,this.normalObjects.positionBuffers[d]),p.setVertexBuffer(1,this.normalObjects.normalBuffers[d]),p.setVertexBuffer(2,this.normalObjects.uvBuffers[d]),p.setIndexBuffer(this.normalObjects.indexBuffers[d],"uint16"),p.drawIndexed(this.normalObjects.indexBuffers[d].size/2,1,0,0,0);if(this.showBVH){p.setPipeline(this.normalObjects.bvhDrawPipeline),p.setBindGroup(0,this.normalObjects.bindGroup);for(let d=0;d<this.normalObjects.bvhLineGeometryBuffers.length;d++)p.setBindGroup(1,this.normalObjects.materialBindGroups[d]),p.setVertexBuffer(0,this.normalObjects.bvhLineGeometryBuffers[d]),p.draw(this.normalObjects.bvhLineCounts[d])}p.end()}this.timestampQuerySet!=null&&(l.resolveQuerySet(this.timestampQuerySet.querySet,0,this.timestampQuerySet.querySet.count,this.timestampQuerySet.resolveBuffer,0),this.timestampQuerySet.resultBuffer.mapState==="unmapped"&&l.copyBufferToBuffer(this.timestampQuerySet.resolveBuffer,0,this.timestampQuerySet.resultBuffer,0,this.timestampQuerySet.resultBuffer.size));const u=l.finish();this.device.queue.submit([u]),this.timestampQuerySet!=null&&this.timestampQuerySet.resultBuffer.mapState==="unmapped"&&this.timestampQuerySet.resultBuffer.mapAsync(GPUMapMode.READ).then(()=>{const h=new BigUint64Array(this.timestampQuerySet.resultBuffer.getMappedRange());r=Number(h[1]-h[0]),this.timestampQuerySet.resultBuffer.unmap()});const f=performance.now()-o;if(this.infoElement&&this.device){const h=`                FPS: ${(1e3/s).toFixed(1)}
                JS Time: ${f.toFixed(1)} ms
                GPU Time: ${(r/1e6).toFixed(2)} ms
                `;this.infoElement.textContent=h}this.animationFrameId=requestAnimationFrame(n)};this.animationFrameId=requestAnimationFrame(n),this.resizeObserver=new ResizeObserver(i=>{for(const s of i){const o=s.contentBoxSize[0].inlineSize,a=s.contentBoxSize[0].blockSize;this.canvas&&this.device&&(this.canvas.width=Math.max(1,Math.min(o,this.device.limits.maxTextureDimension2D)),this.canvas.height=Math.max(1,Math.min(a,this.device.limits.maxTextureDimension2D)),An(this.camera,this.canvas.width/this.canvas.height),this.normalObjects.depthTexture&&(this.normalObjects.depthTexture.destroy(),this.normalObjects.depthTexture=this.device.createTexture({size:[this.canvas.width,this.canvas.height],format:"depth24plus",usage:GPUTextureUsage.RENDER_ATTACHMENT})),this.rebuildAccumulationTextures())}}),this.resizeObserver.observe(this.canvas)}async cleanup(){if(await this.smallCleanup(),this.removeContextMenu(),this.infoElement)for(;this.infoElement.firstChild;)this.infoElement.removeChild(this.infoElement.firstChild)}async smallCleanup(){this.removeInputHandlers(),jr(),this.animationFrameId!==null&&(cancelAnimationFrame(this.animationFrameId),this.animationFrameId=null),this.resizeObserver&&this.canvas&&(this.resizeObserver.unobserve(this.canvas),this.resizeObserver=null)}changeMeshMaterial(e,r){if(e<0||e>=(this.meshesInfo?.meshIndices.length||0))return;const n=r.name,i=this.normalObjects.sceneInformation.meshes.findIndex(l=>l.Material.name===n)||-1;if(i===-1)return;this.meshesInfo.meshMaterials[e]=r,this.normalObjects.sceneInformation.meshes[i].Material=r;const s=this.meshesInfo.meshIndices[e],o=wi(r);let a=this.normalObjects.materialUniforms[s];this.device.queue.writeBuffer(a,0,o);const c=s*dr*4;this.device.queue.writeBuffer(this.rayTracerObjects.materialBuffer,c,o),this.frameAccumulationReset=!0}recreateBindGroup(e){const r=e.name,n=this.normalObjects.sceneInformation.meshes.findIndex(o=>o.Material.name===r)||-1;if(n===-1)return;const i=this.device.createBindGroup({label:"Material Bind Group "+n,layout:this.normalObjects.materialUniformBindGroupLayout,entries:[{binding:0,resource:{buffer:this.normalObjects.materialUniforms[n]}},{binding:1,resource:this.normalObjects.sampler},{binding:2,resource:e.albedoGPUTexture?e.albedoGPUTexture.createView():Ue(this.device).createView()},{binding:3,resource:e.metalnessGPUTexture?e.metalnessGPUTexture.createView():Ue(this.device).createView()},{binding:4,resource:e.roughnessGPUTexture?e.roughnessGPUTexture.createView():Ue(this.device).createView()},{binding:5,resource:e.normalGPUTexture?e.normalGPUTexture.createView():Ue(this.device).createView()},{binding:6,resource:{buffer:this.normalObjects.meshesModelMatrixBuffers[n]}},{binding:7,resource:{buffer:this.normalObjects.meshesNormalMatrixBuffers[n]}}]});this.normalObjects.materialBindGroups[n]=i;var s=e.textureIndex;for(let o=0;o<4;o++){const a=(()=>{switch(o){case 0:return e.albedoTexture;case 1:return e.metalnessTexture;case 2:return e.roughnessTexture;case 3:return e.normalTexture}})()||Lr(1024,32);this.device.queue.copyExternalImageToTexture({source:a},{texture:this.rayTracerObjects.textureArray,origin:[0,0,s*4+o]},[1024,1024])}}getBVHGeometry(e){if(this.normalObjects.sceneInformation.meshes.length===0)return[];this.normalObjects.bvhLineCounts=[];const r=[];for(let n=0;n<this.normalObjects.sceneInformation.meshes.length;n++){const{vertexData:i,count:s}=this.normalObjects.sceneInformation.meshes[n].GetBVHGeometry(e);r.push(i),this.normalObjects.bvhLineCounts.push(s)}return r}rebuildBVHBuffer(){if(this.device===null)return;const e=this.getBVHGeometry(this.bvhDepth);for(let r=0;r<e.length;r++)this.normalObjects.bvhLineGeometryBuffers[r]=this.device.createBuffer({label:`BVH Line Geometry Buffer ${r}`,size:e[r].byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST}),this.device.queue.writeBuffer(this.normalObjects.bvhLineGeometryBuffers[r],0,e[r])}rayCastOnMeshes(e,r){if(this.canvas===null||this.camera===null||this.meshesInfo===null)return-1;const i=this.meshesInfo.meshIndices.map(m=>this.normalObjects.sceneInformation.meshes[m]),s=this.canvas.getBoundingClientRect(),o=e-s.left,a=r-s.top,c=this.canvas.width/s.width,l=this.canvas.height/s.height,u=2*o*c/this.canvas.width-1,f=1-2*a*l/this.canvas.height,h=mo(this.camera,u,f);let p=-1,d=Number.POSITIVE_INFINITY;for(let m=0;m<i.length;m++){const g=i[m].intersectMeshWithRay(h,4);g<0||(g<d&&(d=g,p=m),console.log(`Mesh ${m} intersection distance:`,g))}return p}spawnMaterialContextMenu(e,r,n){if(this.canvas===null)return;this.removeContextMenu();const i=this.meshesInfo?.meshMaterials?.[e];if(!i)return;this.activeContextMenu=fo({x:r,y:n},i,o=>{this.changeMeshMaterial(e,o)},()=>{this.removeContextMenu()}),document.body.appendChild(this.activeContextMenu);const s=o=>{this.activeContextMenu&&!this.activeContextMenu.contains(o.target)&&(this.removeContextMenu(),document.removeEventListener("mousedown",s))};setTimeout(()=>{document.addEventListener("mousedown",s)},0)}rebuildAccumulationTextures(){this.accumTexture?.destroy(),this.renderTexture?.destroy(),this.accumTexture=this.device.createTexture({label:"Accumulation Texture",size:[this.canvas.width,this.canvas.height],format:"rgba16float",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST}),this.renderTexture=this.device.createTexture({label:"Render Target Texture",size:[this.canvas.width,this.canvas.height],format:"rgba16float",usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.COPY_SRC|GPUTextureUsage.TEXTURE_BINDING}),this.frameAccumulationReset=!0,this.rayTracerObjects.bindGroup=this.device.createBindGroup({label:"Ray Tracer Bind Group",layout:this.rayTracerObjects.bindGroupLayout,entries:[{binding:0,resource:{buffer:this.rayTracerObjects.uniformBuffer}},{binding:1,resource:{buffer:this.rayTracerObjects.positionStorageBuffer}},{binding:2,resource:{buffer:this.rayTracerObjects.normalStorageBuffer}},{binding:3,resource:{buffer:this.rayTracerObjects.uvStorageBuffer}},{binding:4,resource:{buffer:this.rayTracerObjects.indexStorageBuffer}},{binding:5,resource:{buffer:this.rayTracerObjects.bvhNodesStorageBuffer}},{binding:6,resource:{buffer:this.rayTracerObjects.meshInstancesStorageBuffer}},{binding:7,resource:this.accumTexture.createView()}]}),this.rayTracerObjects.displayBindGroup=this.device.createBindGroup({label:"Display Bind Group",layout:this.rayTracerObjects.displayBindGroupLayout,entries:[{binding:0,resource:this.renderTexture.createView()}]})}removeContextMenu(){this.activeContextMenu&&(this.activeContextMenu.remove(),this.activeContextMenu=null)}fetchTextureForMaterial(e,r,n){if(!e){console.error("Material is undefined when trying to fetch texture with name:",n,"and type:",oe[r]);return}Do(n).then(s=>{const o=Fo(s,1024,1024),a=Go(this.device,o);switch(r){case oe.Albedo:e.albedoTexture=o,e.albedoGPUTexture=a;break;case oe.Metalness:e.metalnessTexture=o,e.metalnessGPUTexture=a;break;case oe.Roughness:e.roughnessTexture=o,e.roughnessGPUTexture=a;break;case oe.Normal:e.normalTexture=o,e.normalGPUTexture=a;break}this.recreateBindGroup(e)}).catch(s=>{console.error("Error loading texture with name:",n,"and type:",oe[r],s)})}removeInputHandlers(){window.removeEventListener("keydown",this.onKeyDown),window.removeEventListener("keyup",this.onKeyUp),window.removeEventListener("mouseup",this.onMouseUp),window.removeEventListener("mousemove",this.onMouseMove),this.canvas&&this.canvas.removeEventListener("mousedown",this.onMouseDown)}}const Xv={class:"flex justify-center items-center w-full h-full"},$v={id:"indexingContainer",class:"w-[10%] h-full bg-gray-800 flex flex-col justify-start items-center py-1 overflow-y-auto"},Zv=["onClick","onMouseenter"],eB={id:"utils-wrapper",class:"absolute bottom-0 right-0 flex flex-col items-end"},tB={id:"utils",class:"p-1 bg-gray-700"},rB=Mf({__name:"App",setup(t){const e=er(null),r=er(null),n=er(!1),i=[Id,Fd,Kd,e2,c2,Q2,uv,pv,Tv,Iv,Lv,Kv],s=i.length,o=["Basic Start","Compute Basics","Variables and Uniforms","Storage Buffer Instancing","Vertex and Index Buffers","Video","Game","Ray Trace","Transparency","PBR","BVH","Monte Carlo"],a=er(null),c=er(0),l=er(0),u=er(!0);async function f(g){if(!n.value){if(n.value=!0,r.value&&typeof r.value.cleanup=="function"&&(await r.value.cleanup(),r.value=null),e.value){const y=i[g-1];y&&(r.value=await y(e.value))}n.value=!1}}function h(g,y){a.value=g;const T=y.currentTarget,B=T.parentElement;if(B){const w=B.getBoundingClientRect(),E=T.getBoundingClientRect();c.value=E.top-w.top,l.value=E.height}}function p(){a.value=null}const d=Rs(()=>a.value!==null?o[a.value-1]:""),m=Rs(()=>a.value===null?{top:c.value+"px",height:l.value+"px",transition:"top 0.2s cubic-bezier(0.4,0,0.2,1), height 0.2s cubic-bezier(0.4,0,0.2,1)"}:{top:c.value+"px",height:l.value+"px",transition:"top 0.2s cubic-bezier(0.4,0,0.2,1), height 0.2s cubic-bezier(0.4,0,0.2,1)"});function b(){u.value=!u.value}return Qc(()=>{Ml(),f(11)}),(g,y)=>(Wi(),Ki("div",Xv,[yt("div",$v,[(Wi(!0),Ki(Bt,null,Lf(jc(s),T=>(Wi(),Ki("button",{key:T,class:"w-full h-20 last:mb-0 border border-gray-300 hover:bg-amber-300 active:bg-amber-500 text-lg font-bold shadow flex-shrink-0 relative",tabindex:"-1",onClick:()=>f(T),onKeydown:[y[0]||(y[0]=fa(ua(()=>{},["prevent"]),["space"])),y[1]||(y[1]=fa(ua(()=>{},["prevent"]),["enter"]))],onMouseenter:B=>h(T,B),onMouseleave:p},Vn(T),41,Zv))),128))]),yt("canvas",{id:"webgpuCanvas",ref_key:"webgpuCanvas",ref:e,class:"w-[90%] h-full"},null,512),y[2]||(y[2]=yt("pre",{id:"info",class:"absolute top-0 right-0 p-4"},null,-1)),yt("div",eB,[yt("button",{onClick:b,class:"m-0 p-0 bg-white text-black flex items-center"},[yt("img",{src:nd,class:ln([u.value?"rotate-90":"-rotate-90","w-6 h-6 transition-transform duration-200"])},null,2),bl(" "+Vn(u.value?"Hide":"Show")+" Utils ",1)]),Af(yt("pre",tB,null,512),[[Gh,u.value]])]),yt("div",{class:ln(["absolute left-[10%] w-[25%] bg-gray-700 text-white flex items-center justify-center font-bold text-lg pointer-events-none select-none shadow-lg origin-left transition-all duration-200",a.value===null?"opacity-0 scale-x-0":"opacity-100 scale-x-100"]),style:vi(m.value)},Vn(d.value),7)]))}}),nB=(t,e)=>{const r=t.__vccOpts||t;for(const[n,i]of e)r[n]=i;return r},iB=nB(rB,[["__scopeId","data-v-422a2384"]]);ed(iB).mount("#app");
