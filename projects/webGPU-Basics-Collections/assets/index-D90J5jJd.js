...
* @license MIT
**//*! #__NO_SIDE_EFFECTS__ */function ra(t){const e=Object.create(null);for(const r of t.split(","))e[r]=1;return r=>r in e}const ve={},Ir=[],Et=()=>{},Nc=()=>!1,Mi=t=>t.charCodeAt(0)===111&&t.charCodeAt(1)===110&&(t.charCodeAt(2)>122||t.charCodeAt(2)<97),na=t=>t.startsWith("onUpdate:"),He=Object.assign,ia=(t,e)=>{const r=t.indexOf(e);r>-1&&t.splice(r,1)},Hc=Object.prototype.hasOwnProperty,ce=(t,e)=>Hc.call(t,e),re=Array.isArray,Gr=t=>Si(t)==="[object Map]",Tl=t=>Si(t)==="[object Set]",ie=t=>typeof t=="function",Oe=t=>typeof t=="string",ir=t=>typeof t=="symbol",Ce=t=>t!==null&&typeof t=="object",Ml=t=>(Ce(t)||ie(t))&&ie(t.then)&&ie(t.catch),Sl=Object.prototype.toString,Si=t=>Sl.call(t),Vc=t=>Si(t).slice(8,-1),Pl=t=>Si(t)==="[object Object]",sa=t=>Oe(t)&&t!=="NaN"&&t[0]!=="-"&&""+parseInt(t,10)===t,dn=ra(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Pi=t=>{const e=Object.create(null);return r=>e[r]||(e[r]=t(r))},kc=/-(\w)/g,er=Pi(t=>t.replace(kc,(e,r)=>r?r.toUpperCase():"")),zc=/\B([A-Z])/g,sr=Pi(t=>t.replace(zc,"-$1").toLowerCase()),Cl=Pi(t=>t.charAt(0).toUpperCase()+t.slice(1)),Ji=Pi(t=>t?`on${Cl(t)}`:""),$t=(t,e)=>!Object.is(t,e),Yi=(t,...e)=>{for(let r=0;r<t.length;r++)t[r](...e)},Gs=(t,e,r,n=!1)=>{Object.defineProperty(t,e,{configurable:!0,enumerable:!1,writable:n,value:r})},jc=t=>{const e=parseFloat(t);return isNaN(e)?t:e};let ka;const Ci=()=>ka||(ka=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function kr(t){if(re(t)){const e={};for(let r=0;r<t.length;r++){const n=t[r],i=Oe(n)?Jc(n):kr(n);if(i)for(const s in i)e[s]=i[s]}return e}else if(Oe(t)||Ce(t))return t}const Wc=/;(?![^(]*\))/g,qc=/:([^]+)/,Kc=/\/\*[^]*?\*\//g;function Jc(t){const e={};return t.replace(Kc,"").split(Wc).forEach(r=>{if(r){const n=r.split(qc);n.length>1&&(e[n[0].trim()]=n[1].trim())}}),e}function Tn(t){let e="";if(Oe(t))e=t;else if(re(t))for(let r=0;r<t.length;r++){const n=Tn(t[r]);n&&(e+=n+" ")}else if(Ce(t))for(const r in t)t[r]&&(e+=r+" ");return e.trim()}const Yc="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",Xc=ra(Yc);function El(t){return!!t||t===""}const wl=t=>!!(t&&t.__v_isRef===!0),_r=t=>Oe(t)?t:t==null?"":re(t)||Ce(t)&&(t.toString===Sl||!ie(t.toString))?wl(t)?_r(t.value):JSON.stringify(t,Rl,2):String(t),Rl=(t,e)=>wl(e)?Rl(t,e.value):Gr(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((r,[n,i],s)=>(r[Xi(n,s)+" =>"]=i,r),{})}:Tl(e)?{[`Set(${e.size})`]:[...e.values()].map(r=>Xi(r))}:ir(e)?Xi(e):Ce(e)&&!re(e)&&!Pl(e)?String(e):e,Xi=(t,e="")=>{var r;return ir(t)?`Symbol(${(r=t.description)!=null?r:e})`:t};/**
* @vue/reactivity v3.5.18
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let Ke;class Qc{constructor(e=!1){this.detached=e,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this.parent=Ke,!e&&Ke&&(this.index=(Ke.scopes||(Ke.scopes=[])).push(this)-1)}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let e,r;if(this.scopes)for(e=0,r=this.scopes.length;e<r;e++)this.scopes[e].pause();for(e=0,r=this.effects.length;e<r;e++)this.effects[e].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let e,r;if(this.scopes)for(e=0,r=this.scopes.length;e<r;e++)this.scopes[e].resume();for(e=0,r=this.effects.length;e<r;e++)this.effects[e].resume()}}run(e){if(this._active){const r=Ke;try{return Ke=this,e()}finally{Ke=r}}}on(){++this._on===1&&(this.prevScope=Ke,Ke=this)}off(){this._on>0&&--this._on===0&&(Ke=this.prevScope,this.prevScope=void 0)}stop(e){if(this._active){this._active=!1;let r,n;for(r=0,n=this.effects.length;r<n;r++)this.effects[r].stop();for(this.effects.length=0,r=0,n=this.cleanups.length;r<n;r++)this.cleanups[r]();if(this.cleanups.length=0,this.scopes){for(r=0,n=this.scopes.length;r<n;r++)this.scopes[r].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!e){const i=this.parent.scopes.pop();i&&i!==this&&(this.parent.scopes[this.index]=i,i.index=this.index)}this.parent=void 0}}}function $c(){return Ke}let Be;const Qi=new WeakSet;class Ol{constructor(e){this.fn=e,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,Ke&&Ke.active&&Ke.effects.push(this)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,Qi.has(this)&&(Qi.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||Gl(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,za(this),_l(this);const e=Be,r=bt;Be=this,bt=!0;try{return this.fn()}finally{Ul(this),Be=e,bt=r,this.flags&=-3}}stop(){if(this.flags&1){for(let e=this.deps;e;e=e.nextDep)la(e);this.deps=this.depsTail=void 0,za(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?Qi.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){_s(this)&&this.run()}get dirty(){return _s(this)}}let Il=0,hn,mn;function Gl(t,e=!1){if(t.flags|=8,e){t.next=mn,mn=t;return}t.next=hn,hn=t}function aa(){Il++}function oa(){if(--Il>0)return;if(mn){let e=mn;for(mn=void 0;e;){const r=e.next;e.next=void 0,e.flags&=-9,e=r}}let t;for(;hn;){let e=hn;for(hn=void 0;e;){const r=e.next;if(e.next=void 0,e.flags&=-9,e.flags&1)try{e.trigger()}catch(n){t||(t=n)}e=r}}if(t)throw t}function _l(t){for(let e=t.deps;e;e=e.nextDep)e.version=-1,e.prevActiveLink=e.dep.activeLink,e.dep.activeLink=e}function Ul(t){let e,r=t.depsTail,n=r;for(;n;){const i=n.prevDep;n.version===-1?(n===r&&(r=i),la(n),Zc(n)):e=n,n.dep.activeLink=n.prevActiveLink,n.prevActiveLink=void 0,n=i}t.deps=e,t.depsTail=r}function _s(t){for(let e=t.deps;e;e=e.nextDep)if(e.dep.version!==e.version||e.dep.computed&&(Dl(e.dep.computed)||e.dep.version!==e.version))return!0;return!!t._dirty}function Dl(t){if(t.flags&4&&!(t.flags&16)||(t.flags&=-17,t.globalVersion===Mn)||(t.globalVersion=Mn,!t.isSSR&&t.flags&128&&(!t.deps&&!t._dirty||!_s(t))))return;t.flags|=2;const e=t.dep,r=Be,n=bt;Be=t,bt=!0;try{_l(t);const i=t.fn(t._value);(e.version===0||$t(i,t._value))&&(t.flags|=128,t._value=i,e.version++)}catch(i){throw e.version++,i}finally{Be=r,bt=n,Ul(t),t.flags&=-3}}function la(t,e=!1){const{dep:r,prevSub:n,nextSub:i}=t;if(n&&(n.nextSub=i,t.prevSub=void 0),i&&(i.prevSub=n,t.nextSub=void 0),r.subs===t&&(r.subs=n,!n&&r.computed)){r.computed.flags&=-5;for(let s=r.computed.deps;s;s=s.nextDep)la(s,!0)}!e&&!--r.sc&&r.map&&r.map.delete(r.key)}function Zc(t){const{prevDep:e,nextDep:r}=t;e&&(e.nextDep=r,t.prevDep=void 0),r&&(r.prevDep=e,t.nextDep=void 0)}let bt=!0;const Fl=[];function Ht(){Fl.push(bt),bt=!1}function Vt(){const t=Fl.pop();bt=t===void 0?!0:t}function za(t){const{cleanup:e}=t;if(t.cleanup=void 0,e){const r=Be;Be=void 0;try{e()}finally{Be=r}}}let Mn=0;class ef{constructor(e,r){this.sub=e,this.dep=r,this.version=r.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class ua{constructor(e){this.computed=e,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(e){if(!Be||!bt||Be===this.computed)return;let r=this.activeLink;if(r===void 0||r.sub!==Be)r=this.activeLink=new ef(Be,this),Be.deps?(r.prevDep=Be.depsTail,Be.depsTail.nextDep=r,Be.depsTail=r):Be.deps=Be.depsTail=r,Ll(r);else if(r.version===-1&&(r.version=this.version,r.nextDep)){const n=r.nextDep;n.prevDep=r.prevDep,r.prevDep&&(r.prevDep.nextDep=n),r.prevDep=Be.depsTail,r.nextDep=void 0,Be.depsTail.nextDep=r,Be.depsTail=r,Be.deps===r&&(Be.deps=n)}return r}trigger(e){this.version++,Mn++,this.notify(e)}notify(e){aa();try{for(let r=this.subs;r;r=r.prevSub)r.sub.notify()&&r.sub.dep.notify()}finally{oa()}}}function Ll(t){if(t.dep.sc++,t.sub.flags&4){const e=t.dep.computed;if(e&&!t.dep.subs){e.flags|=20;for(let n=e.deps;n;n=n.nextDep)Ll(n)}const r=t.dep.subs;r!==t&&(t.prevSub=r,r&&(r.nextSub=t)),t.dep.subs=t}}const Us=new WeakMap,br=Symbol(""),Ds=Symbol(""),Sn=Symbol("");function Le(t,e,r){if(bt&&Be){let n=Us.get(t);n||Us.set(t,n=new Map);let i=n.get(r);i||(n.set(r,i=new ua),i.map=n,i.key=r),i.track()}}function Dt(t,e,r,n,i,s){const a=Us.get(t);if(!a){Mn++;return}const o=l=>{l&&l.trigger()};if(aa(),e==="clear")a.forEach(o);else{const l=re(t),u=l&&sa(r);if(l&&r==="length"){const c=Number(n);a.forEach((f,d)=>{(d==="length"||d===Sn||!ir(d)&&d>=c)&&o(f)})}else switch((r!==void 0||a.has(void 0))&&o(a.get(r)),u&&o(a.get(Sn)),e){case"add":l?u&&o(a.get("length")):(o(a.get(br)),Gr(t)&&o(a.get(Ds)));break;case"delete":l||(o(a.get(br)),Gr(t)&&o(a.get(Ds)));break;case"set":Gr(t)&&o(a.get(br));break}}oa()}function Ar(t){const e=ue(t);return e===t?e:(Le(e,"iterate",Sn),ut(t)?e:e.map(Ue))}function Ei(t){return Le(t=ue(t),"iterate",Sn),t}const tf={__proto__:null,[Symbol.iterator](){return $i(this,Symbol.iterator,Ue)},concat(...t){return Ar(this).concat(...t.map(e=>re(e)?Ar(e):e))},entries(){return $i(this,"entries",t=>(t[1]=Ue(t[1]),t))},every(t,e){return Ot(this,"every",t,e,void 0,arguments)},filter(t,e){return Ot(this,"filter",t,e,r=>r.map(Ue),arguments)},find(t,e){return Ot(this,"find",t,e,Ue,arguments)},findIndex(t,e){return Ot(this,"findIndex",t,e,void 0,arguments)},findLast(t,e){return Ot(this,"findLast",t,e,Ue,arguments)},findLastIndex(t,e){return Ot(this,"findLastIndex",t,e,void 0,arguments)},forEach(t,e){return Ot(this,"forEach",t,e,void 0,arguments)},includes(...t){return Zi(this,"includes",t)},indexOf(...t){return Zi(this,"indexOf",t)},join(t){return Ar(this).join(t)},lastIndexOf(...t){return Zi(this,"lastIndexOf",t)},map(t,e){return Ot(this,"map",t,e,void 0,arguments)},pop(){return sn(this,"pop")},push(...t){return sn(this,"push",t)},reduce(t,...e){return ja(this,"reduce",t,e)},reduceRight(t,...e){return ja(this,"reduceRight",t,e)},shift(){return sn(this,"shift")},some(t,e){return Ot(this,"some",t,e,void 0,arguments)},splice(...t){return sn(this,"splice",t)},toReversed(){return Ar(this).toReversed()},toSorted(t){return Ar(this).toSorted(t)},toSpliced(...t){return Ar(this).toSpliced(...t)},unshift(...t){return sn(this,"unshift",t)},values(){return $i(this,"values",Ue)}};function $i(t,e,r){const n=Ei(t),i=n[e]();return n!==t&&!ut(t)&&(i._next=i.next,i.next=()=>{const s=i._next();return s.value&&(s.value=r(s.value)),s}),i}const rf=Array.prototype;function Ot(t,e,r,n,i,s){const a=Ei(t),o=a!==t&&!ut(t),l=a[e];if(l!==rf[e]){const f=l.apply(t,s);return o?Ue(f):f}let u=r;a!==t&&(o?u=function(f,d){return r.call(this,Ue(f),d,t)}:r.length>2&&(u=function(f,d){return r.call(this,f,d,t)}));const c=l.call(a,u,n);return o&&i?i(c):c}function ja(t,e,r,n){const i=Ei(t);let s=r;return i!==t&&(ut(t)?r.length>3&&(s=function(a,o,l){return r.call(this,a,o,l,t)}):s=function(a,o,l){return r.call(this,a,Ue(o),l,t)}),i[e](s,...n)}function Zi(t,e,r){const n=ue(t);Le(n,"iterate",Sn);const i=n[e](...r);return(i===-1||i===!1)&&ha(r[0])?(r[0]=ue(r[0]),n[e](...r)):i}function sn(t,e,r=[]){Ht(),aa();const n=ue(t)[e].apply(t,r);return oa(),Vt(),n}const nf=ra("__proto__,__v_isRef,__isVue"),Nl=new Set(Object.getOwnPropertyNames(Symbol).filter(t=>t!=="arguments"&&t!=="caller").map(t=>Symbol[t]).filter(ir));function sf(t){ir(t)||(t=String(t));const e=ue(this);return Le(e,"has",t),e.hasOwnProperty(t)}class Hl{constructor(e=!1,r=!1){this._isReadonly=e,this._isShallow=r}get(e,r,n){if(r==="__v_skip")return e.__v_skip;const i=this._isReadonly,s=this._isShallow;if(r==="__v_isReactive")return!i;if(r==="__v_isReadonly")return i;if(r==="__v_isShallow")return s;if(r==="__v_raw")return n===(i?s?pf:jl:s?zl:kl).get(e)||Object.getPrototypeOf(e)===Object.getPrototypeOf(n)?e:void 0;const a=re(e);if(!i){let l;if(a&&(l=tf[r]))return l;if(r==="hasOwnProperty")return sf}const o=Reflect.get(e,r,Ne(e)?e:n);return(ir(r)?Nl.has(r):nf(r))||(i||Le(e,"get",r),s)?o:Ne(o)?a&&sa(r)?o:o.value:Ce(o)?i?Wl(o):fa(o):o}}class Vl extends Hl{constructor(e=!1){super(!1,e)}set(e,r,n,i){let s=e[r];if(!this._isShallow){const l=tr(s);if(!ut(n)&&!tr(n)&&(s=ue(s),n=ue(n)),!re(e)&&Ne(s)&&!Ne(n))return l?!1:(s.value=n,!0)}const a=re(e)&&sa(r)?Number(r)<e.length:ce(e,r),o=Reflect.set(e,r,n,Ne(e)?e:i);return e===ue(i)&&(a?$t(n,s)&&Dt(e,"set",r,n):Dt(e,"add",r,n)),o}deleteProperty(e,r){const n=ce(e,r);e[r];const i=Reflect.deleteProperty(e,r);return i&&n&&Dt(e,"delete",r,void 0),i}has(e,r){const n=Reflect.has(e,r);return(!ir(r)||!Nl.has(r))&&Le(e,"has",r),n}ownKeys(e){return Le(e,"iterate",re(e)?"length":br),Reflect.ownKeys(e)}}class af extends Hl{constructor(e=!1){super(!0,e)}set(e,r){return!0}deleteProperty(e,r){return!0}}const of=new Vl,lf=new af,uf=new Vl(!0);const Fs=t=>t,Hn=t=>Reflect.getPrototypeOf(t);function cf(t,e,r){return function(...n){const i=this.__v_raw,s=ue(i),a=Gr(s),o=t==="entries"||t===Symbol.iterator&&a,l=t==="keys"&&a,u=i[t](...n),c=r?Fs:e?ai:Ue;return!e&&Le(s,"iterate",l?Ds:br),{next(){const{value:f,done:d}=u.next();return d?{value:f,done:d}:{value:o?[c(f[0]),c(f[1])]:c(f),done:d}},[Symbol.iterator](){return this}}}}function Vn(t){return function(...e){return t==="delete"?!1:t==="clear"?void 0:this}}function ff(t,e){const r={get(i){const s=this.__v_raw,a=ue(s),o=ue(i);t||($t(i,o)&&Le(a,"get",i),Le(a,"get",o));const{has:l}=Hn(a),u=e?Fs:t?ai:Ue;if(l.call(a,i))return u(s.get(i));if(l.call(a,o))return u(s.get(o));s!==a&&s.get(i)},get size(){const i=this.__v_raw;return!t&&Le(ue(i),"iterate",br),Reflect.get(i,"size",i)},has(i){const s=this.__v_raw,a=ue(s),o=ue(i);return t||($t(i,o)&&Le(a,"has",i),Le(a,"has",o)),i===o?s.has(i):s.has(i)||s.has(o)},forEach(i,s){const a=this,o=a.__v_raw,l=ue(o),u=e?Fs:t?ai:Ue;return!t&&Le(l,"iterate",br),o.forEach((c,f)=>i.call(s,u(c),u(f),a))}};return He(r,t?{add:Vn("add"),set:Vn("set"),delete:Vn("delete"),clear:Vn("clear")}:{add(i){!e&&!ut(i)&&!tr(i)&&(i=ue(i));const s=ue(this);return Hn(s).has.call(s,i)||(s.add(i),Dt(s,"add",i,i)),this},set(i,s){!e&&!ut(s)&&!tr(s)&&(s=ue(s));const a=ue(this),{has:o,get:l}=Hn(a);let u=o.call(a,i);u||(i=ue(i),u=o.call(a,i));const c=l.call(a,i);return a.set(i,s),u?$t(s,c)&&Dt(a,"set",i,s):Dt(a,"add",i,s),this},delete(i){const s=ue(this),{has:a,get:o}=Hn(s);let l=a.call(s,i);l||(i=ue(i),l=a.call(s,i)),o&&o.call(s,i);const u=s.delete(i);return l&&Dt(s,"delete",i,void 0),u},clear(){const i=ue(this),s=i.size!==0,a=i.clear();return s&&Dt(i,"clear",void 0,void 0),a}}),["keys","values","entries",Symbol.iterator].forEach(i=>{r[i]=cf(i,t,e)}),r}function ca(t,e){const r=ff(t,e);return(n,i,s)=>i==="__v_isReactive"?!t:i==="__v_isReadonly"?t:i==="__v_raw"?n:Reflect.get(ce(r,i)&&i in n?r:n,i,s)}const df={get:ca(!1,!1)},hf={get:ca(!1,!0)},mf={get:ca(!0,!1)};const kl=new WeakMap,zl=new WeakMap,jl=new WeakMap,pf=new WeakMap;function gf(t){switch(t){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function bf(t){return t.__v_skip||!Object.isExtensible(t)?0:gf(Vc(t))}function fa(t){return tr(t)?t:da(t,!1,of,df,kl)}function yf(t){return da(t,!1,uf,hf,zl)}function Wl(t){return da(t,!0,lf,mf,jl)}function da(t,e,r,n,i){if(!Ce(t)||t.__v_raw&&!(e&&t.__v_isReactive))return t;const s=bf(t);if(s===0)return t;const a=i.get(t);if(a)return a;const o=new Proxy(t,s===2?n:r);return i.set(t,o),o}function Ur(t){return tr(t)?Ur(t.__v_raw):!!(t&&t.__v_isReactive)}function tr(t){return!!(t&&t.__v_isReadonly)}function ut(t){return!!(t&&t.__v_isShallow)}function ha(t){return t?!!t.__v_raw:!1}function ue(t){const e=t&&t.__v_raw;return e?ue(e):t}function vf(t){return!ce(t,"__v_skip")&&Object.isExtensible(t)&&Gs(t,"__v_skip",!0),t}const Ue=t=>Ce(t)?fa(t):t,ai=t=>Ce(t)?Wl(t):t;function Ne(t){return t?t.__v_isRef===!0:!1}function Tt(t){return xf(t,!1)}function xf(t,e){return Ne(t)?t:new Bf(t,e)}class Bf{constructor(e,r){this.dep=new ua,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=r?e:ue(e),this._value=r?e:Ue(e),this.__v_isShallow=r}get value(){return this.dep.track(),this._value}set value(e){const r=this._rawValue,n=this.__v_isShallow||ut(e)||tr(e);e=n?e:ue(e),$t(e,r)&&(this._rawValue=e,this._value=n?e:Ue(e),this.dep.trigger())}}function ql(t){return Ne(t)?t.value:t}const Af={get:(t,e,r)=>e==="__v_raw"?t:ql(Reflect.get(t,e,r)),set:(t,e,r,n)=>{const i=t[e];return Ne(i)&&!Ne(r)?(i.value=r,!0):Reflect.set(t,e,r,n)}};function Kl(t){return Ur(t)?t:new Proxy(t,Af)}class Tf{constructor(e,r,n){this.fn=e,this.setter=r,this._value=void 0,this.dep=new ua(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=Mn-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!r,this.isSSR=n}notify(){if(this.flags|=16,!(this.flags&8)&&Be!==this)return Gl(this,!0),!0}get value(){const e=this.dep.track();return Dl(this),e&&(e.version=this.dep.version),this._value}set value(e){this.setter&&this.setter(e)}}function Mf(t,e,r=!1){let n,i;return ie(t)?n=t:(n=t.get,i=t.set),new Tf(n,i,r)}const kn={},oi=new WeakMap;let dr;function Sf(t,e=!1,r=dr){if(r){let n=oi.get(r);n||oi.set(r,n=[]),n.push(t)}}function Pf(t,e,r=ve){const{immediate:n,deep:i,once:s,scheduler:a,augmentJob:o,call:l}=r,u=b=>i?b:ut(b)||i===!1||i===0?Ft(b,1):Ft(b);let c,f,d,m,h=!1,p=!1;if(Ne(t)?(f=()=>t.value,h=ut(t)):Ur(t)?(f=()=>u(t),h=!0):re(t)?(p=!0,h=t.some(b=>Ur(b)||ut(b)),f=()=>t.map(b=>{if(Ne(b))return b.value;if(Ur(b))return u(b);if(ie(b))return l?l(b,2):b()})):ie(t)?e?f=l?()=>l(t,2):t:f=()=>{if(d){Ht();try{d()}finally{Vt()}}const b=dr;dr=c;try{return l?l(t,3,[m]):t(m)}finally{dr=b}}:f=Et,e&&i){const b=f,P=i===!0?1/0:i;f=()=>Ft(b(),P)}const g=$c(),y=()=>{c.stop(),g&&g.active&&ia(g.effects,c)};if(s&&e){const b=e;e=(...P)=>{b(...P),y()}}let v=p?new Array(t.length).fill(kn):kn;const S=b=>{if(!(!(c.flags&1)||!c.dirty&&!b))if(e){const P=c.run();if(i||h||(p?P.some((E,A)=>$t(E,v[A])):$t(P,v))){d&&d();const E=dr;dr=c;try{const A=[P,v===kn?void 0:p&&v[0]===kn?[]:v,m];v=P,l?l(e,3,A):e(...A)}finally{dr=E}}}else c.run()};return o&&o(S),c=new Ol(f),c.scheduler=a?()=>a(S,!1):S,m=b=>Sf(b,!1,c),d=c.onStop=()=>{const b=oi.get(c);if(b){if(l)l(b,4);else for(const P of b)P();oi.delete(c)}},e?n?S(!0):v=c.run():a?a(S.bind(null,!0),!0):c.run(),y.pause=c.pause.bind(c),y.resume=c.resume.bind(c),y.stop=y,y}function Ft(t,e=1/0,r){if(e<=0||!Ce(t)||t.__v_skip||(r=r||new Set,r.has(t)))return t;if(r.add(t),e--,Ne(t))Ft(t.value,e,r);else if(re(t))for(let n=0;n<t.length;n++)Ft(t[n],e,r);else if(Tl(t)||Gr(t))t.forEach(n=>{Ft(n,e,r)});else if(Pl(t)){for(const n in t)Ft(t[n],e,r);for(const n of Object.getOwnPropertySymbols(t))Object.prototype.propertyIsEnumerable.call(t,n)&&Ft(t[n],e,r)}return t}/**
* @vue/runtime-core v3.5.18
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function Gn(t,e,r,n){try{return n?t(...n):t()}catch(i){wi(i,e,r)}}function wt(t,e,r,n){if(ie(t)){const i=Gn(t,e,r,n);return i&&Ml(i)&&i.catch(s=>{wi(s,e,r)}),i}if(re(t)){const i=[];for(let s=0;s<t.length;s++)i.push(wt(t[s],e,r,n));return i}}function wi(t,e,r,n=!0){const i=e?e.vnode:null,{errorHandler:s,throwUnhandledErrorInProduction:a}=e&&e.appContext.config||ve;if(e){let o=e.parent;const l=e.proxy,u=`https://vuejs.org/error-reference/#runtime-${r}`;for(;o;){const c=o.ec;if(c){for(let f=0;f<c.length;f++)if(c[f](t,l,u)===!1)return}o=o.parent}if(s){Ht(),Gn(s,null,10,[t,l,u]),Vt();return}}Cf(t,r,i,n,a)}function Cf(t,e,r,n=!0,i=!1){if(i)throw t;console.error(t)}const ke=[];let Mt=-1;const Dr=[];let Kt=null,Er=0;const Jl=Promise.resolve();let li=null;function Yl(t){const e=li||Jl;return t?e.then(this?t.bind(this):t):e}function Ef(t){let e=Mt+1,r=ke.length;for(;e<r;){const n=e+r>>>1,i=ke[n],s=Pn(i);s<t||s===t&&i.flags&2?e=n+1:r=n}return e}function ma(t){if(!(t.flags&1)){const e=Pn(t),r=ke[ke.length-1];!r||!(t.flags&2)&&e>=Pn(r)?ke.push(t):ke.splice(Ef(e),0,t),t.flags|=1,Xl()}}function Xl(){li||(li=Jl.then($l))}function wf(t){re(t)?Dr.push(...t):Kt&&t.id===-1?Kt.splice(Er+1,0,t):t.flags&1||(Dr.push(t),t.flags|=1),Xl()}function Wa(t,e,r=Mt+1){for(;r<ke.length;r++){const n=ke[r];if(n&&n.flags&2){if(t&&n.id!==t.uid)continue;ke.splice(r,1),r--,n.flags&4&&(n.flags&=-2),n(),n.flags&4||(n.flags&=-2)}}}function Ql(t){if(Dr.length){const e=[...new Set(Dr)].sort((r,n)=>Pn(r)-Pn(n));if(Dr.length=0,Kt){Kt.push(...e);return}for(Kt=e,Er=0;Er<Kt.length;Er++){const r=Kt[Er];r.flags&4&&(r.flags&=-2),r.flags&8||r(),r.flags&=-2}Kt=null,Er=0}}const Pn=t=>t.id==null?t.flags&2?-1:1/0:t.id;function $l(t){try{for(Mt=0;Mt<ke.length;Mt++){const e=ke[Mt];e&&!(e.flags&8)&&(e.flags&4&&(e.flags&=-2),Gn(e,e.i,e.i?15:14),e.flags&4||(e.flags&=-2))}}finally{for(;Mt<ke.length;Mt++){const e=ke[Mt];e&&(e.flags&=-2)}Mt=-1,ke.length=0,Ql(),li=null,(ke.length||Dr.length)&&$l()}}let ot=null,Zl=null;function ui(t){const e=ot;return ot=t,Zl=t&&t.type.__scopeId||null,e}function Rf(t,e=ot,r){if(!e||t._n)return t;const n=(...i)=>{n._d&&eo(-1);const s=ui(e);let a;try{a=t(...i)}finally{ui(s),n._d&&eo(1)}return a};return n._n=!0,n._c=!0,n._d=!0,n}function Of(t,e){if(ot===null)return t;const r=Gi(ot),n=t.dirs||(t.dirs=[]);for(let i=0;i<e.length;i++){let[s,a,o,l=ve]=e[i];s&&(ie(s)&&(s={mounted:s,updated:s}),s.deep&&Ft(a),n.push({dir:s,instance:r,value:a,oldValue:void 0,arg:o,modifiers:l}))}return t}function ur(t,e,r,n){const i=t.dirs,s=e&&e.dirs;for(let a=0;a<i.length;a++){const o=i[a];s&&(o.oldValue=s[a].value);let l=o.dir[n];l&&(Ht(),wt(l,r,8,[t.el,o,t,e]),Vt())}}const If=Symbol("_vte"),Gf=t=>t.__isTeleport;function pa(t,e){t.shapeFlag&6&&t.component?(t.transition=e,pa(t.component.subTree,e)):t.shapeFlag&128?(t.ssContent.transition=e.clone(t.ssContent),t.ssFallback.transition=e.clone(t.ssFallback)):t.transition=e}/*! #__NO_SIDE_EFFECTS__ */function eu(t,e){return ie(t)?He({name:t.name},e,{setup:t}):t}function tu(t){t.ids=[t.ids[0]+t.ids[2]+++"-",0,0]}function pn(t,e,r,n,i=!1){if(re(t)){t.forEach((h,p)=>pn(h,e&&(re(e)?e[p]:e),r,n,i));return}if(gn(n)&&!i){n.shapeFlag&512&&n.type.__asyncResolved&&n.component.subTree.component&&pn(t,e,r,n.component.subTree);return}const s=n.shapeFlag&4?Gi(n.component):n.el,a=i?null:s,{i:o,r:l}=t,u=e&&e.r,c=o.refs===ve?o.refs={}:o.refs,f=o.setupState,d=ue(f),m=f===ve?()=>!1:h=>ce(d,h);if(u!=null&&u!==l&&(Oe(u)?(c[u]=null,m(u)&&(f[u]=null)):Ne(u)&&(u.value=null)),ie(l))Gn(l,o,12,[a,c]);else{const h=Oe(l),p=Ne(l);if(h||p){const g=()=>{if(t.f){const y=h?m(l)?f[l]:c[l]:l.value;i?re(y)&&ia(y,s):re(y)?y.includes(s)||y.push(s):h?(c[l]=[s],m(l)&&(f[l]=c[l])):(l.value=[s],t.k&&(c[t.k]=l.value))}else h?(c[l]=a,m(l)&&(f[l]=a)):p&&(l.value=a,t.k&&(c[t.k]=a))};a?(g.id=-1,Ze(g,r)):g()}}}Ci().requestIdleCallback;Ci().cancelIdleCallback;const gn=t=>!!t.type.__asyncLoader,ru=t=>t.type.__isKeepAlive;function _f(t,e){nu(t,"a",e)}function Uf(t,e){nu(t,"da",e)}function nu(t,e,r=ze){const n=t.__wdc||(t.__wdc=()=>{let i=r;for(;i;){if(i.isDeactivated)return;i=i.parent}return t()});if(Ri(e,n,r),r){let i=r.parent;for(;i&&i.parent;)ru(i.parent.vnode)&&Df(n,e,r,i),i=i.parent}}function Df(t,e,r,n){const i=Ri(e,t,n,!0);su(()=>{ia(n[e],i)},r)}function Ri(t,e,r=ze,n=!1){if(r){const i=r[t]||(r[t]=[]),s=e.__weh||(e.__weh=(...a)=>{Ht();const o=_n(r),l=wt(e,r,t,a);return o(),Vt(),l});return n?i.unshift(s):i.push(s),s}}const jt=t=>(e,r=ze)=>{(!En||t==="sp")&&Ri(t,(...n)=>e(...n),r)},Ff=jt("bm"),iu=jt("m"),Lf=jt("bu"),Nf=jt("u"),Hf=jt("bum"),su=jt("um"),Vf=jt("sp"),kf=jt("rtg"),zf=jt("rtc");function jf(t,e=ze){Ri("ec",t,e)}const Wf=Symbol.for("v-ndc");function au(t,e,r,n){let i;const s=r,a=re(t);if(a||Oe(t)){const o=a&&Ur(t);let l=!1,u=!1;o&&(l=!ut(t),u=tr(t),t=Ei(t)),i=new Array(t.length);for(let c=0,f=t.length;c<f;c++)i[c]=e(l?u?ai(Ue(t[c])):Ue(t[c]):t[c],c,void 0,s)}else if(typeof t=="number"){i=new Array(t);for(let o=0;o<t;o++)i[o]=e(o+1,o,void 0,s)}else if(Ce(t))if(t[Symbol.iterator])i=Array.from(t,(o,l)=>e(o,l,void 0,s));else{const o=Object.keys(t);i=new Array(o.length);for(let l=0,u=o.length;l<u;l++){const c=o[l];i[l]=e(t[c],c,l,s)}}else i=[];return i}const Ls=t=>t?Cu(t)?Gi(t):Ls(t.parent):null,bn=He(Object.create(null),{$:t=>t,$el:t=>t.vnode.el,$data:t=>t.data,$props:t=>t.props,$attrs:t=>t.attrs,$slots:t=>t.slots,$refs:t=>t.refs,$parent:t=>Ls(t.parent),$root:t=>Ls(t.root),$host:t=>t.ce,$emit:t=>t.emit,$options:t=>lu(t),$forceUpdate:t=>t.f||(t.f=()=>{ma(t.update)}),$nextTick:t=>t.n||(t.n=Yl.bind(t.proxy)),$watch:t=>hd.bind(t)}),es=(t,e)=>t!==ve&&!t.__isScriptSetup&&ce(t,e),qf={get({_:t},e){if(e==="__v_skip")return!0;const{ctx:r,setupState:n,data:i,props:s,accessCache:a,type:o,appContext:l}=t;let u;if(e[0]!=="$"){const m=a[e];if(m!==void 0)switch(m){case 1:return n[e];case 2:return i[e];case 4:return r[e];case 3:return s[e]}else{if(es(n,e))return a[e]=1,n[e];if(i!==ve&&ce(i,e))return a[e]=2,i[e];if((u=t.propsOptions[0])&&ce(u,e))return a[e]=3,s[e];if(r!==ve&&ce(r,e))return a[e]=4,r[e];Ns&&(a[e]=0)}}const c=bn[e];let f,d;if(c)return e==="$attrs"&&Le(t.attrs,"get",""),c(t);if((f=o.__cssModules)&&(f=f[e]))return f;if(r!==ve&&ce(r,e))return a[e]=4,r[e];if(d=l.config.globalProperties,ce(d,e))return d[e]},set({_:t},e,r){const{data:n,setupState:i,ctx:s}=t;return es(i,e)?(i[e]=r,!0):n!==ve&&ce(n,e)?(n[e]=r,!0):ce(t.props,e)||e[0]==="$"&&e.slice(1)in t?!1:(s[e]=r,!0)},has({_:{data:t,setupState:e,accessCache:r,ctx:n,appContext:i,propsOptions:s}},a){let o;return!!r[a]||t!==ve&&ce(t,a)||es(e,a)||(o=s[0])&&ce(o,a)||ce(n,a)||ce(bn,a)||ce(i.config.globalProperties,a)},defineProperty(t,e,r){return r.get!=null?t._.accessCache[e]=0:ce(r,"value")&&this.set(t,e,r.value,null),Reflect.defineProperty(t,e,r)}};function qa(t){return re(t)?t.reduce((e,r)=>(e[r]=null,e),{}):t}let Ns=!0;function Kf(t){const e=lu(t),r=t.proxy,n=t.ctx;Ns=!1,e.beforeCreate&&Ka(e.beforeCreate,t,"bc");const{data:i,computed:s,methods:a,watch:o,provide:l,inject:u,created:c,beforeMount:f,mounted:d,beforeUpdate:m,updated:h,activated:p,deactivated:g,beforeDestroy:y,beforeUnmount:v,destroyed:S,unmounted:b,render:P,renderTracked:E,renderTriggered:A,errorCaptured:R,serverPrefetch:M,expose:G,inheritAttrs:D,components:F,directives:U,filters:O}=e;if(u&&Jf(u,n,null),a)for(const _ in a){const w=a[_];ie(w)&&(n[_]=w.bind(r))}if(i){const _=i.call(r,r);Ce(_)&&(t.data=fa(_))}if(Ns=!0,s)for(const _ in s){const w=s[_],K=ie(w)?w.bind(r,r):ie(w.get)?w.get.bind(r,r):Et,ee=!ie(w)&&ie(w.set)?w.set.bind(r):Et,$=wn({get:K,set:ee});Object.defineProperty(n,_,{enumerable:!0,configurable:!0,get:()=>$.value,set:J=>$.value=J})}if(o)for(const _ in o)ou(o[_],n,r,_);if(l){const _=ie(l)?l.call(r):l;Reflect.ownKeys(_).forEach(w=>{ed(w,_[w])})}c&&Ka(c,t,"c");function N(_,w){re(w)?w.forEach(K=>_(K.bind(r))):w&&_(w.bind(r))}if(N(Ff,f),N(iu,d),N(Lf,m),N(Nf,h),N(_f,p),N(Uf,g),N(jf,R),N(zf,E),N(kf,A),N(Hf,v),N(su,b),N(Vf,M),re(G))if(G.length){const _=t.exposed||(t.exposed={});G.forEach(w=>{Object.defineProperty(_,w,{get:()=>r[w],set:K=>r[w]=K,enumerable:!0})})}else t.exposed||(t.exposed={});P&&t.render===Et&&(t.render=P),D!=null&&(t.inheritAttrs=D),F&&(t.components=F),U&&(t.directives=U),M&&tu(t)}function Jf(t,e,r=Et){re(t)&&(t=Hs(t));for(const n in t){const i=t[n];let s;Ce(i)?"default"in i?s=Qn(i.from||n,i.default,!0):s=Qn(i.from||n):s=Qn(i),Ne(s)?Object.defineProperty(e,n,{enumerable:!0,configurable:!0,get:()=>s.value,set:a=>s.value=a}):e[n]=s}}function Ka(t,e,r){wt(re(t)?t.map(n=>n.bind(e.proxy)):t.bind(e.proxy),e,r)}function ou(t,e,r,n){let i=n.includes(".")?Bu(r,n):()=>r[n];if(Oe(t)){const s=e[t];ie(s)&&rs(i,s)}else if(ie(t))rs(i,t.bind(r));else if(Ce(t))if(re(t))t.forEach(s=>ou(s,e,r,n));else{const s=ie(t.handler)?t.handler.bind(r):e[t.handler];ie(s)&&rs(i,s,t)}}function lu(t){const e=t.type,{mixins:r,extends:n}=e,{mixins:i,optionsCache:s,config:{optionMergeStrategies:a}}=t.appContext,o=s.get(e);let l;return o?l=o:!i.length&&!r&&!n?l=e:(l={},i.length&&i.forEach(u=>ci(l,u,a,!0)),ci(l,e,a)),Ce(e)&&s.set(e,l),l}function ci(t,e,r,n=!1){const{mixins:i,extends:s}=e;s&&ci(t,s,r,!0),i&&i.forEach(a=>ci(t,a,r,!0));for(const a in e)if(!(n&&a==="expose")){const o=Yf[a]||r&&r[a];t[a]=o?o(t[a],e[a]):e[a]}return t}const Yf={data:Ja,props:Ya,emits:Ya,methods:un,computed:un,beforeCreate:Ve,created:Ve,beforeMount:Ve,mounted:Ve,beforeUpdate:Ve,updated:Ve,beforeDestroy:Ve,beforeUnmount:Ve,destroyed:Ve,unmounted:Ve,activated:Ve,deactivated:Ve,errorCaptured:Ve,serverPrefetch:Ve,components:un,directives:un,watch:Qf,provide:Ja,inject:Xf};function Ja(t,e){return e?t?function(){return He(ie(t)?t.call(this,this):t,ie(e)?e.call(this,this):e)}:e:t}function Xf(t,e){return un(Hs(t),Hs(e))}function Hs(t){if(re(t)){const e={};for(let r=0;r<t.length;r++)e[t[r]]=t[r];return e}return t}function Ve(t,e){return t?[...new Set([].concat(t,e))]:e}function un(t,e){return t?He(Object.create(null),t,e):e}function Ya(t,e){return t?re(t)&&re(e)?[...new Set([...t,...e])]:He(Object.create(null),qa(t),qa(e??{})):e}function Qf(t,e){if(!t)return e;if(!e)return t;const r=He(Object.create(null),t);for(const n in e)r[n]=Ve(t[n],e[n]);return r}function uu(){return{app:null,config:{isNativeTag:Nc,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let $f=0;function Zf(t,e){return function(n,i=null){ie(n)||(n=He({},n)),i!=null&&!Ce(i)&&(i=null);const s=uu(),a=new WeakSet,o=[];let l=!1;const u=s.app={_uid:$f++,_component:n,_props:i,_container:null,_context:s,_instance:null,version:Ud,get config(){return s.config},set config(c){},use(c,...f){return a.has(c)||(c&&ie(c.install)?(a.add(c),c.install(u,...f)):ie(c)&&(a.add(c),c(u,...f))),u},mixin(c){return s.mixins.includes(c)||s.mixins.push(c),u},component(c,f){return f?(s.components[c]=f,u):s.components[c]},directive(c,f){return f?(s.directives[c]=f,u):s.directives[c]},mount(c,f,d){if(!l){const m=u._ceVNode||Zt(n,i);return m.appContext=s,d===!0?d="svg":d===!1&&(d=void 0),t(m,c,d),l=!0,u._container=c,c.__vue_app__=u,Gi(m.component)}},onUnmount(c){o.push(c)},unmount(){l&&(wt(o,u._instance,16),t(null,u._container),delete u._container.__vue_app__)},provide(c,f){return s.provides[c]=f,u},runWithContext(c){const f=Fr;Fr=u;try{return c()}finally{Fr=f}}};return u}}let Fr=null;function ed(t,e){if(ze){let r=ze.provides;const n=ze.parent&&ze.parent.provides;n===r&&(r=ze.provides=Object.create(n)),r[t]=e}}function Qn(t,e,r=!1){const n=wd();if(n||Fr){let i=Fr?Fr._context.provides:n?n.parent==null||n.ce?n.vnode.appContext&&n.vnode.appContext.provides:n.parent.provides:void 0;if(i&&t in i)return i[t];if(arguments.length>1)return r&&ie(e)?e.call(n&&n.proxy):e}}const cu={},fu=()=>Object.create(cu),du=t=>Object.getPrototypeOf(t)===cu;function td(t,e,r,n=!1){const i={},s=fu();t.propsDefaults=Object.create(null),hu(t,e,i,s);for(const a in t.propsOptions[0])a in i||(i[a]=void 0);r?t.props=n?i:yf(i):t.type.props?t.props=i:t.props=s,t.attrs=s}function rd(t,e,r,n){const{props:i,attrs:s,vnode:{patchFlag:a}}=t,o=ue(i),[l]=t.propsOptions;let u=!1;if((n||a>0)&&!(a&16)){if(a&8){const c=t.vnode.dynamicProps;for(let f=0;f<c.length;f++){let d=c[f];if(Oi(t.emitsOptions,d))continue;const m=e[d];if(l)if(ce(s,d))m!==s[d]&&(s[d]=m,u=!0);else{const h=er(d);i[h]=Vs(l,o,h,m,t,!1)}else m!==s[d]&&(s[d]=m,u=!0)}}}else{hu(t,e,i,s)&&(u=!0);let c;for(const f in o)(!e||!ce(e,f)&&((c=sr(f))===f||!ce(e,c)))&&(l?r&&(r[f]!==void 0||r[c]!==void 0)&&(i[f]=Vs(l,o,f,void 0,t,!0)):delete i[f]);if(s!==o)for(const f in s)(!e||!ce(e,f))&&(delete s[f],u=!0)}u&&Dt(t.attrs,"set","")}function hu(t,e,r,n){const[i,s]=t.propsOptions;let a=!1,o;if(e)for(let l in e){if(dn(l))continue;const u=e[l];let c;i&&ce(i,c=er(l))?!s||!s.includes(c)?r[c]=u:(o||(o={}))[c]=u:Oi(t.emitsOptions,l)||(!(l in n)||u!==n[l])&&(n[l]=u,a=!0)}if(s){const l=ue(r),u=o||ve;for(let c=0;c<s.length;c++){const f=s[c];r[f]=Vs(i,l,f,u[f],t,!ce(u,f))}}return a}function Vs(t,e,r,n,i,s){const a=t[r];if(a!=null){const o=ce(a,"default");if(o&&n===void 0){const l=a.default;if(a.type!==Function&&!a.skipFactory&&ie(l)){const{propsDefaults:u}=i;if(r in u)n=u[r];else{const c=_n(i);n=u[r]=l.call(null,e),c()}}else n=l;i.ce&&i.ce._setProp(r,n)}a[0]&&(s&&!o?n=!1:a[1]&&(n===""||n===sr(r))&&(n=!0))}return n}const nd=new WeakMap;function mu(t,e,r=!1){const n=r?nd:e.propsCache,i=n.get(t);if(i)return i;const s=t.props,a={},o=[];let l=!1;if(!ie(t)){const c=f=>{l=!0;const[d,m]=mu(f,e,!0);He(a,d),m&&o.push(...m)};!r&&e.mixins.length&&e.mixins.forEach(c),t.extends&&c(t.extends),t.mixins&&t.mixins.forEach(c)}if(!s&&!l)return Ce(t)&&n.set(t,Ir),Ir;if(re(s))for(let c=0;c<s.length;c++){const f=er(s[c]);Xa(f)&&(a[f]=ve)}else if(s)for(const c in s){const f=er(c);if(Xa(f)){const d=s[c],m=a[f]=re(d)||ie(d)?{type:d}:He({},d),h=m.type;let p=!1,g=!0;if(re(h))for(let y=0;y<h.length;++y){const v=h[y],S=ie(v)&&v.name;if(S==="Boolean"){p=!0;break}else S==="String"&&(g=!1)}else p=ie(h)&&h.name==="Boolean";m[0]=p,m[1]=g,(p||ce(m,"default"))&&o.push(f)}}const u=[a,o];return Ce(t)&&n.set(t,u),u}function Xa(t){return t[0]!=="$"&&!dn(t)}const ga=t=>t==="_"||t==="__"||t==="_ctx"||t==="$stable",ba=t=>re(t)?t.map(Pt):[Pt(t)],id=(t,e,r)=>{if(e._n)return e;const n=Rf((...i)=>ba(e(...i)),r);return n._c=!1,n},pu=(t,e,r)=>{const n=t._ctx;for(const i in t){if(ga(i))continue;const s=t[i];if(ie(s))e[i]=id(i,s,n);else if(s!=null){const a=ba(s);e[i]=()=>a}}},gu=(t,e)=>{const r=ba(e);t.slots.default=()=>r},bu=(t,e,r)=>{for(const n in e)(r||!ga(n))&&(t[n]=e[n])},sd=(t,e,r)=>{const n=t.slots=fu();if(t.vnode.shapeFlag&32){const i=e.__;i&&Gs(n,"__",i,!0);const s=e._;s?(bu(n,e,r),r&&Gs(n,"_",s,!0)):pu(e,n)}else e&&gu(t,e)},ad=(t,e,r)=>{const{vnode:n,slots:i}=t;let s=!0,a=ve;if(n.shapeFlag&32){const o=e._;o?r&&o===1?s=!1:bu(i,e,r):(s=!e.$stable,pu(e,i)),a=e}else e&&(gu(t,e),a={default:1});if(s)for(const o in i)!ga(o)&&a[o]==null&&delete i[o]},Ze=xd;function od(t){return ld(t)}function ld(t,e){const r=Ci();r.__VUE__=!0;const{insert:n,remove:i,patchProp:s,createElement:a,createText:o,createComment:l,setText:u,setElementText:c,parentNode:f,nextSibling:d,setScopeId:m=Et,insertStaticContent:h}=t,p=(x,T,I,V=null,L=null,H=null,W=void 0,j=null,z=!!T.dynamicChildren)=>{if(x===T)return;x&&!an(x,T)&&(V=Ee(x),J(x,L,H,!0),x=null),T.patchFlag===-2&&(z=!1,T.dynamicChildren=null);const{type:k,ref:Q,shapeFlag:q}=T;switch(k){case Ii:g(x,T,I,V);break;case zr:y(x,T,I,V);break;case ns:x==null&&v(T,I,V,W);break;case mt:F(x,T,I,V,L,H,W,j,z);break;default:q&1?P(x,T,I,V,L,H,W,j,z):q&6?U(x,T,I,V,L,H,W,j,z):(q&64||q&128)&&k.process(x,T,I,V,L,H,W,j,z,be)}Q!=null&&L?pn(Q,x&&x.ref,H,T||x,!T):Q==null&&x&&x.ref!=null&&pn(x.ref,null,H,x,!0)},g=(x,T,I,V)=>{if(x==null)n(T.el=o(T.children),I,V);else{const L=T.el=x.el;T.children!==x.children&&u(L,T.children)}},y=(x,T,I,V)=>{x==null?n(T.el=l(T.children||""),I,V):T.el=x.el},v=(x,T,I,V)=>{[x.el,x.anchor]=h(x.children,T,I,V,x.el,x.anchor)},S=({el:x,anchor:T},I,V)=>{let L;for(;x&&x!==T;)L=d(x),n(x,I,V),x=L;n(T,I,V)},b=({el:x,anchor:T})=>{let I;for(;x&&x!==T;)I=d(x),i(x),x=I;i(T)},P=(x,T,I,V,L,H,W,j,z)=>{T.type==="svg"?W="svg":T.type==="math"&&(W="mathml"),x==null?E(T,I,V,L,H,W,j,z):M(x,T,L,H,W,j,z)},E=(x,T,I,V,L,H,W,j)=>{let z,k;const{props:Q,shapeFlag:q,transition:Y,dirs:te}=x;if(z=x.el=a(x.type,H,Q&&Q.is,Q),q&8?c(z,x.children):q&16&&R(x.children,z,null,V,L,ts(x,H),W,j),te&&ur(x,null,V,"created"),A(z,x,x.scopeId,W,V),Q){for(const xe in Q)xe!=="value"&&!dn(xe)&&s(z,xe,null,Q[xe],H,V);"value"in Q&&s(z,"value",null,Q.value,H),(k=Q.onVnodeBeforeMount)&&Bt(k,V,x)}te&&ur(x,null,V,"beforeMount");const oe=ud(L,Y);oe&&Y.beforeEnter(z),n(z,T,I),((k=Q&&Q.onVnodeMounted)||oe||te)&&Ze(()=>{k&&Bt(k,V,x),oe&&Y.enter(z),te&&ur(x,null,V,"mounted")},L)},A=(x,T,I,V,L)=>{if(I&&m(x,I),V)for(let H=0;H<V.length;H++)m(x,V[H]);if(L){let H=L.subTree;if(T===H||Tu(H.type)&&(H.ssContent===T||H.ssFallback===T)){const W=L.vnode;A(x,W,W.scopeId,W.slotScopeIds,L.parent)}}},R=(x,T,I,V,L,H,W,j,z=0)=>{for(let k=z;k<x.length;k++){const Q=x[k]=j?Jt(x[k]):Pt(x[k]);p(null,Q,T,I,V,L,H,W,j)}},M=(x,T,I,V,L,H,W)=>{const j=T.el=x.el;let{patchFlag:z,dynamicChildren:k,dirs:Q}=T;z|=x.patchFlag&16;const q=x.props||ve,Y=T.props||ve;let te;if(I&&cr(I,!1),(te=Y.onVnodeBeforeUpdate)&&Bt(te,I,T,x),Q&&ur(T,x,I,"beforeUpdate"),I&&cr(I,!0),(q.innerHTML&&Y.innerHTML==null||q.textContent&&Y.textContent==null)&&c(j,""),k?G(x.dynamicChildren,k,j,I,V,ts(T,L),H):W||w(x,T,j,null,I,V,ts(T,L),H,!1),z>0){if(z&16)D(j,q,Y,I,L);else if(z&2&&q.class!==Y.class&&s(j,"class",null,Y.class,L),z&4&&s(j,"style",q.style,Y.style,L),z&8){const oe=T.dynamicProps;for(let xe=0;xe<oe.length;xe++){const me=oe[xe],je=q[me],We=Y[me];(We!==je||me==="value")&&s(j,me,je,We,L,I)}}z&1&&x.children!==T.children&&c(j,T.children)}else!W&&k==null&&D(j,q,Y,I,L);((te=Y.onVnodeUpdated)||Q)&&Ze(()=>{te&&Bt(te,I,T,x),Q&&ur(T,x,I,"updated")},V)},G=(x,T,I,V,L,H,W)=>{for(let j=0;j<T.length;j++){const z=x[j],k=T[j],Q=z.el&&(z.type===mt||!an(z,k)||z.shapeFlag&198)?f(z.el):I;p(z,k,Q,null,V,L,H,W,!0)}},D=(x,T,I,V,L)=>{if(T!==I){if(T!==ve)for(const H in T)!dn(H)&&!(H in I)&&s(x,H,T[H],null,L,V);for(const H in I){if(dn(H))continue;const W=I[H],j=T[H];W!==j&&H!=="value"&&s(x,H,j,W,L,V)}"value"in I&&s(x,"value",T.value,I.value,L)}},F=(x,T,I,V,L,H,W,j,z)=>{const k=T.el=x?x.el:o(""),Q=T.anchor=x?x.anchor:o("");let{patchFlag:q,dynamicChildren:Y,slotScopeIds:te}=T;te&&(j=j?j.concat(te):te),x==null?(n(k,I,V),n(Q,I,V),R(T.children||[],I,Q,L,H,W,j,z)):q>0&&q&64&&Y&&x.dynamicChildren?(G(x.dynamicChildren,Y,I,L,H,W,j),(T.key!=null||L&&T===L.subTree)&&yu(x,T,!0)):w(x,T,I,Q,L,H,W,j,z)},U=(x,T,I,V,L,H,W,j,z)=>{T.slotScopeIds=j,x==null?T.shapeFlag&512?L.ctx.activate(T,I,V,W,z):O(T,I,V,L,H,W,z):B(x,T,z)},O=(x,T,I,V,L,H,W)=>{const j=x.component=Ed(x,V,L);if(ru(x)&&(j.ctx.renderer=be),Rd(j,!1,W),j.asyncDep){if(L&&L.registerDep(j,N,W),!x.el){const z=j.subTree=Zt(zr);y(null,z,T,I),x.placeholder=z.el}}else N(j,x,T,I,L,H,W)},B=(x,T,I)=>{const V=T.component=x.component;if(yd(x,T,I))if(V.asyncDep&&!V.asyncResolved){_(V,T,I);return}else V.next=T,V.update();else T.el=x.el,V.vnode=T},N=(x,T,I,V,L,H,W)=>{const j=()=>{if(x.isMounted){let{next:q,bu:Y,u:te,parent:oe,vnode:xe}=x;{const vt=vu(x);if(vt){q&&(q.el=xe.el,_(x,q,W)),vt.asyncDep.then(()=>{x.isUnmounted||j()});return}}let me=q,je;cr(x,!1),q?(q.el=xe.el,_(x,q,W)):q=xe,Y&&Yi(Y),(je=q.props&&q.props.onVnodeBeforeUpdate)&&Bt(je,oe,q,xe),cr(x,!0);const We=$a(x),yt=x.subTree;x.subTree=We,p(yt,We,f(yt.el),Ee(yt),x,L,H),q.el=We.el,me===null&&vd(x,We.el),te&&Ze(te,L),(je=q.props&&q.props.onVnodeUpdated)&&Ze(()=>Bt(je,oe,q,xe),L)}else{let q;const{el:Y,props:te}=T,{bm:oe,m:xe,parent:me,root:je,type:We}=x,yt=gn(T);cr(x,!1),oe&&Yi(oe),!yt&&(q=te&&te.onVnodeBeforeMount)&&Bt(q,me,T),cr(x,!0);{je.ce&&je.ce._def.shadowRoot!==!1&&je.ce._injectChildStyle(We);const vt=x.subTree=$a(x);p(null,vt,I,V,x,L,H),T.el=vt.el}if(xe&&Ze(xe,L),!yt&&(q=te&&te.onVnodeMounted)){const vt=T;Ze(()=>Bt(q,me,vt),L)}(T.shapeFlag&256||me&&gn(me.vnode)&&me.vnode.shapeFlag&256)&&x.a&&Ze(x.a,L),x.isMounted=!0,T=I=V=null}};x.scope.on();const z=x.effect=new Ol(j);x.scope.off();const k=x.update=z.run.bind(z),Q=x.job=z.runIfDirty.bind(z);Q.i=x,Q.id=x.uid,z.scheduler=()=>ma(Q),cr(x,!0),k()},_=(x,T,I)=>{T.component=x;const V=x.vnode.props;x.vnode=T,x.next=null,rd(x,T.props,V,I),ad(x,T.children,I),Ht(),Wa(x),Vt()},w=(x,T,I,V,L,H,W,j,z=!1)=>{const k=x&&x.children,Q=x?x.shapeFlag:0,q=T.children,{patchFlag:Y,shapeFlag:te}=T;if(Y>0){if(Y&128){ee(k,q,I,V,L,H,W,j,z);return}else if(Y&256){K(k,q,I,V,L,H,W,j,z);return}}te&8?(Q&16&&Me(k,L,H),q!==k&&c(I,q)):Q&16?te&16?ee(k,q,I,V,L,H,W,j,z):Me(k,L,H,!0):(Q&8&&c(I,""),te&16&&R(q,I,V,L,H,W,j,z))},K=(x,T,I,V,L,H,W,j,z)=>{x=x||Ir,T=T||Ir;const k=x.length,Q=T.length,q=Math.min(k,Q);let Y;for(Y=0;Y<q;Y++){const te=T[Y]=z?Jt(T[Y]):Pt(T[Y]);p(x[Y],te,I,null,L,H,W,j,z)}k>Q?Me(x,L,H,!0,!1,q):R(T,I,V,L,H,W,j,z,q)},ee=(x,T,I,V,L,H,W,j,z)=>{let k=0;const Q=T.length;let q=x.length-1,Y=Q-1;for(;k<=q&&k<=Y;){const te=x[k],oe=T[k]=z?Jt(T[k]):Pt(T[k]);if(an(te,oe))p(te,oe,I,null,L,H,W,j,z);else break;k++}for(;k<=q&&k<=Y;){const te=x[q],oe=T[Y]=z?Jt(T[Y]):Pt(T[Y]);if(an(te,oe))p(te,oe,I,null,L,H,W,j,z);else break;q--,Y--}if(k>q){if(k<=Y){const te=Y+1,oe=te<Q?T[te].el:V;for(;k<=Y;)p(null,T[k]=z?Jt(T[k]):Pt(T[k]),I,oe,L,H,W,j,z),k++}}else if(k>Y)for(;k<=q;)J(x[k],L,H,!0),k++;else{const te=k,oe=k,xe=new Map;for(k=oe;k<=Y;k++){const Xe=T[k]=z?Jt(T[k]):Pt(T[k]);Xe.key!=null&&xe.set(Xe.key,k)}let me,je=0;const We=Y-oe+1;let yt=!1,vt=0;const nn=new Array(We);for(k=0;k<We;k++)nn[k]=0;for(k=te;k<=q;k++){const Xe=x[k];if(je>=We){J(Xe,L,H,!0);continue}let xt;if(Xe.key!=null)xt=xe.get(Xe.key);else for(me=oe;me<=Y;me++)if(nn[me-oe]===0&&an(Xe,T[me])){xt=me;break}xt===void 0?J(Xe,L,H,!0):(nn[xt-oe]=k+1,xt>=vt?vt=xt:yt=!0,p(Xe,T[xt],I,null,L,H,W,j,z),je++)}const Na=yt?cd(nn):Ir;for(me=Na.length-1,k=We-1;k>=0;k--){const Xe=oe+k,xt=T[Xe],Ha=T[Xe+1],Va=Xe+1<Q?Ha.el||Ha.placeholder:V;nn[k]===0?p(null,xt,I,Va,L,H,W,j,z):yt&&(me<0||k!==Na[me]?$(xt,I,Va,2):me--)}}},$=(x,T,I,V,L=null)=>{const{el:H,type:W,transition:j,children:z,shapeFlag:k}=x;if(k&6){$(x.component.subTree,T,I,V);return}if(k&128){x.suspense.move(T,I,V);return}if(k&64){W.move(x,T,I,be);return}if(W===mt){n(H,T,I);for(let q=0;q<z.length;q++)$(z[q],T,I,V);n(x.anchor,T,I);return}if(W===ns){S(x,T,I);return}if(V!==2&&k&1&&j)if(V===0)j.beforeEnter(H),n(H,T,I),Ze(()=>j.enter(H),L);else{const{leave:q,delayLeave:Y,afterLeave:te}=j,oe=()=>{x.ctx.isUnmounted?i(H):n(H,T,I)},xe=()=>{q(H,()=>{oe(),te&&te()})};Y?Y(H,oe,xe):xe()}else n(H,T,I)},J=(x,T,I,V=!1,L=!1)=>{const{type:H,props:W,ref:j,children:z,dynamicChildren:k,shapeFlag:Q,patchFlag:q,dirs:Y,cacheIndex:te}=x;if(q===-2&&(L=!1),j!=null&&(Ht(),pn(j,null,I,x,!0),Vt()),te!=null&&(T.renderCache[te]=void 0),Q&256){T.ctx.deactivate(x);return}const oe=Q&1&&Y,xe=!gn(x);let me;if(xe&&(me=W&&W.onVnodeBeforeUnmount)&&Bt(me,T,x),Q&6)le(x.component,I,V);else{if(Q&128){x.suspense.unmount(I,V);return}oe&&ur(x,null,T,"beforeUnmount"),Q&64?x.type.remove(x,T,I,be,V):k&&!k.hasOnce&&(H!==mt||q>0&&q&64)?Me(k,T,I,!1,!0):(H===mt&&q&384||!L&&Q&16)&&Me(z,T,I),V&&se(x)}(xe&&(me=W&&W.onVnodeUnmounted)||oe)&&Ze(()=>{me&&Bt(me,T,x),oe&&ur(x,null,T,"unmounted")},I)},se=x=>{const{type:T,el:I,anchor:V,transition:L}=x;if(T===mt){Te(I,V);return}if(T===ns){b(x);return}const H=()=>{i(I),L&&!L.persisted&&L.afterLeave&&L.afterLeave()};if(x.shapeFlag&1&&L&&!L.persisted){const{leave:W,delayLeave:j}=L,z=()=>W(I,H);j?j(x.el,H,z):z()}else H()},Te=(x,T)=>{let I;for(;x!==T;)I=d(x),i(x),x=I;i(T)},le=(x,T,I)=>{const{bum:V,scope:L,job:H,subTree:W,um:j,m:z,a:k,parent:Q,slots:{__:q}}=x;Qa(z),Qa(k),V&&Yi(V),Q&&re(q)&&q.forEach(Y=>{Q.renderCache[Y]=void 0}),L.stop(),H&&(H.flags|=8,J(W,x,T,I)),j&&Ze(j,T),Ze(()=>{x.isUnmounted=!0},T),T&&T.pendingBranch&&!T.isUnmounted&&x.asyncDep&&!x.asyncResolved&&x.suspenseId===T.pendingId&&(T.deps--,T.deps===0&&T.resolve())},Me=(x,T,I,V=!1,L=!1,H=0)=>{for(let W=H;W<x.length;W++)J(x[W],T,I,V,L)},Ee=x=>{if(x.shapeFlag&6)return Ee(x.component.subTree);if(x.shapeFlag&128)return x.suspense.next();const T=d(x.anchor||x.el),I=T&&T[If];return I?d(I):T};let Se=!1;const Ye=(x,T,I)=>{x==null?T._vnode&&J(T._vnode,null,null,!0):p(T._vnode||null,x,T,null,null,null,I),T._vnode=x,Se||(Se=!0,Wa(),Ql(),Se=!1)},be={p,um:J,m:$,r:se,mt:O,mc:R,pc:w,pbc:G,n:Ee,o:t};return{render:Ye,hydrate:void 0,createApp:Zf(Ye)}}function ts({type:t,props:e},r){return r==="svg"&&t==="foreignObject"||r==="mathml"&&t==="annotation-xml"&&e&&e.encoding&&e.encoding.includes("html")?void 0:r}function cr({effect:t,job:e},r){r?(t.flags|=32,e.flags|=4):(t.flags&=-33,e.flags&=-5)}function ud(t,e){return(!t||t&&!t.pendingBranch)&&e&&!e.persisted}function yu(t,e,r=!1){const n=t.children,i=e.children;if(re(n)&&re(i))for(let s=0;s<n.length;s++){const a=n[s];let o=i[s];o.shapeFlag&1&&!o.dynamicChildren&&((o.patchFlag<=0||o.patchFlag===32)&&(o=i[s]=Jt(i[s]),o.el=a.el),!r&&o.patchFlag!==-2&&yu(a,o)),o.type===Ii&&(o.el=a.el),o.type===zr&&!o.el&&(o.el=a.el)}}function cd(t){const e=t.slice(),r=[0];let n,i,s,a,o;const l=t.length;for(n=0;n<l;n++){const u=t[n];if(u!==0){if(i=r[r.length-1],t[i]<u){e[n]=i,r.push(n);continue}for(s=0,a=r.length-1;s<a;)o=s+a>>1,t[r[o]]<u?s=o+1:a=o;u<t[r[s]]&&(s>0&&(e[n]=r[s-1]),r[s]=n)}}for(s=r.length,a=r[s-1];s-- >0;)r[s]=a,a=e[a];return r}function vu(t){const e=t.subTree.component;if(e)return e.asyncDep&&!e.asyncResolved?e:vu(e)}function Qa(t){if(t)for(let e=0;e<t.length;e++)t[e].flags|=8}const fd=Symbol.for("v-scx"),dd=()=>Qn(fd);function rs(t,e,r){return xu(t,e,r)}function xu(t,e,r=ve){const{immediate:n,deep:i,flush:s,once:a}=r,o=He({},r),l=e&&n||!e&&s!=="post";let u;if(En){if(s==="sync"){const m=dd();u=m.__watcherHandles||(m.__watcherHandles=[])}else if(!l){const m=()=>{};return m.stop=Et,m.resume=Et,m.pause=Et,m}}const c=ze;o.call=(m,h,p)=>wt(m,c,h,p);let f=!1;s==="post"?o.scheduler=m=>{Ze(m,c&&c.suspense)}:s!=="sync"&&(f=!0,o.scheduler=(m,h)=>{h?m():ma(m)}),o.augmentJob=m=>{e&&(m.flags|=4),f&&(m.flags|=2,c&&(m.id=c.uid,m.i=c))};const d=Pf(t,e,o);return En&&(u?u.push(d):l&&d()),d}function hd(t,e,r){const n=this.proxy,i=Oe(t)?t.includes(".")?Bu(n,t):()=>n[t]:t.bind(n,n);let s;ie(e)?s=e:(s=e.handler,r=e);const a=_n(this),o=xu(i,s.bind(n),r);return a(),o}function Bu(t,e){const r=e.split(".");return()=>{let n=t;for(let i=0;i<r.length&&n;i++)n=n[r[i]];return n}}const md=(t,e)=>e==="modelValue"||e==="model-value"?t.modelModifiers:t[`${e}Modifiers`]||t[`${er(e)}Modifiers`]||t[`${sr(e)}Modifiers`];function pd(t,e,...r){if(t.isUnmounted)return;const n=t.vnode.props||ve;let i=r;const s=e.startsWith("update:"),a=s&&md(n,e.slice(7));a&&(a.trim&&(i=r.map(c=>Oe(c)?c.trim():c)),a.number&&(i=r.map(jc)));let o,l=n[o=Ji(e)]||n[o=Ji(er(e))];!l&&s&&(l=n[o=Ji(sr(e))]),l&&wt(l,t,6,i);const u=n[o+"Once"];if(u){if(!t.emitted)t.emitted={};else if(t.emitted[o])return;t.emitted[o]=!0,wt(u,t,6,i)}}function Au(t,e,r=!1){const n=e.emitsCache,i=n.get(t);if(i!==void 0)return i;const s=t.emits;let a={},o=!1;if(!ie(t)){const l=u=>{const c=Au(u,e,!0);c&&(o=!0,He(a,c))};!r&&e.mixins.length&&e.mixins.forEach(l),t.extends&&l(t.extends),t.mixins&&t.mixins.forEach(l)}return!s&&!o?(Ce(t)&&n.set(t,null),null):(re(s)?s.forEach(l=>a[l]=null):He(a,s),Ce(t)&&n.set(t,a),a)}function Oi(t,e){return!t||!Mi(e)?!1:(e=e.slice(2).replace(/Once$/,""),ce(t,e[0].toLowerCase()+e.slice(1))||ce(t,sr(e))||ce(t,e))}function $a(t){const{type:e,vnode:r,proxy:n,withProxy:i,propsOptions:[s],slots:a,attrs:o,emit:l,render:u,renderCache:c,props:f,data:d,setupState:m,ctx:h,inheritAttrs:p}=t,g=ui(t);let y,v;try{if(r.shapeFlag&4){const b=i||n,P=b;y=Pt(u.call(P,b,c,f,m,d,h)),v=o}else{const b=e;y=Pt(b.length>1?b(f,{attrs:o,slots:a,emit:l}):b(f,null)),v=e.props?o:gd(o)}}catch(b){yn.length=0,wi(b,t,1),y=Zt(zr)}let S=y;if(v&&p!==!1){const b=Object.keys(v),{shapeFlag:P}=S;b.length&&P&7&&(s&&b.some(na)&&(v=bd(v,s)),S=jr(S,v,!1,!0))}return r.dirs&&(S=jr(S,null,!1,!0),S.dirs=S.dirs?S.dirs.concat(r.dirs):r.dirs),r.transition&&pa(S,r.transition),y=S,ui(g),y}const gd=t=>{let e;for(const r in t)(r==="class"||r==="style"||Mi(r))&&((e||(e={}))[r]=t[r]);return e},bd=(t,e)=>{const r={};for(const n in t)(!na(n)||!(n.slice(9)in e))&&(r[n]=t[n]);return r};function yd(t,e,r){const{props:n,children:i,component:s}=t,{props:a,children:o,patchFlag:l}=e,u=s.emitsOptions;if(e.dirs||e.transition)return!0;if(r&&l>=0){if(l&1024)return!0;if(l&16)return n?Za(n,a,u):!!a;if(l&8){const c=e.dynamicProps;for(let f=0;f<c.length;f++){const d=c[f];if(a[d]!==n[d]&&!Oi(u,d))return!0}}}else return(i||o)&&(!o||!o.$stable)?!0:n===a?!1:n?a?Za(n,a,u):!0:!!a;return!1}function Za(t,e,r){const n=Object.keys(e);if(n.length!==Object.keys(t).length)return!0;for(let i=0;i<n.length;i++){const s=n[i];if(e[s]!==t[s]&&!Oi(r,s))return!0}return!1}function vd({vnode:t,parent:e},r){for(;e;){const n=e.subTree;if(n.suspense&&n.suspense.activeBranch===t&&(n.el=t.el),n===t)(t=e.vnode).el=r,e=e.parent;else break}}const Tu=t=>t.__isSuspense;function xd(t,e){e&&e.pendingBranch?re(t)?e.effects.push(...t):e.effects.push(t):wf(t)}const mt=Symbol.for("v-fgt"),Ii=Symbol.for("v-txt"),zr=Symbol.for("v-cmt"),ns=Symbol.for("v-stc"),yn=[];let rt=null;function Lr(t=!1){yn.push(rt=t?null:[])}function Bd(){yn.pop(),rt=yn[yn.length-1]||null}let Cn=1;function eo(t,e=!1){Cn+=t,t<0&&rt&&e&&(rt.hasOnce=!0)}function Ad(t){return t.dynamicChildren=Cn>0?rt||Ir:null,Bd(),Cn>0&&rt&&rt.push(t),t}function Nr(t,e,r,n,i,s){return Ad(_e(t,e,r,n,i,s,!0))}function Mu(t){return t?t.__v_isVNode===!0:!1}function an(t,e){return t.type===e.type&&t.key===e.key}const Su=({key:t})=>t??null,$n=({ref:t,ref_key:e,ref_for:r})=>(typeof t=="number"&&(t=""+t),t!=null?Oe(t)||Ne(t)||ie(t)?{i:ot,r:t,k:e,f:!!r}:t:null);function _e(t,e=null,r=null,n=0,i=null,s=t===mt?0:1,a=!1,o=!1){const l={__v_isVNode:!0,__v_skip:!0,type:t,props:e,key:e&&Su(e),ref:e&&$n(e),scopeId:Zl,slotScopeIds:null,children:r,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:s,patchFlag:n,dynamicProps:i,dynamicChildren:null,appContext:null,ctx:ot};return o?(ya(l,r),s&128&&t.normalize(l)):r&&(l.shapeFlag|=Oe(r)?8:16),Cn>0&&!a&&rt&&(l.patchFlag>0||s&6)&&l.patchFlag!==32&&rt.push(l),l}const Zt=Td;function Td(t,e=null,r=null,n=0,i=null,s=!1){if((!t||t===Wf)&&(t=zr),Mu(t)){const o=jr(t,e,!0);return r&&ya(o,r),Cn>0&&!s&&rt&&(o.shapeFlag&6?rt[rt.indexOf(t)]=o:rt.push(o)),o.patchFlag=-2,o}if(_d(t)&&(t=t.__vccOpts),e){e=Md(e);let{class:o,style:l}=e;o&&!Oe(o)&&(e.class=Tn(o)),Ce(l)&&(ha(l)&&!re(l)&&(l=He({},l)),e.style=kr(l))}const a=Oe(t)?1:Tu(t)?128:Gf(t)?64:Ce(t)?4:ie(t)?2:0;return _e(t,e,r,n,i,a,s,!0)}function Md(t){return t?ha(t)||du(t)?He({},t):t:null}function jr(t,e,r=!1,n=!1){const{props:i,ref:s,patchFlag:a,children:o,transition:l}=t,u=e?Sd(i||{},e):i,c={__v_isVNode:!0,__v_skip:!0,type:t.type,props:u,key:u&&Su(u),ref:e&&e.ref?r&&s?re(s)?s.concat($n(e)):[s,$n(e)]:$n(e):s,scopeId:t.scopeId,slotScopeIds:t.slotScopeIds,children:o,target:t.target,targetStart:t.targetStart,targetAnchor:t.targetAnchor,staticCount:t.staticCount,shapeFlag:t.shapeFlag,patchFlag:e&&t.type!==mt?a===-1?16:a|16:a,dynamicProps:t.dynamicProps,dynamicChildren:t.dynamicChildren,appContext:t.appContext,dirs:t.dirs,transition:l,component:t.component,suspense:t.suspense,ssContent:t.ssContent&&jr(t.ssContent),ssFallback:t.ssFallback&&jr(t.ssFallback),placeholder:t.placeholder,el:t.el,anchor:t.anchor,ctx:t.ctx,ce:t.ce};return l&&n&&pa(c,l.clone(c)),c}function Pu(t=" ",e=0){return Zt(Ii,null,t,e)}function Pt(t){return t==null||typeof t=="boolean"?Zt(zr):re(t)?Zt(mt,null,t.slice()):Mu(t)?Jt(t):Zt(Ii,null,String(t))}function Jt(t){return t.el===null&&t.patchFlag!==-1||t.memo?t:jr(t)}function ya(t,e){let r=0;const{shapeFlag:n}=t;if(e==null)e=null;else if(re(e))r=16;else if(typeof e=="object")if(n&65){const i=e.default;i&&(i._c&&(i._d=!1),ya(t,i()),i._c&&(i._d=!0));return}else{r=32;const i=e._;!i&&!du(e)?e._ctx=ot:i===3&&ot&&(ot.slots._===1?e._=1:(e._=2,t.patchFlag|=1024))}else ie(e)?(e={default:e,_ctx:ot},r=32):(e=String(e),n&64?(r=16,e=[Pu(e)]):r=8);t.children=e,t.shapeFlag|=r}function Sd(...t){const e={};for(let r=0;r<t.length;r++){const n=t[r];for(const i in n)if(i==="class")e.class!==n.class&&(e.class=Tn([e.class,n.class]));else if(i==="style")e.style=kr([e.style,n.style]);else if(Mi(i)){const s=e[i],a=n[i];a&&s!==a&&!(re(s)&&s.includes(a))&&(e[i]=s?[].concat(s,a):a)}else i!==""&&(e[i]=n[i])}return e}function Bt(t,e,r,n=null){wt(t,e,7,[r,n])}const Pd=uu();let Cd=0;function Ed(t,e,r){const n=t.type,i=(e?e.appContext:t.appContext)||Pd,s={uid:Cd++,vnode:t,type:n,parent:e,appContext:i,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new Qc(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(i.provides),ids:e?e.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:mu(n,i),emitsOptions:Au(n,i),emit:null,emitted:null,propsDefaults:ve,inheritAttrs:n.inheritAttrs,ctx:ve,data:ve,props:ve,attrs:ve,slots:ve,refs:ve,setupState:ve,setupContext:null,suspense:r,suspenseId:r?r.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return s.ctx={_:s},s.root=e?e.root:s,s.emit=pd.bind(null,s),t.ce&&t.ce(s),s}let ze=null;const wd=()=>ze||ot;let fi,ks;{const t=Ci(),e=(r,n)=>{let i;return(i=t[r])||(i=t[r]=[]),i.push(n),s=>{i.length>1?i.forEach(a=>a(s)):i[0](s)}};fi=e("__VUE_INSTANCE_SETTERS__",r=>ze=r),ks=e("__VUE_SSR_SETTERS__",r=>En=r)}const _n=t=>{const e=ze;return fi(t),t.scope.on(),()=>{t.scope.off(),fi(e)}},to=()=>{ze&&ze.scope.off(),fi(null)};function Cu(t){return t.vnode.shapeFlag&4}let En=!1;function Rd(t,e=!1,r=!1){e&&ks(e);const{props:n,children:i}=t.vnode,s=Cu(t);td(t,n,s,e),sd(t,i,r||e);const a=s?Od(t,e):void 0;return e&&ks(!1),a}function Od(t,e){const r=t.type;t.accessCache=Object.create(null),t.proxy=new Proxy(t.ctx,qf);const{setup:n}=r;if(n){Ht();const i=t.setupContext=n.length>1?Gd(t):null,s=_n(t),a=Gn(n,t,0,[t.props,i]),o=Ml(a);if(Vt(),s(),(o||t.sp)&&!gn(t)&&tu(t),o){if(a.then(to,to),e)return a.then(l=>{ro(t,l)}).catch(l=>{wi(l,t,0)});t.asyncDep=a}else ro(t,a)}else Eu(t)}function ro(t,e,r){ie(e)?t.type.__ssrInlineRender?t.ssrRender=e:t.render=e:Ce(e)&&(t.setupState=Kl(e)),Eu(t)}function Eu(t,e,r){const n=t.type;t.render||(t.render=n.render||Et);{const i=_n(t);Ht();try{Kf(t)}finally{Vt(),i()}}}const Id={get(t,e){return Le(t,"get",""),t[e]}};function Gd(t){const e=r=>{t.exposed=r||{}};return{attrs:new Proxy(t.attrs,Id),slots:t.slots,emit:t.emit,expose:e}}function Gi(t){return t.exposed?t.exposeProxy||(t.exposeProxy=new Proxy(Kl(vf(t.exposed)),{get(e,r){if(r in e)return e[r];if(r in bn)return bn[r](t)},has(e,r){return r in e||r in bn}})):t.proxy}function _d(t){return ie(t)&&"__vccOpts"in t}const wn=(t,e)=>Mf(t,e,En),Ud="3.5.18";/**
* @vue/runtime-dom v3.5.18
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let zs;const no=typeof window<"u"&&window.trustedTypes;if(no)try{zs=no.createPolicy("vue",{createHTML:t=>t})}catch{}const wu=zs?t=>zs.createHTML(t):t=>t,Dd="http://www.w3.org/2000/svg",Fd="http://www.w3.org/1998/Math/MathML",_t=typeof document<"u"?document:null,io=_t&&_t.createElement("template"),Ld={insert:(t,e,r)=>{e.insertBefore(t,r||null)},remove:t=>{const e=t.parentNode;e&&e.removeChild(t)},createElement:(t,e,r,n)=>{const i=e==="svg"?_t.createElementNS(Dd,t):e==="mathml"?_t.createElementNS(Fd,t):r?_t.createElement(t,{is:r}):_t.createElement(t);return t==="select"&&n&&n.multiple!=null&&i.setAttribute("multiple",n.multiple),i},createText:t=>_t.createTextNode(t),createComment:t=>_t.createComment(t),setText:(t,e)=>{t.nodeValue=e},setElementText:(t,e)=>{t.textContent=e},parentNode:t=>t.parentNode,nextSibling:t=>t.nextSibling,querySelector:t=>_t.querySelector(t),setScopeId(t,e){t.setAttribute(e,"")},insertStaticContent(t,e,r,n,i,s){const a=r?r.previousSibling:e.lastChild;if(i&&(i===s||i.nextSibling))for(;e.insertBefore(i.cloneNode(!0),r),!(i===s||!(i=i.nextSibling)););else{io.innerHTML=wu(n==="svg"?`<svg>${t}</svg>`:n==="mathml"?`<math>${t}</math>`:t);const o=io.content;if(n==="svg"||n==="mathml"){const l=o.firstChild;for(;l.firstChild;)o.appendChild(l.firstChild);o.removeChild(l)}e.insertBefore(o,r)}return[a?a.nextSibling:e.firstChild,r?r.previousSibling:e.lastChild]}},Nd=Symbol("_vtc");function Hd(t,e,r){const n=t[Nd];n&&(e=(e?[e,...n]:[...n]).join(" ")),e==null?t.removeAttribute("class"):r?t.setAttribute("class",e):t.className=e}const di=Symbol("_vod"),Ru=Symbol("_vsh"),Vd={beforeMount(t,{value:e},{transition:r}){t[di]=t.style.display==="none"?"":t.style.display,r&&e?r.beforeEnter(t):on(t,e)},mounted(t,{value:e},{transition:r}){r&&e&&r.enter(t)},updated(t,{value:e,oldValue:r},{transition:n}){!e!=!r&&(n?e?(n.beforeEnter(t),on(t,!0),n.enter(t)):n.leave(t,()=>{on(t,!1)}):on(t,e))},beforeUnmount(t,{value:e}){on(t,e)}};function on(t,e){t.style.display=e?t[di]:"none",t[Ru]=!e}const kd=Symbol(""),zd=/(^|;)\s*display\s*:/;function jd(t,e,r){const n=t.style,i=Oe(r);let s=!1;if(r&&!i){if(e)if(Oe(e))for(const a of e.split(";")){const o=a.slice(0,a.indexOf(":")).trim();r[o]==null&&Zn(n,o,"")}else for(const a in e)r[a]==null&&Zn(n,a,"");for(const a in r)a==="display"&&(s=!0),Zn(n,a,r[a])}else if(i){if(e!==r){const a=n[kd];a&&(r+=";"+a),n.cssText=r,s=zd.test(r)}}else e&&t.removeAttribute("style");di in t&&(t[di]=s?n.display:"",t[Ru]&&(n.display="none"))}const so=/\s*!important$/;function Zn(t,e,r){if(re(r))r.forEach(n=>Zn(t,e,n));else if(r==null&&(r=""),e.startsWith("--"))t.setProperty(e,r);else{const n=Wd(t,e);so.test(r)?t.setProperty(sr(n),r.replace(so,""),"important"):t[n]=r}}const ao=["Webkit","Moz","ms"],is={};function Wd(t,e){const r=is[e];if(r)return r;let n=er(e);if(n!=="filter"&&n in t)return is[e]=n;n=Cl(n);for(let i=0;i<ao.length;i++){const s=ao[i]+n;if(s in t)return is[e]=s}return e}const oo="http://www.w3.org/1999/xlink";function lo(t,e,r,n,i,s=Xc(e)){n&&e.startsWith("xlink:")?r==null?t.removeAttributeNS(oo,e.slice(6,e.length)):t.setAttributeNS(oo,e,r):r==null||s&&!El(r)?t.removeAttribute(e):t.setAttribute(e,s?"":ir(r)?String(r):r)}function uo(t,e,r,n,i){if(e==="innerHTML"||e==="textContent"){r!=null&&(t[e]=e==="innerHTML"?wu(r):r);return}const s=t.tagName;if(e==="value"&&s!=="PROGRESS"&&!s.includes("-")){const o=s==="OPTION"?t.getAttribute("value")||"":t.value,l=r==null?t.type==="checkbox"?"on":"":String(r);(o!==l||!("_value"in t))&&(t.value=l),r==null&&t.removeAttribute(e),t._value=r;return}let a=!1;if(r===""||r==null){const o=typeof t[e];o==="boolean"?r=El(r):r==null&&o==="string"?(r="",a=!0):o==="number"&&(r=0,a=!0)}try{t[e]=r}catch{}a&&t.removeAttribute(i||e)}function qd(t,e,r,n){t.addEventListener(e,r,n)}function Kd(t,e,r,n){t.removeEventListener(e,r,n)}const co=Symbol("_vei");function Jd(t,e,r,n,i=null){const s=t[co]||(t[co]={}),a=s[e];if(n&&a)a.value=n;else{const[o,l]=Yd(e);if(n){const u=s[e]=$d(n,i);qd(t,o,u,l)}else a&&(Kd(t,o,a,l),s[e]=void 0)}}const fo=/(?:Once|Passive|Capture)$/;function Yd(t){let e;if(fo.test(t)){e={};let n;for(;n=t.match(fo);)t=t.slice(0,t.length-n[0].length),e[n[0].toLowerCase()]=!0}return[t[2]===":"?t.slice(3):sr(t.slice(2)),e]}let ss=0;const Xd=Promise.resolve(),Qd=()=>ss||(Xd.then(()=>ss=0),ss=Date.now());function $d(t,e){const r=n=>{if(!n._vts)n._vts=Date.now();else if(n._vts<=r.attached)return;wt(Zd(n,r.value),e,5,[n])};return r.value=t,r.attached=Qd(),r}function Zd(t,e){if(re(e)){const r=t.stopImmediatePropagation;return t.stopImmediatePropagation=()=>{r.call(t),t._stopped=!0},e.map(n=>i=>!i._stopped&&n&&n(i))}else return e}const ho=t=>t.charCodeAt(0)===111&&t.charCodeAt(1)===110&&t.charCodeAt(2)>96&&t.charCodeAt(2)<123,eh=(t,e,r,n,i,s)=>{const a=i==="svg";e==="class"?Hd(t,n,a):e==="style"?jd(t,r,n):Mi(e)?na(e)||Jd(t,e,r,n,s):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):th(t,e,n,a))?(uo(t,e,n),!t.tagName.includes("-")&&(e==="value"||e==="checked"||e==="selected")&&lo(t,e,n,a,s,e!=="value")):t._isVueCE&&(/[A-Z]/.test(e)||!Oe(n))?uo(t,er(e),n,s,e):(e==="true-value"?t._trueValue=n:e==="false-value"&&(t._falseValue=n),lo(t,e,n,a))};function th(t,e,r,n){if(n)return!!(e==="innerHTML"||e==="textContent"||e in t&&ho(e)&&ie(r));if(e==="spellcheck"||e==="draggable"||e==="translate"||e==="autocorrect"||e==="form"||e==="list"&&t.tagName==="INPUT"||e==="type"&&t.tagName==="TEXTAREA")return!1;if(e==="width"||e==="height"){const i=t.tagName;if(i==="IMG"||i==="VIDEO"||i==="CANVAS"||i==="SOURCE")return!1}return ho(e)&&Oe(r)?!1:e in t}const rh=["ctrl","shift","alt","meta"],nh={stop:t=>t.stopPropagation(),prevent:t=>t.preventDefault(),self:t=>t.target!==t.currentTarget,ctrl:t=>!t.ctrlKey,shift:t=>!t.shiftKey,alt:t=>!t.altKey,meta:t=>!t.metaKey,left:t=>"button"in t&&t.button!==0,middle:t=>"button"in t&&t.button!==1,right:t=>"button"in t&&t.button!==2,exact:(t,e)=>rh.some(r=>t[`${r}Key`]&&!e.includes(r))},mo=(t,e)=>{const r=t._withMods||(t._withMods={}),n=e.join(".");return r[n]||(r[n]=(i,...s)=>{for(let a=0;a<e.length;a++){const o=nh[e[a]];if(o&&o(i,e))return}return t(i,...s)})},ih={esc:"escape",space:" ",up:"arrow-up",left:"arrow-left",right:"arrow-right",down:"arrow-down",delete:"backspace"},po=(t,e)=>{const r=t._withKeys||(t._withKeys={}),n=e.join(".");return r[n]||(r[n]=i=>{if(!("key"in i))return;const s=sr(i.key);if(e.some(a=>a===s||ih[a]===s))return t(i)})},sh=He({patchProp:eh},Ld);let go;function ah(){return go||(go=od(sh))}const oh=(...t)=>{const e=ah().createApp(...t),{mount:r}=e;return e.mount=n=>{const i=uh(n);if(!i)return;const s=e._component;!ie(s)&&!s.render&&!s.template&&(s.template=i.innerHTML),i.nodeType===1&&(i.textContent="");const a=r(i,!1,lh(i));return i instanceof Element&&(i.removeAttribute("v-cloak"),i.setAttribute("data-v-app","")),a},e};function lh(t){if(t instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&t instanceof MathMLElement)return"mathml"}function uh(t){return Oe(t)?document.querySelector(t):t}const ch="/projects/webGPU-Basics-Collections/assets/expand-yilVOYUy.png",pt=16;function pe({name:t="default",albedo:e=[1,1,1],roughness:r=.98,metalness:n=0,usePerlinRoughness:i=!1,usePerlinMetalness:s=!1,perlinFreq:a=2,useAlbedoTexture:o=!1,useMetalnessTexture:l=!1,useRoughnessTexture:u=!1,useNormalTexture:c=!1,textureIndex:f=-1}){return{name:t,albedo:e,roughness:r,usePerlinRoughness:i,metalness:n,usePerlinMetalness:s,perlinFreq:a,useAlbedoTexture:o,useMetalnessTexture:l,useRoughnessTexture:u,useNormalTexture:c,textureIndex:f}}function Un(t){const e=new Array(pt),r=new Float32Array(e);return r.set(t.albedo,0),r[3]=t.metalness,r[4]=t.usePerlinMetalness?1:0,r[5]=t.roughness,r[6]=t.usePerlinRoughness?1:0,r[7]=t.perlinFreq,r[8]=t.useAlbedoTexture?1:0,r[9]=t.useMetalnessTexture?1:0,r[10]=t.useRoughnessTexture?1:0,r[11]=t.useNormalTexture?1:0,r[12]=t.textureIndex,r}function _i(t){const e=[];for(const r of t)e.push(...r.albedo),e.push(r.metalness),e.push(r.usePerlinMetalness?1:0),e.push(r.roughness),e.push(r.usePerlinRoughness?1:0),e.push(r.perlinFreq),e.push(r.useAlbedoTexture?1:0),e.push(r.useMetalnessTexture?1:0),e.push(r.useRoughnessTexture?1:0),e.push(r.useNormalTexture?1:0),e.push(r.textureIndex),e.push(0),e.push(0),e.push(0);return new Float32Array(e)}var fh=1e-6,Re=typeof Float32Array<"u"?Float32Array:Array,dh="zyx";function cn(){var t=new Re(4);return Re!=Float32Array&&(t[1]=0,t[2]=0),t[0]=1,t[3]=1,t}function hi(t,e,r,n){var i=new Re(4);return i[0]=t,i[1]=e,i[2]=r,i[3]=n,i}function ei(t,e){if(t===e){var r=e[1];t[1]=e[2],t[2]=r}else t[0]=e[0],t[1]=e[2],t[2]=e[1],t[3]=e[3];return t}function hh(t,e,r){var n=e[0],i=e[1],s=e[2],a=e[3],o=r[0],l=r[1],u=r[2],c=r[3];return t[0]=n*o+s*l,t[1]=i*o+a*l,t[2]=n*u+s*c,t[3]=i*u+a*c,t}function Qt(){var t=new Re(9);return Re!=Float32Array&&(t[1]=0,t[2]=0,t[3]=0,t[5]=0,t[6]=0,t[7]=0),t[0]=1,t[4]=1,t[8]=1,t}function mh(t,e){return t[0]=e[0],t[1]=e[1],t[2]=e[2],t[3]=e[4],t[4]=e[5],t[5]=e[6],t[6]=e[8],t[7]=e[9],t[8]=e[10],t}function js(t,e,r,n,i,s,a,o,l){var u=new Re(9);return u[0]=t,u[1]=e,u[2]=r,u[3]=n,u[4]=i,u[5]=s,u[6]=a,u[7]=o,u[8]=l,u}function as(t,e){var r=e[0],n=e[1],i=e[2],s=e[3],a=e[4],o=e[5],l=e[6],u=e[7],c=e[8],f=e[9],d=e[10],m=e[11],h=e[12],p=e[13],g=e[14],y=e[15],v=r*o-n*a,S=r*l-i*a,b=r*u-s*a,P=n*l-i*o,E=n*u-s*o,A=i*u-s*l,R=c*p-f*h,M=c*g-d*h,G=c*y-m*h,D=f*g-d*p,F=f*y-m*p,U=d*y-m*g,O=v*U-S*F+b*D+P*G-E*M+A*R;return O?(O=1/O,t[0]=(o*U-l*F+u*D)*O,t[1]=(l*G-a*U-u*M)*O,t[2]=(a*F-o*G+u*R)*O,t[3]=(i*F-n*U-s*D)*O,t[4]=(r*U-i*G+s*M)*O,t[5]=(n*G-r*F-s*R)*O,t[6]=(p*A-g*E+y*P)*O,t[7]=(g*b-h*A-y*S)*O,t[8]=(h*E-p*b+y*v)*O,t):null}function bo(t,e,r){return t[0]=e[0]+r[0],t[1]=e[1]+r[1],t[2]=e[2]+r[2],t[3]=e[3]+r[3],t[4]=e[4]+r[4],t[5]=e[5]+r[5],t[6]=e[6]+r[6],t[7]=e[7]+r[7],t[8]=e[8]+r[8],t}function yo(t,e,r){return t[0]=e[0]*r,t[1]=e[1]*r,t[2]=e[2]*r,t[3]=e[3]*r,t[4]=e[4]*r,t[5]=e[5]*r,t[6]=e[6]*r,t[7]=e[7]*r,t[8]=e[8]*r,t}function mr(){var t=new Re(16);return Re!=Float32Array&&(t[1]=0,t[2]=0,t[3]=0,t[4]=0,t[6]=0,t[7]=0,t[8]=0,t[9]=0,t[11]=0,t[12]=0,t[13]=0,t[14]=0),t[0]=1,t[5]=1,t[10]=1,t[15]=1,t}function Ou(t){return t[0]=1,t[1]=0,t[2]=0,t[3]=0,t[4]=0,t[5]=1,t[6]=0,t[7]=0,t[8]=0,t[9]=0,t[10]=1,t[11]=0,t[12]=0,t[13]=0,t[14]=0,t[15]=1,t}function ph(t,e){var r=e[0],n=e[1],i=e[2],s=e[3],a=e[4],o=e[5],l=e[6],u=e[7],c=e[8],f=e[9],d=e[10],m=e[11],h=e[12],p=e[13],g=e[14],y=e[15],v=r*o-n*a,S=r*l-i*a,b=r*u-s*a,P=n*l-i*o,E=n*u-s*o,A=i*u-s*l,R=c*p-f*h,M=c*g-d*h,G=c*y-m*h,D=f*g-d*p,F=f*y-m*p,U=d*y-m*g,O=v*U-S*F+b*D+P*G-E*M+A*R;return O?(O=1/O,t[0]=(o*U-l*F+u*D)*O,t[1]=(i*F-n*U-s*D)*O,t[2]=(p*A-g*E+y*P)*O,t[3]=(d*E-f*A-m*P)*O,t[4]=(l*G-a*U-u*M)*O,t[5]=(r*U-i*G+s*M)*O,t[6]=(g*b-h*A-y*S)*O,t[7]=(c*A-d*b+m*S)*O,t[8]=(a*F-o*G+u*R)*O,t[9]=(n*G-r*F-s*R)*O,t[10]=(h*E-p*b+y*v)*O,t[11]=(f*b-c*E-m*v)*O,t[12]=(o*M-a*D-l*R)*O,t[13]=(r*D-n*M+i*R)*O,t[14]=(p*S-h*P-g*v)*O,t[15]=(c*P-f*S+d*v)*O,t):null}function gh(t,e,r,n){var i=e[0],s=e[1],a=e[2],o=e[3],l=i+i,u=s+s,c=a+a,f=i*l,d=i*u,m=i*c,h=s*u,p=s*c,g=a*c,y=o*l,v=o*u,S=o*c,b=n[0],P=n[1],E=n[2];return t[0]=(1-(h+g))*b,t[1]=(d+S)*b,t[2]=(m-v)*b,t[3]=0,t[4]=(d-S)*P,t[5]=(1-(f+g))*P,t[6]=(p+y)*P,t[7]=0,t[8]=(m+v)*E,t[9]=(p-y)*E,t[10]=(1-(f+h))*E,t[11]=0,t[12]=r[0],t[13]=r[1],t[14]=r[2],t[15]=1,t}function ae(){var t=new Re(3);return Re!=Float32Array&&(t[0]=0,t[1]=0,t[2]=0),t}function bh(t){var e=new Re(3);return e[0]=t[0],e[1]=t[1],e[2]=t[2],e}function ti(t){var e=t[0],r=t[1],n=t[2];return Math.sqrt(e*e+r*r+n*n)}function C(t,e,r){var n=new Re(3);return n[0]=t,n[1]=e,n[2]=r,n}function Yt(t,e,r){return t[0]=e[0]+r[0],t[1]=e[1]+r[1],t[2]=e[2]+r[2],t}function Ws(t,e,r){return t[0]=e[0]-r[0],t[1]=e[1]-r[1],t[2]=e[2]-r[2],t}function Wt(t,e,r){return t[0]=e[0]*r,t[1]=e[1]*r,t[2]=e[2]*r,t}function Rn(t,e){var r=e[0],n=e[1],i=e[2],s=r*r+n*n+i*i;return s>0&&(s=1/Math.sqrt(s)),t[0]=e[0]*s,t[1]=e[1]*s,t[2]=e[2]*s,t}function pr(t,e){return t[0]*e[0]+t[1]*e[1]+t[2]*e[2]}function ri(t,e,r){var n=e[0],i=e[1],s=e[2],a=r[0],o=r[1],l=r[2];return t[0]=i*l-s*o,t[1]=s*a-n*l,t[2]=n*o-i*a,t}function os(t,e,r){var n=e[0],i=e[1],s=e[2],a=r[3]*n+r[7]*i+r[11]*s+r[15];return a=a||1,t[0]=(r[0]*n+r[4]*i+r[8]*s+r[12])/a,t[1]=(r[1]*n+r[5]*i+r[9]*s+r[13])/a,t[2]=(r[2]*n+r[6]*i+r[10]*s+r[14])/a,t}function Hr(t,e,r){var n=e[0],i=e[1],s=e[2];return t[0]=n*r[0]+i*r[3]+s*r[6],t[1]=n*r[1]+i*r[4]+s*r[7],t[2]=n*r[2]+i*r[5]+s*r[8],t}var Rr=Ws,yh=ti;(function(){var t=ae();return function(e,r,n,i,s,a){var o,l;for(r||(r=3),n||(n=0),i?l=Math.min(i*r+n,e.length):l=e.length,o=n;o<l;o+=r)t[0]=e[o],t[1]=e[o+1],t[2]=e[o+2],s(t,t,a),e[o]=t[0],e[o+1]=t[1],e[o+2]=t[2];return e}})();function vh(){var t=new Re(4);return Re!=Float32Array&&(t[0]=0,t[1]=0,t[2]=0,t[3]=0),t}function xh(t,e,r,n){var i=new Re(4);return i[0]=t,i[1]=e,i[2]=r,i[3]=n,i}function Bh(t,e){var r=e[0],n=e[1],i=e[2],s=e[3],a=r*r+n*n+i*i+s*s;return a>0&&(a=1/Math.sqrt(a)),t[0]=r*a,t[1]=n*a,t[2]=i*a,t[3]=s*a,t}(function(){var t=vh();return function(e,r,n,i,s,a){var o,l;for(r||(r=4),n||(n=0),i?l=Math.min(i*r+n,e.length):l=e.length,o=n;o<l;o+=r)t[0]=e[o],t[1]=e[o+1],t[2]=e[o+2],t[3]=e[o+3],s(t,t,a),e[o]=t[0],e[o+1]=t[1],e[o+2]=t[2],e[o+3]=t[3];return e}})();function Lt(){var t=new Re(4);return Re!=Float32Array&&(t[0]=0,t[1]=0,t[2]=0),t[3]=1,t}function Ah(t,e,r){r=r*.5;var n=Math.sin(r);return t[0]=n*e[0],t[1]=n*e[1],t[2]=n*e[2],t[3]=Math.cos(r),t}function Th(t,e,r){var n=e[0],i=e[1],s=e[2],a=e[3],o=r[0],l=r[1],u=r[2],c=r[3];return t[0]=n*c+a*o+i*u-s*l,t[1]=i*c+a*l+s*o-n*u,t[2]=s*c+a*u+n*l-i*o,t[3]=a*c-n*o-i*l-s*u,t}function ls(t,e,r,n){var i=e[0],s=e[1],a=e[2],o=e[3],l=r[0],u=r[1],c=r[2],f=r[3],d,m,h,p,g;return m=i*l+s*u+a*c+o*f,m<0&&(m=-m,l=-l,u=-u,c=-c,f=-f),1-m>fh?(d=Math.acos(m),h=Math.sin(d),p=Math.sin((1-n)*d)/h,g=Math.sin(n*d)/h):(p=1-n,g=n),t[0]=p*i+g*l,t[1]=p*s+g*u,t[2]=p*a+g*c,t[3]=p*o+g*f,t}function Mh(t,e){var r=e[0]+e[4]+e[8],n;if(r>0)n=Math.sqrt(r+1),t[3]=.5*n,n=.5/n,t[0]=(e[5]-e[7])*n,t[1]=(e[6]-e[2])*n,t[2]=(e[1]-e[3])*n;else{var i=0;e[4]>e[0]&&(i=1),e[8]>e[i*3+i]&&(i=2);var s=(i+1)%3,a=(i+2)%3;n=Math.sqrt(e[i*3+i]-e[s*3+s]-e[a*3+a]+1),t[i]=.5*n,n=.5/n,t[3]=(e[s*3+a]-e[a*3+s])*n,t[s]=(e[s*3+i]+e[i*3+s])*n,t[a]=(e[a*3+i]+e[i*3+a])*n}return t}function Or(t,e,r,n){var i=arguments.length>4&&arguments[4]!==void 0?arguments[4]:dh,s=Math.PI/360;e*=s,n*=s,r*=s;var a=Math.sin(e),o=Math.cos(e),l=Math.sin(r),u=Math.cos(r),c=Math.sin(n),f=Math.cos(n);switch(i){case"xyz":t[0]=a*u*f+o*l*c,t[1]=o*l*f-a*u*c,t[2]=o*u*c+a*l*f,t[3]=o*u*f-a*l*c;break;case"xzy":t[0]=a*u*f-o*l*c,t[1]=o*l*f-a*u*c,t[2]=o*u*c+a*l*f,t[3]=o*u*f+a*l*c;break;case"yxz":t[0]=a*u*f+o*l*c,t[1]=o*l*f-a*u*c,t[2]=o*u*c-a*l*f,t[3]=o*u*f+a*l*c;break;case"yzx":t[0]=a*u*f+o*l*c,t[1]=o*l*f+a*u*c,t[2]=o*u*c-a*l*f,t[3]=o*u*f-a*l*c;break;case"zxy":t[0]=a*u*f-o*l*c,t[1]=o*l*f+a*u*c,t[2]=o*u*c+a*l*f,t[3]=o*u*f-a*l*c;break;case"zyx":t[0]=a*u*f-o*l*c,t[1]=o*l*f+a*u*c,t[2]=o*u*c-a*l*f,t[3]=o*u*f+a*l*c;break;default:throw new Error("Unknown angle order "+i)}return t}var us=xh,Iu=Bh;(function(){var t=ae(),e=C(1,0,0),r=C(0,1,0);return function(n,i,s){var a=pr(i,s);return a<-.999999?(ri(t,e,i),yh(t)<1e-6&&ri(t,r,i),Rn(t,t),Ah(n,t,Math.PI),n):a>.999999?(n[0]=0,n[1]=0,n[2]=0,n[3]=1,n):(ri(t,i,s),n[0]=t[0],n[1]=t[1],n[2]=t[2],n[3]=1+a,Iu(n,n))}})();(function(){var t=Lt(),e=Lt();return function(r,n,i,s,a,o){return ls(t,n,a,o),ls(e,i,s,o),ls(r,t,e,2*o*(1-o)),r}})();(function(){var t=Qt();return function(e,r,n,i){return t[0]=n[0],t[3]=n[1],t[6]=n[2],t[1]=i[0],t[4]=i[1],t[7]=i[2],t[2]=-r[0],t[5]=-r[1],t[8]=-r[2],Iu(e,Mh(e,t))}})();function X(){var t=new Re(2);return Re!=Float32Array&&(t[0]=0,t[1]=0),t}function mi(t){var e=new Re(2);return e[0]=t[0],e[1]=t[1],e}function Z(t,e){var r=new Re(2);return r[0]=t,r[1]=e,r}function Ut(t,e,r){return t[0]=e[0]+r[0],t[1]=e[1]+r[1],t}function Sh(t,e,r){return t[0]=e[0]-r[0],t[1]=e[1]-r[1],t}function Gt(t,e,r){return t[0]=e[0]*r,t[1]=e[1]*r,t}function Ph(t){var e=t[0],r=t[1];return e*e+r*r}function et(t,e){return t[0]*e[0]+t[1]*e[1]}function Ch(t,e,r,n){var i=e[0],s=e[1];return t[0]=i+n*(r[0]-i),t[1]=s+n*(r[1]-s),t}function Fe(t,e,r){var n=e[0],i=e[1];return t[0]=r[0]*n+r[2]*i,t[1]=r[1]*n+r[3]*i,t}var At=Sh;(function(){var t=X();return function(e,r,n,i,s,a){var o,l;for(r||(r=2),n||(n=0),i?l=Math.min(i*r+n,e.length):l=e.length,o=n;o<l;o+=r)t[0]=e[o],t[1]=e[o+1],s(t,t,a),e[o]=t[0],e[o+1]=t[1];return e}})();function Tr(t){const e=Math.cos(t),r=Math.sin(t);return hi(e,r,-r,e)}function Gu(t,e,r){const n=Math.cos(t),i=Math.sin(t),s=Math.cos(e),a=Math.sin(e),o=Math.cos(r),l=Math.sin(r);return js(s*o,-s*l,a,i*a*o+n*l,-i*a*l+n*o,-i*s,-n*a*o+i*l,n*a*l+i*o,n*s)}function Eh(t,e){const r=Qt();return r[0]=t[0]*e[0],r[1]=t[0]*e[1],r[2]=t[0]*e[2],r[3]=t[1]*e[0],r[4]=t[1]*e[1],r[5]=t[1]*e[2],r[6]=t[2]*e[0],r[7]=t[2]*e[1],r[8]=t[2]*e[2],r}function wh(t,e){let r=t[0],n=t[3]/t[0],i=t[6]/t[0],s=t[4]-n*n*r,a=(t[7]-i*n*r)/s,o=t[8]-(i*i*r+a*a*s),l=e[0],u=e[1]-n*l,c=e[2]-i*l-a*u,f=l/r,d=u/s,m=c/o;const h=C(0,0,0);return h[2]=m,h[1]=d-a*h[2],h[0]=f-n*h[1]-i*h[2],h}function de(t=0,e=1){return t===void 0?(t=0,e=1):e===void 0&&(e=t,t=0),t+Math.random()*(e-t)}function Rh(t,e,r,n){return C(de(t,t+r),de(e,e+n),de(0,Math.PI*2))}function Oh(){const t=Math.floor(de(0,256)),e=Math.floor(de(0,256)),r=Math.floor(de(0,256)),n=255;return new Uint8Array([t,e,r,n])}function zn(t,e){return t[0]*e[1]-t[1]*e[0]}function Ui(t,e,r){const n=Ws(ae(),e,t),i=Ws(ae(),r,t);return Rn(ae(),ri(ae(),n,i))}function Ih(t){return t*(180/Math.PI)}function Gh(t){return t*(Math.PI/180)}function ar(){return document.getElementById("info")}function Rt(){return document.getElementById("utils")}let _u=null;function _h(t){_u=t}function or(t){_u?.addFrame(t)}function Uu(){Rt()}function lr(){const t=Rt();if(t)for(;t.firstChild;)t.removeChild(t.firstChild);Uu()}function gt(t,e,r,n){const i=document.createElement("label");i.textContent=t,i.htmlFor=`checkbox-${t}`;const s=document.createElement("input");return s.type="checkbox",s.id=`checkbox-${t}`,s.checked=e,s.tabIndex=-1,s.style.cssText=`
        margin-left: 8px;
        transform: scale(1.2);
        cursor: pointer;
    ...
    `,i.appendChild(s);const a=document.createElement("div");a.style.cssText="display: flex; align-items: center; gap: 10px; margin-bottom: 12px;";const o=document.createElement("label");o.textContent="Albedo:",a.appendChild(o);const l=_=>Math.round(_*255).toString(16).padStart(2,"0"),u=`#${l(e.albedo[0])}${l(e.albedo[1])}${l(e.albedo[2])}`,c=document.createElement("input");c.type="color",c.value=u,c.style.cssText=`
        ...
        cursor: pointer;
        padding: 0;
    `,c.tabIndex=-1,a.appendChild(c);const f=document.createElement("span");f.textContent=u.toUpperCase(),f.style.cssText="font-family: monospace; color: #aaa;",a.appendChild(f),c.addEventListener("input",()=>{f.textContent=c.value.toUpperCase();const _=parseInt(c.value.slice(1,3),16)/255,w=parseInt(c.value.slice(3,5),16)/255,K=parseInt(c.value.slice(5,7),16)/255;e.albedo=[_,w,K],r(e)}),i.appendChild(a);const d=document.createElement("label");d.textContent="Albedo texture",a.appendChild(d);const m=document.createElement("input");m.type="checkbox",m.checked=e.useAlbedoTexture,m.tabIndex=-1,a.appendChild(m),m.addEventListener("change",()=>{e.useAlbedoTexture=m.checked,r(e)});const h=document.createElement("div");h.style.cssText="display: flex; align-items: center; gap: 10px; margin-bottom: 12px;";const p=document.createElement("label");p.textContent=`Metalness: ${e.metalness.toFixed(2)}`,h.appendChild(p);const g=document.createElement("input");g.type="range",g.min="0",g.max="1",g.step="0.01",g.value=e.metalness.toString(),g.style.cssText=`
        flex: 1;
        cursor: pointer;
    `,g.tabIndex=-1,h.appendChild(g),i.appendChild(h),g.addEventListener("input",()=>{const _=parseFloat(g.value);e.metalness=isNaN(_)?0:_,p.textContent=`Metalness: ${e.metalness.toFixed(2)}`,r(e)});const y=document.createElement("label");y.textContent="Perlin noise",h.appendChild(y);const v=document.createElement("input");v.type="checkbox",v.checked=e.usePerlinMetalness,v.tabIndex=-1,h.appendChild(v),v.addEventListener("change",()=>{e.usePerlinMetalness=v.checked,r(e)});const S=document.createElement("label");S.textContent="Metalness texture",h.appendChild(S);const b=document.createElement("input");b.type="checkbox",b.checked=e.useMetalnessTexture,b.tabIndex=-1,h.appendChild(b),b.addEventListener("change",()=>{e.useMetalnessTexture=b.checked,r(e)});const P=document.createElement("div");P.style.cssText="display: flex; align-items: center; gap: 10px; margin-bottom: 12px;";const E=document.createElement("label");E.textContent=`Roughness: ${e.roughness.toFixed(2)}`,P.appendChild(E);const A=document.createElement("input");A.type="range",A.min="0",A.max="1",A.step="0.01",A.value=e.roughness.toString(),A.style.cssText=`
        flex: 1;
        cursor: pointer;
    `,A.tabIndex=-1,P.appendChild(A),i.appendChild(P),A.addEventListener("input",()=>{const _=parseFloat(A.value);e.roughness=isNaN(_)?0:_,E.textContent=`Roughness: ${e.roughness.toFixed(2)}`,r(e)});const R=document.createElement("label");R.textContent="Perlin noise",P.appendChild(R);const M=document.createElement("input");M.type="checkbox",M.checked=e.usePerlinRoughness,M.tabIndex=-1,P.appendChild(M),M.addEventListener("change",()=>{e.usePerlinRoughness=M.checked,r(e)});const G=document.createElement("label");G.textContent="Roughness texture",P.appendChild(G);const D=document.createElement("input");D.type="checkbox",D.checked=e.useRoughnessTexture,D.tabIndex=-1,P.appendChild(D),D.addEventListener("change",()=>{e.useRoughnessTexture=D.checked,r(e)});const F=document.createElement("div");F.style.cssText="display: flex; align-items: center; gap: 10px; margin-bottom: 12px;";const U=document.createElement("label");U.textContent=`Perlin Frequency: ${e.perlinFreq.toFixed(2)}`,F.appendChild(U);const O=document.createElement("input");O.type="range",O.min="0.1",O.max="10",O.step="0.1",O.value=e.perlinFreq.toString(),O.style.cssText=`
        flex: 1;
        cursor: pointer;
    ...
    `,s.appendChild(a);const o=document.createElement("div");o.style.cssText="display: flex; align-items: center; gap: 10px; margin-bottom: 12px;";const l=document.createElement("label");l.textContent="Enabled:",o.appendChild(l);const u=document.createElement("input");u.type="checkbox",u.checked=e.enabled,u.tabIndex=-1,o.appendChild(u),u.addEventListener("change",()=>{e.enabled=u.checked,n(e)}),s.appendChild(o);const c=document.createElement("div");c.style.cssText="display: flex; flex-direction: row; gap: 6px; margin-bottom: 12px;";const f=document.createElement("label");f.textContent="Area light center:",c.appendChild(f),["X","Y","Z"].forEach((B,N)=>{const _=document.createElement("input");_.type="number",_.value=e.center[N].toFixed(2),_.style.cssText=`
        ...
        background: #222;
        color: #eee;
    `,g.tabIndex=-1,h.appendChild(g),g.addEventListener("input",()=>{const B=parseFloat(g.value);e.intensity=isNaN(B)?0:B,n(e)}),s.appendChild(h);const y=document.createElement("div");y.style.cssText="display: flex; align-items: center; gap: 10px; margin-bottom: 12px;";const v=document.createElement("label");v.textContent="Area light height:",y.appendChild(v);const S=document.createElement("input");S.type="number",S.value=e.height.toFixed(2),S.style.cssText=`
        width: 80px;
        padding: 4px;
        border: 1px solid #555;
        border-radius: 4px;
        background: #222;
        color: #eee;
    `,S.tabIndex=-1,y.appendChild(S),S.addEventListener("input",()=>{const B=parseFloat(S.value);e.height=isNaN(B)?0:B,n(e)}),s.appendChild(y);const b=document.createElement("div");b.style.cssText="display: flex; align-items: center; gap: 10px; margin-bottom: 12px;";const P=document.createElement("label");P.textContent="Area light width:",b.appendChild(P);const E=document.createElement("input");E.type="number",E.value=e.width.toFixed(2),E.style.cssText=`
        width: 80px;
        padding: 4px;
        border: 1px solid #555;
        border-radius: 4px;
        background: #222;
        color: #eee;
    `,E.tabIndex=-1,b.appendChild(E),E.addEventListener("input",()=>{const B=parseFloat(E.value);e.width=isNaN(B)?0:B,n(e)}),s.appendChild(b);const A=document.createElement("div");A.style.cssText="display: flex; align-items: center; gap: 10px; margin-bottom: 12px;";const R=document.createElement("label");R.textContent="Light color:",A.appendChild(R);const M=B=>Math.round(B*255).toString(16).padStart(2,"0"),G=`#${M(e.color[0])}${M(e.color[1])}${M(e.color[2])}`,D=document.createElement("input");D.type="color",D.value=G,D.style.cssText=`
        width: 50px;
        height: 30px;
        border: none;
        border-radius: 4px;
    ...
    `,s.appendChild(a);const o=document.createElement("div");o.style.cssText="display: flex; align-items: center; gap: 10px; margin-bottom: 12px;";const l=document.createElement("label");l.textContent="Enabled:",o.appendChild(l);const u=document.createElement("input");u.type="checkbox",u.checked=e.enabled,u.tabIndex=-1,o.appendChild(u),u.addEventListener("change",()=>{e.enabled=u.checked,n(e)}),s.appendChild(o);const c=document.createElement("div");c.style.cssText="display: flex; flex-direction: row; gap: 6px; margin-bottom: 12px;";const f=document.createElement("label");f.textContent="Light position:",c.appendChild(f),["X","Y","Z"].forEach((F,U)=>{const O=document.createElement("input");O.type="number",O.value=e.position[U].toFixed(2),O.style.cssText=`
        ...
        background: #222;
        color: #eee;
    `,g.tabIndex=-1,h.appendChild(g),g.addEventListener("input",()=>{const F=parseFloat(g.value);e.intensity=isNaN(F)?0:F,n(e)}),s.appendChild(h);const y=document.createElement("div");y.style.cssText="display: flex; align-items: center; gap: 10px; margin-bottom: 12px;";const v=document.createElement("label");v.textContent="Cone angle:",y.appendChild(v);const S=document.createElement("input");S.type="range",S.value=Ih(e.coneAngle).toFixed(2),S.min="0",S.max="180",S.style.cssText=`
        width: 80px;
        padding: 4px;
        border: 1px solid #555;
        border-radius: 4px;
        background: #222;
        color: #eee;
    `,S.tabIndex=-1,y.appendChild(S),S.addEventListener("input",()=>{const F=parseFloat(S.value),U=Gh(F);e.coneAngle=isNaN(U)?0:U,n(e)}),s.appendChild(y);const b=document.createElement("div");b.style.cssText="display: flex; align-items: center; gap: 10px; margin-bottom: 12px;";const P=document.createElement("label");P.textContent="Light color:",b.appendChild(P);const E=F=>Math.round(F*255).toString(16).padStart(2,"0"),A=`#${E(e.color[0])}${E(e.color[1])}${E(e.color[2])}`,R=document.createElement("input");R.type="color",R.value=A,R.style.cssText=`
        width: 50px;
        height: 30px;
        border: none;
        border-radius: 4px;
        cursor: pointer;
        padding: 0;
    `,R.tabIndex=-1,b.appendChild(R);const M=document.createElement("span");M.textContent=A.toUpperCase(),M.style.cssText="font-family: monospace; color: #aaa;",b.appendChild(M),R.addEventListener("input",()=>{M.textContent=R.value.toUpperCase(),e.color=[parseInt(R.value.slice(1,3),16)/255,parseInt(R.value.slice(3,5),16)/255,parseInt(R.value.slice(5,7),16)/255],n(e)}),s.appendChild(b);const G=document.createElement("div");G.style.cssText="display: flex; gap: 8px; justify-content: flex-end;";const D=document.createElement("button");return D.textContent="Cancel",D.style.cssText=`
        padding: 6px 16px;
        background: #555;
        border: none;
        border-radius: 4px;
        ...
        cursor: pointer;
        font-size: 13px;
    `,D.tabIndex=-1,D.addEventListener("click",()=>{i()}),G.appendChild(D),s.appendChild(G),s}const Dh={class:"flex flex-row items-stretch h-20 font-mono text-[10px] select-none text-[#aaa]"},Fh={class:"flex-1 overflow-hidden relative bg-[#1a1a1a]/20 rounded-sm"},Lh=["title"],Nh={class:"w-[30px] relative shrink-0 ml-[3px]"},Hh={class:"absolute left-1 top-0 leading-none whitespace-nowrap"},Vh={class:"absolute left-1 top-1/2 -translate-y-1/2 leading-none whitespace-nowrap"},kh=eu({__name:"profiler",props:{maxBars:{default:60}},setup(t,{expose:e}){const r=t;let n=0;const i=Tt([]),s=Tt(60),a=wn(()=>s.value),o=wn(()=>Math.round(s.value/2));function l(f){return Math.min(f/s.value*100,100)}function u(f){const d=Math.min(f/60,1),m=Math.round(255*(1-d)),h=Math.round(255*d);return`rgb(${m},${h},0)`}function c(f){i.value.length>=r.maxBars&&i.value.shift(),i.value.push({id:n++,duration:Math.min(Math.max(f,0),60)})}return e({addFrame:c}),(f,d)=>(Lr(),Nr("div",Dh,[_e("div",Fh,[_e("div",{class:"absolute left-0 bottom-0 top-0 flex flex-row items-end",style:kr({width:i.value.length/r.maxBars*100+"%"})},[(Lr(!0),Nr(mt,null,au(i.value,m=>(Lr(),Nr("div",{key:m.id,class:"flex-1 min-w-0 rounded-t-[1px]",title:`${m.duration.toFixed(1)}ms`,style:kr({height:l(m.duration)+"%",backgroundColor:u(m.duration)})},null,12,Lh))),128))],4)]),_e("div",Nh,[d[0]||(d[0]=_e("div",{class:"absolute left-0 top-0 bottom-0 w-px bg-[#555]"},null,-1)),_e("span",Hh,_r(a.value),1),_e("span",Vh,_r(o.value),1),d[1]||(d[1]=_e("span",{class:"absolute left-1 bottom-0 leading-none whitespace-nowrap"},"0",-1))])]))}}),zh=`@vertex\r
...
}`,Cx=`// This is a similar process than the sceneMinMax but at levels\r
...
}`,Ex=`// Shader that takes all triangles and scene max and min bounds\r
...
`,Gx=`// Initialize each leaf AABB and prepare for the \r
// next batch of N dispatches that will \r
// go up the tree level by level\r
// and construct the internal node AABBs without racing conditions.\r
\r
//================================//\r
override THREADS_PER_WORKGROUP: u32;\r
override INTERNAL_NODE_COUNT: u32;\r
override LEAF_NODE_COUNT: u32;\r
const LEAF_BIT: u32 = 0x80000000u; // The flag bit\r
\r
//================================//\r
struct BVHNode \r
{\r
...
@group(0) @binding(3) var<storage, read> internalNodes: array<BVHNode>;\r
@group(0) @binding(4) var<storage, read_write> leafAABBs: array<LeafAABB>;\r
@group(0) @binding(5) var<storage, read_write> pendingChildCounts: array<atomic<u32>>;\r
\r
// Frontier buffers are used to know which internal nodes are ready to be dispatches for AABB computation.\r
// We are only ready once we know both children AABBs have been computed.\r
@group(0) @binding(6) var<storage, read_write> frontierNodes: array<u32>;\r
@group(0) @binding(7) var<storage, read_write> frontierCount: array<atomic<u32>>;\r
\r
//================================//\r
@compute\r
...
\r
    if (threadIndex < LEAF_NODE_COUNT)\r
    {\r
        let leafIndex = threadIndex;\r
        let originalTriangleIndex = sortedIndices[leafIndex];\r
\r
        let i0 = indices[originalTriangleIndex * 3u + 0u];\r
        let i1 = indices[originalTriangleIndex * 3u + 1u];\r
        let i2 = indices[originalTriangleIndex * 3u + 2u];\r
        let v0 = vec3f(vertices[i0 * 3u + 0u], vertices[i0 * 3u + 1u], vertices[i0 * 3u + 2u]);\r
        let v1 = vec3f(vertices[i1 * 3u + 0u], vertices[i1 * 3u + 1u], vertices[i1 * 3u + 2u]);\r
        let v2 = vec3f(vertices[i2 * 3u + 0u], vertices[i2 * 3u + 1u], vertices[i2 * 3u + 2u]);\r
\r
        leafAABBs[leafIndex].aabbMin = min(v0, min(v1, v2));\r
        leafAABBs[leafIndex].aabbMax = max(v0, max(v1, v2));\r
    }\r
\r
...
\r
    let leftChildIndex = internalNodes[threadIndex].left;\r
    let rightChildIndex = internalNodes[threadIndex].right;\r
    let pendingChildren = select(0u, 1u, (leftChildIndex & LEAF_BIT) == 0u) +\r
        select(0u, 1u, (rightChildIndex & LEAF_BIT) == 0u);\r
\r
    atomicStore(&pendingChildCounts[threadIndex], pendingChildren);\r
\r
    if (pendingChildren == 0u)\r
    {\r
        let slot = atomicAdd(&frontierCount[0], 1u);\r
        frontierNodes[slot] = threadIndex;\r
    }\r
}\r
`,_x=`// Deterministic construction of AABB per internal node,\r
// which then gives us the dispatch indirect arguments for the next pass \r
// until we end up processing the entire tree.\r
// This is the fix of not being able to one shot a bottom-up pass on the tree\r
// which would construct the final AABB in one single dispatch...\r
\r
//================================//\r
override THREADS_PER_WORKGROUP: u32;\r
const LEAF_BIT: u32 = 0x80000000u;\r
...
\r
//================================//\r
@group(0) @binding(0) var<storage, read_write> internalNodes: array<BVHNode>;\r
@group(0) @binding(1) var<storage, read> leafAABBs: array<LeafAABB>;\r
@group(0) @binding(2) var<storage, read_write> pendingChildCounts: array<atomic<u32>>;\r
@group(0) @binding(3) var<storage, read> frontierIn: array<u32>;\r
@group(0) @binding(4) var<storage, read_write> frontierInCount: array<atomic<u32>>;\r
@group(0) @binding(5) var<storage, read_write> frontierOut: array<u32>;\r
@group(0) @binding(6) var<storage, read_write> frontierOutCount: array<atomic<u32>>;\r
\r
//================================//\r
@compute\r
@workgroup_size(THREADS_PER_WORKGROUP)\r
fn cs_reduce(@builtin(global_invocation_id) gid: vec3u)\r
{\r
    let frontierCount = atomicLoad(&frontierInCount[0]);\r
    if (gid.x >= frontierCount)\r
    {\r
        return;\r
    }\r
\r
    let nodeIndex = frontierIn[gid.x];\r
\r
    let leftChildIndex = internalNodes[nodeIndex].left;\r
    let rightChildIndex = internalNodes[nodeIndex].right;\r
\r
    let leftChildAABB = getChildAABB(leftChildIndex);\r
    let rightChildAABB = getChildAABB(rightChildIndex);\r
\r
    let mergedMin = min(leftChildAABB.aabbMin, rightChildAABB.aabbMin);\r
    let mergedMax = max(leftChildAABB.aabbMax, rightChildAABB.aabbMax);\r
\r
    internalNodes[nodeIndex].aabbMin = mergedMin;\r
    internalNodes[nodeIndex].aabbMax = mergedMax;\r
    internalNodes[nodeIndex].sahCost = 0.0;\r
\r
    let parentIndex = internalNodes[nodeIndex].parent;\r
    if (parentIndex == INVALID_NODE)\r
    {\r
        return;\r
    }\r
\r
    let previousPending = atomicSub(&pendingChildCounts[parentIndex], 1u);\r
    if (previousPending == 1u)\r
    {\r
        let slot = atomicAdd(&frontierOutCount[0], 1u);\r
        frontierOut[slot] = parentIndex;\r
    }\r
}\r
\r
//================================//\r
...
fn cs_prepare()\r
{\r
    atomicStore(&frontierOutCount[0], 0u);\r
}\r
\r
//================================//\r
fn getChildAABB(childIndex: u32) -> LeafAABB\r
{\r
    if ((childIndex & LEAF_BIT) != 0u)\r
    {\r
        let index = childIndex & 0x7FFFFFFFu;\r
        return leafAABBs[index];\r
    }\r
\r
    return LeafAABB(internalNodes[childIndex].aabbMin, 0u, internalNodes[childIndex].aabbMax, 0u);\r
}\r
`,Ux=`// This shader is the final step of the BVH construction process.\r
