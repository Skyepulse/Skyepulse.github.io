...
{\r
    ...
    {\r
        albedo = textureSampleLevel(textures, materialSampler, uv, i32(material.textureIndex) * 4, 0.0).rgb;\r
    }\r
\r
    ...
    {\r
        alphap = textureSampleLevel(textures, materialSampler, uv, i32(material.textureIndex) * 4 + 2, 0.0).r;\r
    }\r
    ...
    {\r
        metalness = textureSampleLevel(textures, materialSampler, uv, i32(material.textureIndex) * 4 + 1, 0.0).r;\r
    }\r
    \r
    let ka = 0.1;\r
