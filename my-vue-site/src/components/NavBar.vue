<template>
    <div id="nav-bar" ref="navbarRef" class="fixed top-0 left-0 w-full bg-neutral-50 z-50 transition-all duration-300 border-b-1 border-gray-400" :class="{'h-[10vh]': !dropDownOpen, 'h-[25vh]': dropDownOpen}">
